...
TL;DR: The paper proposes an edge AI roadside perception node for autonomous traffic violation detection and safety event dissemination in India's high-violation, low-enforcement scenario, achieving high accuracy and efficiency.


<details>
  <summary>Details</summary>
Motivation: The rapid motorization in emerging economies like India has led to severe enforcement challenges due to the scale of traffic violations, necessitating scalable, autonomous solutions beyond traditional methods.

Method: The system integrates YOLOv8 Nano for object detection, DeepSORT for tracking, and a rule-guided OCR engine for license plate recognition, deployed on an NVIDIA Jetson Nano with TensorRT optimization.

Result: It achieves 97.7% violation detection accuracy, 84.9% OCR precision, and operates at 28-30 FPS with 9.6W power consumption, outperforming other models in accuracy and efficiency.

Conclusion: The node enhances cooperative perception and road safety by publishing standardized safety events via V2X protocols, validating roadside edge AI's role in intelligent transportation systems.
...
TL;DR: The paper introduces the ROAD benchmark to evaluate LiDAR-based object classification under domain and label shifts, addressing gaps in continual and transfer learning for 3D point cloud perception.


<details>
  <summary>Details</summary>
Motivation: Real-world 3D perception systems need to adapt to evolving object definitions and sensor domains, but continual and transfer learning in 3D point clouds remains underexplored.

Method: The ROAD benchmark evaluates zero-shot transfer, linear probe, and continual learning (CL) methods using large-scale datasets (Waymo, NuScenes, Argoverse2).

Result: Existing approaches show limitations under realistic domain and label shifts; strong baselines are established for robust 3D perception.

Conclusion: The ROAD benchmark provides a comprehensive evaluation suite for future research on robust 3D perception under evolving conditions.
...
TL;DR: The Lunara Aesthetic Dataset offers diverse artistic styles with high aesthetic quality, human-refined prompts, and structured annotations, surpassing other datasets in aesthetics and licensing transparency.


<details>
  <summary>Details</summary>
Motivation: To create a dataset prioritizing aesthetic quality, stylistic diversity, and licensing transparency for research and unrestricted use.

Method: Images are generated using the Moonworks Lunara model, accompanied by human-refined prompts and structured annotations detailing objects, attributes, relationships, and stylistic cues.

Result: The dataset achieves higher aesthetic scores than other datasets, focusing on precision over breadth.

Conclusion: The Lunara Aesthetic Dataset is a unique, high-quality resource released under Apache 2.0 for broad academic and commercial applications.
...
TL;DR: A lightweight CNN, LWMSCNN-SE, is proposed for efficient maize disease classification, achieving 96.63% accuracy with low computational costs (241,348 parameters, 0.666 GFLOPs), making it suitable for edge devices.


<details>
  <summary>Details</summary>
Motivation: To address the high computational costs of traditional disease detection models in resource-constrained environments like smartphones and drones, ensuring efficient maize disease classification for food security.

Method: LWMSCNN-SE integrates multi-scale feature extraction, depthwise separable convolutions, and squeeze-and-excitation (SE) attention mechanisms for lightweight and efficient performance.

Result: Achieves 96.63% classification accuracy with only 241,348 parameters and 0.666 GFLOPs, demonstrating suitability for real-time deployment on edge devices.

Conclusion: The model effectively balances accuracy and efficiency, offering a practical solution for maize disease diagnosis in precision farming systems.
...
TL;DR: 3DGS-Drag is a point-based 3D editing framework that enables intuitive drag manipulation for real 3D scenes, combining deformation and diffusion guidance for efficient, high-quality editing.


<details>
  <summary>Details</summary>
Motivation: The challenge of extending intuitive drag editing from 2D to 3D scenes motivated the development of a framework that bridges deformation-based and 2D-editing-based methods.

Method: The method uses deformation guidance with 3D Gaussian Splatting for geometric consistency and diffusion guidance for content correction, supported by a progressive editing strategy.

Result: 3DGS-Drag achieves state-of-the-art performance in geometry-related 3D editing, enabling diverse edits like motion change and shape adjustment efficiently (~10-20 minutes on an RTX 4090 GPU).

Conclusion: The framework successfully addresses limitations in 3D editing, offering an efficient and intuitive solution for real-world 3D scene manipulation.
...
TL;DR: The Sesame Plant Segmentation Dataset is an open-source annotated image collection for AI models in agriculture, featuring pixel-level segmentation of sesame plants and showing strong performance in detection and segmentation tasks.


<details>
  <summary>Details</summary>
Motivation: To provide a precise and open-source dataset for sesame plant analysis in agriculture, addressing the limitations of bounding box datasets.

Method: Data collected via high-resolution mobile cameras in Nigeria, annotated using Segment Anything Model v2, and evaluated with Ultralytics YOLOv8.

Result: High performance metrics: recall (79-82%), precision (77-79%), and mean average precision (52-84%) for detection and segmentation tasks.

Conclusion: The dataset is a valuable resource for sesame plant monitoring and research, offering improved precision over traditional methods.
...
TL;DR: The paper introduces AKT, a transformer-based method for high-resolution UAV imagery in precision agriculture, addressing challenges like small object-to-pixel ratios and computational costs, and demonstrates improved performance over existing methods.


<details>
  <summary>Details</summary>
Motivation: High-resolution UAV photogrammetry faces challenges in maize localization due to small object-to-pixel ratios, high computational costs, and scene-specific complexities, necessitating a more efficient and accurate solution.

Method: The authors propose AKT, which replaces traditional MLPs with PKAN modules and introduces PAA for multiscale spatial dependency modeling, alongside releasing the PML dataset for benchmarking.

Result: AKT achieves a 62.8% F1-score (4.2% better than SOTA), reduces FLOPs by 12.6%, and improves throughput by 20.7%, showing strong performance in stand counting and interplant spacing estimation.

Conclusion: Integrating Kolmogorov-Arnold theory with efficient attention mechanisms provides an effective solution for high-resolution agricultural remote sensing tasks.
...
TL;DR: A new ideal observer model simplifies visual search by setting thresholds on image features, reducing parameters for applications in medical imaging, computer vision, defense, and sensor evaluation.


<details>
  <summary>Details</summary>
Motivation: To create a streamlined framework for holistic visual search processing with fewer parameters.

Method: Develops an ideal observer model with thresholds on extractable image features.

Result: A reduced-parameter system useful for medical image perception, computer vision, defense, and sensor evaluation.

Conclusion: The model offers versatile applications in optimizing imaging systems, benchmarking, and feature selection.
...
TL;DR: The study explores combining Gabor and GLCM features to model early-stage visual search behavior, showing agreement with human gaze data and a model observer.


<details>
  <summary>Details</summary>
Motivation: To understand how observers allocate attention in visual search tasks by integrating structural and texture-based features.

Method: Proposed two pipelines combining Gabor and GLCM features, tested on simulated breast tomosynthesis images, and compared with eye-tracking data.

Result: Qualitative agreement between predicted fixations and model observer, strong correlation between GLCM mean and Gabor features, and consistency with human gaze behavior.

Conclusion: Combining structural and texture features improves visual search modeling, supporting perceptually informed observer models.
...
TL;DR: The paper introduces CASHEW and CASHEW-RL to stabilize multi-step reasoning in vision-language models, improving performance across 13 benchmarks.


<details>
  <summary>Details</summary>
Motivation: Multi-step reasoning in vision-language models is unstable, leading to divergent trajectories and inconsistent predictions. The goal is to address this instability.

Method: CASHEW aggregates multiple reasoning trajectories with visual verification, while CASHEW-RL internalizes this behavior via Group Sequence Policy Optimization (GSPO) for adaptive effort allocation.

Result: Significant performance gains, up to +23.6pp on ScienceQA and +8.1pp on EgoSchema.

Conclusion: CASHEW and CASHEW-RL effectively stabilize reasoning and improve model performance.
...
TL;DR: TP-Blend is a training-free framework for text-conditioned diffusion editing, enabling simultaneous object and style replacement through two attention processors.


<details>
  <summary>Details</summary>
Motivation: Existing methods handle single object replacement well but fail when introducing a new object and style together.

Method: TP-Blend uses Cross-Attention Object Fusion (CAOF) for object injection and Self-Attention Style Fusion (SASF) for style blending, optimizing attention and feature updates.

Result: The framework achieves high-resolution, photo-realistic edits with precise control, outperforming baselines in fidelity, quality, and speed.

Conclusion: TP-Blend effectively combines object and style edits in a lightweight, memory-efficient manner.
...
TL;DR: A decoder-based deep learning method generates manufacturable 3D structures optimized for additive manufacturing, ensuring geometric validity and printing constraints.


<details>
  <summary>Details</summary>
Motivation: To address the challenge of generating 3D structures that are both geometrically valid and manufacturable, respecting constraints like overhang angles and wall thickness.

Method: A deep learning framework decodes latent representations into printable 3D geometries, incorporating manufacturing constraints during generation.

Result: The approach produces parts with improved manufacturability compared to naive methods and is validated across diverse object categories, including practical 3D printing.

Conclusion: Neural decoders effectively map abstract representations to manufacturable 3D geometries, advancing additive manufacturing optimization.
...
TL;DR: Early layers in adapter-based vision-language models show meaningful image-text alignment, contradicting the belief that alignment occurs only in late layers. A new synthesis method provides direct, layer-specific evidence of this alignment.


<details>
  <summary>Details</summary>
Motivation: To challenge the assumption that image-text alignment in vision-language models only emerges in late layers and to provide a simple, efficient method for measuring alignment.

Method: A synthesis-based approach inspired by DeepDream, where concept vectors are extracted and optimized to generate images aligned with textual concepts across model layers.

Result: Over 50% of synthesized images depict recognizable visual features of textual concepts (e.g., animals, seasons) as early as layer 1 in Gemma 3.

Conclusion: The method offers direct evidence of early-layer alignment, simplifies multimodal alignment measurement, and enhances model interpretability by visualizing representation spaces.
...
TL;DR: A vision-only ZSAD framework uses DDIM inversion for anomaly detection without fine-grained prompts, achieving SOTA on VISA dataset.


<details>
  <summary>Details</summary>
Motivation: Current ZSAD methods rely on auxiliary modalities or lack spatial precision; this work aims to address these limitations with a simpler approach.

Method: Leverages DDIM inversion to reconstruct normal-looking images from latent representations, highlighting anomalies via input-reconstruction discrepancies.

Result: Achieves state-of-the-art performance on VISA dataset with strong localisation capabilities.

Conclusion: Demonstrates effective anomaly detection without auxiliary modalities, reducing prompt dependence.
...
TL;DR: CBD, a new diversity metric leveraging VLMs, outperforms traditional methods for input selection in DNN fine-tuning, offering efficiency and scalability.


<details>
  <summary>Details</summary>
Motivation: To address the inefficiency and lack of scalability in diversity-based input selection methods for DNN fine-tuning.

Method: Introduces Concept-Based Diversity (CBD), combines it with Margin uncertainty metric, and evaluates across diverse models and datasets.

Result: CBD-based selection outperforms baselines, is efficient, and scales well even for large datasets like ImageNet.

Conclusion: CBD-based selection is effective, efficient, and scalable for improving DNN performance via selective input labeling.
...
TL;DR: FigEx2 is a visual-conditioned framework for localizing panels and generating panel-wise captions in scientific compound figures, featuring noise-aware fusion, staged optimization, and strong zero-shot transferability.


<details>
  <summary>Details</summary>
Motivation: Captions for scientific compound figures are often missing or lack panel-level details, making understanding individual panels challenging.

Method: FigEx2 uses a noise-aware gated fusion module to stabilize captioning, combines supervised and reinforcement learning (RL) with CLIP-based alignment and BERTScore rewards, and employs a curated benchmark (BioSci-Fig-Cap).

Result: FigEx2 achieves 0.726 mAP@0.5:0.95 for detection and outperforms Qwen3-VL-8B by 0.51 in METEOR and 0.24 in BERTScore, with notable zero-shot transferability.

Conclusion: FigEx2 effectively addresses panel-level captioning challenges in scientific figures, demonstrating superior performance and adaptability across domains.
...
TL;DR: A vision-language guided framework for generating and detecting biomedical image forgeries, combining diffusion-based synthesis with semantic control.


<details>
  <summary>Details</summary>
Motivation: Addressing the challenge of detecting scientific image manipulation in biomedical publications due to domain-specific complexities.

Method: Combines diffusion-based synthesis with vision-language prompting for realistic manipulations. Introduces Rescind benchmark and Integscan framework for precise forgery localization.

Result: Integscan achieves state-of-the-art performance in detection and localization on Rescind and existing benchmarks.

Conclusion: Establishes a strong foundation for automated scientific integrity analysis in biomedical research.
...
TL;DR: Introducing controlled noise in training data improves CNN robustness, with just 10% noisy data enhancing performance under corrupted test conditions.


<details>
  <summary>Details</summary>
Motivation: Investigate how deliberate noise introduction during training can enhance CNN robustness for real-world noisy inputs.

Method: Use CIFAR-10 dataset with Resnet-18; introduce Gaussian noise, Salt-and-Pepper noise, and Gaussian blur at varying intensities.

Result: Incorporating 10% noisy data reduces test loss and improves accuracy under corrupted test conditions, with minimal impact on clean-data performance.

Conclusion: Strategic noise exposure acts as an effective regularizer, balancing traditional data cleanliness and real-world resilience.
...
TL;DR: DINO-AugSeg leverages DINOv3 features and introduces wavelet-based augmentation (WT-Aug) and contextual fusion (CG-Fuse) to improve few-shot medical image segmentation, outperforming existing methods across diverse imaging modalities.


<details>
  <summary>Details</summary>
Motivation: Few-shot medical image segmentation is challenging due to limited annotated data. Self-supervised models like DINOv3 show promise but face domain gaps when applied directly to medical images.

Method: Proposes DINO-AugSeg with WT-Aug (wavelet-based feature augmentation) and CG-Fuse (contextual fusion via cross-attention) to enhance feature diversity and integration.
...
Conclusion: DINO-AugSeg demonstrates robustness by combining wavelet-domain augmentation and contextual fusion, advancing few-shot medical image segmentation.
...
TL;DR: Automated pipeline for generating domain-specific synthetic datasets using diffusion models to address distribution shifts.


<details>
  <summary>Details</summary>
Motivation: Address the distribution shift between pre-trained models and real-world deployment environments.

Method: Three-stage framework involving controlled inpainting, multi-modal validation, and user-preference classification.

Result: Efficient creation of high-quality, deployable datasets with reduced reliance on real-world data.

Conclusion: The pipeline effectively bridges the gap between synthetic data generation and real-world applicability.
...
TL;DR: PathoGen is a diffusion-based model for generating realistic histopathology lesions to address data scarcity in AI training, outperforming existing methods and improving downstream tasks.


<details>
  <summary>Details</summary>
Motivation: Addressing the shortage of expert-annotated lesion data for rare pathologies in histopathology AI models.

Method: Uses a diffusion-based generative model (PathoGen) for controllable, high-fidelity lesion inpainting in benign images.

Result: Outperforms GANs and Stable Diffusion in fidelity and similarity, enhancing segmentation performance, especially in data-scarce scenarios.

Conclusion: PathoGen provides a scalable solution to overcome annotation bottlenecks and improve medical AI generalizability with limited labeled data.
...
TL;DR: The paper introduces SSP, a novel collaborative framework combining optical flow and textual prompts for enhanced audio-visual semantic segmentation (AVSS), outperforming existing methods.


<details>
  <summary>Details</summary>
Motivation: AVSS requires deeper semantic understanding beyond pixel-level sound source identification. Current methods lack integration of motion dynamics and semantic context, which SSP addresses.

Method: SSP decomposes AVSS into subtasks using pre-mask (optical flow for motion) and post-mask (training with optical flow diagrams) techniques. It uses textual prompts for stationary objects and a VTA module for cross-modal alignment.

Result: SSP achieves superior performance in AVSS, providing precise segmentation by leveraging motion and semantic context.

Conclusion: SSP effectively integrates motion and semantic cues, advancing AVSS accuracy and efficiency beyond traditional AVS methods.
...
TL;DR: SubTTA improves test-time adaptation (TTA) for vision-language models (VLMs) by addressing modality gaps and visual noise, enhancing zero-shot predictions for better adaptation.


<details>
  <summary>Details</summary>
Motivation: VLMs struggle with distribution shifts, and existing TTA methods rely on unreliable zero-shot predictions.

Method: SubTTA aligns semantic subspaces of modalities, minimizes chordal distance, and filters noise using task-specific textual subspaces.

Result: SubTTA outperforms state-of-the-art TTA methods by an average of 2.24%.

Conclusion: SubTTA effectively addresses VLMs' adaptation challenges under distribution shifts.
...
TL;DR: The paper investigates how Multimodal Large Language Models (MLLMs) integrate visual and textual information internally through layer-wise masking analysis, revealing non-uniform fusion patterns and proposing a training-free contrastive attention framework to enhance multimodal reasoning.


<details>
  <summary>Details</summary>
Motivation: Despite the progress of MLLMs in vision-language understanding, their internal mechanisms for integrating visual and textual information remain unclear, motivating this study.

Method: The authors conduct a systematic layer-wise masking analysis across multiple MLLM architectures, examining fusion evolution, attention patterns, and introducing a training-free contrastive attention framework.

Result: Findings reveal specific layers where fusion emerges, late-stage visual signal reactivation, high-attention noise, and propose a framework improving multimodal reasoning performance.

Conclusion: The study provides insights into MLLM fusion dynamics and demonstrates efficacy of the proposed framework, advancing understanding and performance in multimodal reasoning.
...
TL;DR: The paper introduces instance-aligned captions for explainable video anomaly detection (VAD) to improve spatial grounding and verifiability, addressing limitations in current methods.


<details>
  <summary>Details</summary>
Motivation: Current explainable VAD lacks spatial grounding, especially in multi-entity interactions, leading to unverifiable explanations. The goal is to enhance trustworthiness and actionability.

Method: Authors propose instance-aligned captions that link textual claims to specific object instances with appearance and motion attributes. They annotate eight VAD benchmarks and extend VIEW360 into VIEW360+ for testing.

Result: Experiments show the new captions highlight flaws in existing LLM- and VLM-based methods, offering a robust benchmark for future research.

Conclusion: The framework improves verifiable reasoning in VAD and sets a foundation for trustworthy, interpretable anomaly detection.
...
TL;DR: A hardware-algorithm co-design framework combines a custom SVE sensor and physics-aware dehazing algorithm to improve optical measurements in extreme rocket launch conditions.


<details>
  <summary>Details</summary>
Motivation: Extreme imaging conditions during rocket launches degrade image quality, hindering accurate photogrammetric and velocimetric analyses.

Method: Uses a Spatially Varying Exposure sensor for multi-exposure data and a dehazing algorithm for dynamic haze density estimation and illumination optimization.

Result: Validated on real launch imagery, the framework successfully recovers plume and engine details for accurate mechanical parameter extraction.

Conclusion: The framework enables precise quantitative analysis in extreme aerospace environments, supporting better measurement of mechanical parameters.
...
TL;DR: The paper proposes SISTA, a multi-level alignment framework for medical VLP, addressing false negatives in contrastive learning and improving alignment between images and reports at patch-word levels, leading to better transfer performance on downstream tasks.


<details>
  <summary>Details</summary>
Motivation: Traditional contrastive learning treats unpaired medical images and reports as negatives, which can disrupt semantic structure due to inherent similarities. SISTA aims to rectify this by leveraging semantic correspondence at multiple levels.

Method: SISTA introduces inter-report similarity to eliminate false negatives and aligns image patches with relevant word tokens. It operates at both image-report and patch-word levels.

Result: The framework improves transfer performance on image classification, segmentation, and detection tasks, especially in fine-grained tasks with limited labeled data.

Conclusion: SISTA enhances medical VLP by addressing limitations of conventional contrastive learning, demonstrating significant improvements in downstream tasks.
...
TL;DR: Award-winning solution for Cross-platform 3D Object Detection using PVRCNN++ framework, improved with data augmentation and self-training, achieving top results in RoboSense2025 Challenge.


<details>
  <summary>Details</summary>
Motivation: To enhance cross-platform generalization in 3D object detection by addressing domain gaps.

Method: Built upon PVRCNN++, integrating point-voxel features, with tailored data augmentation and self-training using pseudo-labels.

Result: Achieved 3rd place with 62.67% 3D AP for Cars (phase-1) and 58.76%/49.81% for Cars/Pedestrians (phase-2).

Conclusion: The approach successfully improved generalization and performance in cross-platform 3D detection.
...
TL;DR: CogniMap3D is a bioinspired framework for dynamic 3D scene understanding, combining motion cues, cognitive mapping, and optimization for efficient scene reconstruction.


<details>
  <summary>Details</summary>
Motivation: The motivation is to mimic human cognitive processes for dynamic 3D scene understanding, enabling efficient storage and retrieval of spatial knowledge.

Method: The method includes a multi-stage motion cue framework, cognitive mapping for static scenes, and factor graph optimization for camera poses.

Result: The framework achieves state-of-the-art performance in video depth estimation, camera pose reconstruction, and 3D mapping.

Conclusion: CogniMap3D effectively supports continuous scene understanding across extended sequences and multiple visits.
...
TL;DR: The paper introduces a framework for instruction-driven facial expression generation, enabling smooth transitions between arbitrary expressions using textual descriptions.


<details>
  <summary>Details</summary>
Motivation: To simulate realistic emotional variation in 3D avatars by enabling transitions between any two facial expressions based on text instructions.

Method: Proposes IFED for multimodal data learning, I2FET for refining semantic comprehension, and a Facial Expression Transition model for smooth expression changes.

Result: Outperforms state-of-the-art methods on CK+ and CelebV-HQ datasets, generating accurate facial expression trajectories from text.

Conclusion: The framework expands facial expression repertoires and transitions, promising practical applications.
...
TL;DR: The paper addresses flaws in existing corner detection methods by introducing a second-order Gaussian directional derivative filter to improve accuracy in detecting adjacent corners.


<details>
  <summary>Details</summary>
Motivation: Existing corner detection methods, like Zhang et al.'s, have theoretical flaws due to mutual interference of grayscale information between adjacent corners.

Method: A second-order Gaussian directional derivative (SOGDD) filter is applied to smooth high-resolution angle models (END-type and L-type), and a new corner detection method is proposed.

Result: The method accurately detects adjacent corners, outperforming state-of-the-art techniques in localization error, robustness, image matching, and 3D reconstruction.

Conclusion: The proposed SOGDD-based method effectively addresses the limitations of existing corner detection approaches and demonstrates superior performance.
...
TL;DR: MLLMs like Gemini-3-Pro show promise in gastroenterology but lag in spatial grounding and factual accuracy compared to humans.


<details>
  <summary>Details</summary>
Motivation: Evaluate MLLMs' clinical utility in gastrointestinal endoscopy against human benchmarks.

Method: Used GI-Bench with 20 lesion categories, tested 12 MLLMs across a five-stage workflow, and compared results to junior endoscopists and trainees using Macro-F1, mIoU, and Likert scales.

Result: Top MLLMs matched junior endoscopists in diagnosis but struggled with spatial grounding and factual accuracy, despite better linguistic fluency.

Conclusion: MLLMs have potential but need improvement in spatial accuracy and factual correctness to replace human clinicians.
...
TL;DR: The paper introduces GPM, a method mimicking human visual perception, and develops H-GPE, achieving balanced performance and efficiency in lightweight networks.


<details>
  <summary>Details</summary>
Motivation: Existing lightweight models often sacrifice parameter efficiency or oversimplify human vision, hindering deployment on resource-limited devices.

Method: GPM uses a Global Insight Generator and parallel branches (LSAE and IRB) to mimic human vision's global-to-local processing. H-GPE is built on GPM.

Result: H-GPE outperforms recent lightweight models in image tasks (classification, detection, segmentation) with balanced FLOPs and parameters.

Conclusion: GPM and H-GPE offer a better accuracy-efficiency trade-off by better modeling human visual perception while maintaining computational and parameter efficiency.
...
TL;DR: R^4 is an agentic framework that decomposes medical imaging workflows into four agents (Router, Retriever, Reflector, Repairer) to improve reasoning, safety, and spatial grounding in medical image analysis, outperforming single-VLM baselines without fine-tuning.


<details>
  <summary>Details</summary>
Motivation: Existing medical image analysis systems lack control over reasoning, safety, and spatial grounding, limiting their reliability and clinical utility.

Method: R^4 uses four coordinated agents to decompose workflows: Router for task-aware prompts, Retriever for report and bounding box generation, Reflector for error critique, and Repairer for iterative revisions.

Result: R^4 boosts LLM-as-a-Judge scores by +1.7-+2.5 points and mAP50 by +2.5-+3.5 points over baselines.

Conclusion: Agentic routing, reflection, and repair enhance VLM reliability and grounding in clinical image interpretation.
...
TL;DR: MMH is a novel framework for multi-site multi-sequence brain MRI harmonization, using diffusion-based global harmonization and target-specific fine-tuning, outperforming existing methods without needing paired data.


<details>
  <summary>Details</summary>
Motivation: Multi-site MRI data introduces non-biological heterogeneity due to site-specific variations, limiting model generalizability. Existing harmonization methods often rely on paired data or fail to disentangle style from anatomy, and focus on single-sequence MRI.

Method: MMH leverages biomedical semantic priors for sequence-aware style alignment in two stages: (1) diffusion-based global harmonization using style-agnostic gradient conditioning, and (2) target-specific fine-tuning. It uses a tri-planar attention BiomedCLIP encoder for volumetric style disentanglement.

Result: Evaluations on 4,163 T1- and T2-weighted MRIs show MMH outperforms state-of-the-art methods in feature clustering, voxel-level comparison, tissue segmentation, and downstream tasks like age and site classification.

Conclusion: MMH effectively addresses the limitations of existing MRI harmonization methods by enabling multi-sequence harmonization without paired data, improving generalizability and utility in real-world settings.
...
TL;DR: MobiDiary is a framework that generates natural language descriptions of daily activities from physical signals (IMU and Wi-Fi), bypassing privacy concerns of vision-based systems. It uses unified sensor encoding and Transformer-based decoding for expressive summaries, achieving state-of-the-art performance.


<details>
  <summary>Details</summary>
Motivation: Address privacy and environmental limitations of vision-based HAR systems by leveraging physical signals (IMU and Wi-Fi) to generate human-readable activity descriptions.

Method: Proposes MobiDiary with a unified sensor encoder exploiting shared inductive biases of motion-induced signals. Uses patch-based mechanisms for temporal correlations and placement embedding for spatial context. A Transformer-based decoder generates descriptions autoregressively.

Result: Outperforms specialized baselines on public benchmarks (XRF V2, UWash, WiFiTAD) in captioning metrics (BLEU@4, CIDEr, RMC) and continuous action understanding.

Conclusion: MobiDiary effectively bridges the semantic gap between physical signals and linguistic descriptions, generalizing across modalities while maintaining privacy and expressiveness.
...
TL;DR: Introduces FUME, a deep learning method using dual-gas optical imaging to detect ruminal acidosis in dairy cattle, achieving high accuracy with low computational cost.


<details>
  <summary>Details</summary>
Motivation: Addresses the limitations of invasive pH measurement methods for diagnosing ruminal acidosis by proposing a scalable, non-invasive alternative.

Method: Uses dual-stream architecture with weight-shared encoders and attention mechanisms to analyze CO2 and CH4 emissions for classifying rumen health.

Result: Achieves 80.99% mIoU in segmentation and 98.82% classification accuracy with only 1.28M parameters and 1.97G MACs, outperforming existing methods.

Conclusion: Demonstrates feasibility of gas emission-based monitoring for livestock health, enabling practical acidosis detection.
...
TL;DR: The paper proposes event-based segmentation and a confidence estimation method for zero-shot ADL recognition, outperforming time-based and supervised methods.


<details>
  <summary>Details</summary>
Motivation: To address the misalignment of time-based segmentation with LLMs' contextual reasoning and lack of confidence estimation in zero-shot ADL recognition.

Method: Uses event-based segmentation and introduces a novel confidence estimation technique.

Result: Event-based segmentation outperforms time-based and supervised methods; confidence measure effectively identifies correct predictions.

Conclusion: The approach enhances zero-shot ADL recognition, proving effective even with smaller LLMs and realistic datasets.
...
TL;DR: AIMC-Spec is a synthetic dataset addressing the lack of standardization in automatic intrapulse modulation classification (AIMC), featuring 33 modulation types across 13 SNR levels. Five deep learning algorithms were benchmarked, showing FM signals perform better than other types, especially at low SNRs.


<details>
  <summary>Details</summary>
Motivation: The absence of standardized datasets impedes progress in AIMC, crucial for radar signal analysis in noisy conditions.

Method: AIMC-Spec, a spectrogram-based synthetic dataset, was created and tested using five deep learning algorithms under a unified input format.

Result: FM signals were classified more reliably than phase or hybrid types, with performance varying across SNR levels. Modulation type and network architecture significantly impact robustness.

Conclusion: AIMC-Spec provides a reproducible baseline and supports future AIMC research and standardization.
...
TL;DR: HIPPO accelerates video-LLM inference by preserving semantic tokens and overlapping draft generation with verification, achieving up to 3.51x speedup.


<details>
  <summary>Details</summary>
Motivation: Existing SD methods for video-LLMs fail to match text-LLM acceleration due to inadequate token preservation and high draft model costs.

Method: HIPPO introduces semantic-aware token preservation and parallel draft-verification decoupling.

Result: HIPPO achieves up to 3.51x speedup on four video-LLMs across six benchmarks.

Conclusion: HIPPO effectively addresses limitations of prior SD methods, significantly boosting video-LLM inference speed.
...
TL;DR: The paper explores one-shot learning techniques using siamese capsule networks and stacked images, outperforming other methods across various domains.


<details>
  <summary>Details</summary>
Motivation: Addressing the challenge of learning good features with limited data, particularly in one-shot learning scenarios.

Method: Employs siamese capsule networks and stacked images for one-shot identification tasks.

Result: The capsule architecture achieves strong results, surpassing other techniques on diverse datasets.

Conclusion: The proposed approach is effective, easy to use, and outperforms existing methods in one-shot learning.
...
TL;DR: KidVis benchmark tests MLLMs on low-semantic visual tasks, revealing a significant performance gap compared to human children and suggesting scaling models alone doesn't improve foundational visual capabilities.


<details>
  <summary>Details</summary>
Motivation: To assess if MLLMs possess basic visual primitives comparable to human intuition, despite their advanced reasoning skills.

Method: Introduces KidVis, a benchmark with six atomic visual capabilities, and evaluates 20 MLLMs against human children's performance.

Result: Human children scored 95.32 on average, while GPT-5 scored 67.33, showing a 'Scaling Law Paradox' where scaling models doesn't linearly improve foundational visual skills.

Conclusion: Current MLLMs lack essential perceptual primitives needed for generalized visual intelligence, despite their high-level reasoning abilities.
...
TL;DR: The M3SR architecture uses multi-scale, multi-perceptual features in a U-Net structure to improve hyperspectral image reconstruction, outperforming existing methods with lower computational costs.


<details>
  <summary>Details</summary>
Motivation: Existing Mamba architectures for spectral reconstruction face limitations in spatial perception and single-scale feature extraction, restricting their ability to fully analyze hyperspectral images.

Method: The M3SR introduces a multi-perceptual fusion block within a U-Net structure to extract and fuse global, intermediate, and local features for multi-scale reconstruction.

Result: Experiments show M3SR achieves better performance than state-of-the-art methods while being computationally efficient.

Conclusion: M3SR effectively addresses the limitations of single-scale and single-perceptual approaches, enhancing hyperspectral image reconstruction.
...
TL;DR: ReCo-KD is a lightweight training framework that transfers detailed and contextual knowledge from a high-capacity teacher to a compact student network, improving 3D medical image segmentation efficiency without custom student design.


<details>
  <summary>Details</summary>
Motivation: Existing state-of-the-art models for 3D medical image segmentation are too large for clinics with limited computing resources, while lightweight models suffer performance loss.

Method: Proposes Region- and Context-aware Knowledge Distillation (ReCo-KD), integrating Multi-Scale Structure-Aware Region Distillation (MS-SARD) and Multi-Scale Context Alignment (MS-CA) to transfer fine-grained and contextual knowledge.

Result: The distilled lightweight model achieves accuracy close to the teacher model while significantly reducing parameters and inference latency, validated on multiple datasets.

Conclusion: ReCo-KD is a practical solution for clinical deployment, balancing accuracy and computational efficiency in 3D medical image segmentation.
...
TL;DR: Efficient DiT framework for mobile/edge devices combines compact architecture, elastic training, and knowledge-guided distillation for high-quality, low-latency image generation.


<details>
  <summary>Details</summary>
Motivation: Address high computational/memory costs of DiTs for practical on-device deployment.

Method: Compact DiT with sparse attention, elastic training optimizing sub-DiTs, and knowledge-guided distillation pipeline.

Result: Achieves transformer-level quality under resource constraints, enabling real-time on-device use (e.g., 4-step generation).

Conclusion: Framework enables scalable, efficient, high-quality diffusion models for diverse hardware.
...
TL;DR: IQARAG is a training-free framework using RAG to enhance LMMs' IQA performance by retrieving quality-variant reference images with MOSs, avoiding costly fine-tuning.


<details>
  <summary>Details</summary>
Motivation: Existing LMMs require expensive fine-tuning for IQA tasks. IQARAG aims to provide a resource-efficient alternative.

Method: IQARAG retrieves quality-variant reference images with MOSs, integrating them into prompts for LMMs via three phases: Retrieval Feature Extraction, Image Retrieval, and Integration & Quality Score Generation.

Result: IQARAG significantly improves LMMs' IQA performance across datasets like KADID, KonIQ, LIVE Challenge, and SPAQ.

Conclusion: IQARAG offers a practical, training-free solution for boosting LMMs' IQA capabilities, outperforming fine-tuning methods in efficiency.
...
TL;DR: The paper introduces YOLOBirDrone, a vision-based drone detection system that improves accuracy in distinguishing drones from birds using advanced modules and a new dataset.


<details>
  <summary>Details</summary>
Motivation: Drone misuse for attacks creates safety concerns, and current vision-based systems struggle with accuracy, especially in differentiating small drones and birds.

Method: Proposes YOLOBirDrone with components like AELAN, MPDA, and RMPDA for better feature extraction and classification, using the new BirDrone dataset.

Result: The system achieves ~85% detection accuracy, outperforming existing methods in distinguishing drones and birds.

Conclusion: YOLOBirDrone's novel architecture and dataset significantly enhance detection accuracy, addressing a critical safety challenge in drone misuse.
...
TL;DR: UM-Text is a unified multimodal model for visual text editing via natural language, leveraging a Visual Language Model (VLM) and UM-Encoder for style-consistent results.


<details>
  <summary>Details</summary>
Motivation: Address the challenge of generating visual text that aligns stylistically with reference images, overcoming previous methods' lack of stylistic consistency.

Method: Proposes UM-Text with VLM for context understanding and UM-Encoder for embedding fusion. Includes regional consistency loss and a three-stage training strategy.

Result: Achieves state-of-the-art performance on benchmarks, supported by UM-DATA-200K dataset.

Conclusion: UM-Text effectively handles visual text editing with style consistency, validated by extensive results.
...
TL;DR: The paper introduces a novel GAN model called IGAN, combining inception-inspired and dilated convolutions to improve image quality and training stability, achieving better FID and IS scores than state-of-the-art GANs.


<details>
  <summary>Details</summary>
Motivation: GANs often struggle with mode collapse and unstable gradients. The goal is to develop a model that balances high-quality image generation with training stability.

Method: IGAN incorporates deeper inception-inspired and dilated convolutions, along with dropout and spectral normalization in both generator and discriminator.

Result: IGAN achieves FID scores of 13.12 and 15.08 on CUB-200 and ImageNet, and IS scores of 9.27 and 68.25, outperforming existing GANs.

Conclusion: IGAN successfully balances stability and quality, offering a scalable and efficient framework for high-fidelity image synthesis.
...
TL;DR: BioMorphNet integrates WSIs and gene expression for better cancer diagnosis, improving classification by 2.67%-6.29% and aiding biomarker discovery.


<details>
  <summary>Details</summary>
Motivation: Existing methods lack focus on spatial transcriptomics and patch-level applications.

Method: BioMorphNet combines tissue morphology and gene expression via graph modeling and clinical pathway features.

Result: Improved classification metrics by 2.67%-6.29% for three cancer types.

Conclusion: BioMorphNet enhances tumor localization and biomarker discovery.
...
TL;DR: The paper introduces the Individualized Exploratory Transformer (IET) with a novel attention mechanism (IEA) for Single Image Super-Resolution (SISR), improving efficiency and performance by enabling adaptive token selection.


<details>
  <summary>Details</summary>
Motivation: Transformer-based SISR methods are computationally expensive due to attention mechanisms. Fixed-group attention overlooks token asymmetry, limiting flexibility. The goal is to enhance efficiency without sacrificing accuracy.

Method: Proposes the Individualized Exploratory Transformer (IET) with Individualized Exploratory Attention (IEA), allowing tokens to adaptively select attention candidates for precise, efficient computation.

Result: IET achieves state-of-the-art performance on SR benchmarks while maintaining computational efficiency.

Conclusion: The IET framework with IEA successfully addresses inefficiencies in transformer-based SISR by enabling token-adaptive attention, improving both performance and computational cost.
...
TL;DR: The paper investigates how Vision-Language Models (VLMs) perform under degraded visual perception in safety-critical applications like autonomous driving, revealing significant semantic misalignments despite moderate drops in traditional metrics.


<details>
  <summary>Details</summary>
Motivation: To understand the robustness of VLMs in real-world scenarios where perception degradation (e.g., poor visibility) could impact safety-critical decision-making.

Method: The study uses semantic segmentation on Cityscapes with controlled perception corruptions, evaluating VLMs' semantic alignment through new metrics for hallucination, omission, and safety misinterpretation.

Result: VLMs exhibit severe semantic misalignments (e.g., hallucinations, omissions) even when segmentation metrics show only moderate degradation, indicating a disconnect between pixel-level and semantic robustness.

Conclusion: Current VLMs lack reliable semantic alignment under perception degradation, necessitating new evaluation frameworks for safety-critical applications.
...
TL;DR: Geo-NVS-w is a geometry-aware framework for novel view synthesis from unstructured image collections, addressing geometric inconsistencies with an SDF-based representation and Geometry-Preservation Loss. It achieves competitive rendering and reduces energy use by 4-5x.


<details>
  <summary>Details</summary>
Motivation: Existing methods for novel view synthesis from in-the-wild images often lack geometric grounding, leading to inconsistencies. Geo-NVS-w aims to solve this by integrating geometry-aware techniques.

Method: The framework uses a Signed Distance Function (SDF) for geometric representation and introduces a Geometry-Preservation Loss to maintain fine structural details during rendering.

Result: Geo-NVS-w achieves competitive rendering quality and reduces energy consumption by 4-5x compared to similar methods, producing photorealistic results with geometric coherence.

Conclusion: Geo-NVS-w is a robust solution for in-the-wild novel view synthesis, combining geometric accuracy with energy efficiency.
...
TL;DR: The paper proposes LoGo, a source-free unsupervised domain adaptation framework for semantic segmentation of 3D geospatial point clouds, addressing domain shifts and long-tailed distributions through local-global dual-consensus strategies.


<details>
  <summary>Details</summary>
Motivation: The need arises from domain shifts in geospatial data and data privacy concerns, which limit access to source-domain data, motivating the development of SFUDA methods.

Method: LoGo combines local class-balanced prototype estimation and global optimal transport-based distribution alignment, with a dual-consistency pseudo-label filtering mechanism.

Result: The framework effectively mitigates feature collapse in long-tailed distributions and corrects bias towards majority classes.

Conclusion: LoGo is a promising solution for SFUDA in geospatial point clouds, addressing key challenges like domain shifts and class imbalances.
...
TL;DR: An AI system using YOLOv8 and ResNet-50 improves pericoronitis diagnosis on panoramic radiographs with high accuracy and interpretability.


<details>
  <summary>Details</summary>
Motivation: To address challenges in diagnosing pericoronitis on panoramic radiographs by integrating AI-assisted assessment with anatomical localization, pathological classification, and interpretability.

Method: A two-stage deep learning pipeline: YOLOv8 detects third molars and classifies their positions and angulations, while ResNet-50 identifies radiographic features of pericoronitis. Grad-CAM provides interpretability.

Result: YOLOv8 achieved 92% precision and 92.5% mAP. ResNet-50 scored 88% F1 for normal cases and 86% for pericoronitis. Grad-CAM aligned with radiologists' impressions 84% of the time.

Conclusion: The AI system demonstrates potential for accurate and interpretable panoramic assessment, boosting clinical confidence.
...
TL;DR: The paper proposes a lightweight multimodal task platform combining BLIP-2 with YOLO models for UAVs, enhancing real-time visual understanding with minimal computational overhead.


<details>
  <summary>Details</summary>
Motivation: Addressing the high computational cost of large Vision language models for UAV edge devices with limited resources.

Method: Integrates BLIP-2 with YOLO-World and YOLOv8-Seg, uses content-aware key frame sampling, and implements prompt optimization for multi-task adaptation.

Result: Enables precise object detection, instance segmentation, and video-level interactive tasks without task-specific fine-tuning.

Conclusion: The platform effectively extends BLIP-2's capabilities for UAV applications while maintaining computational efficiency.
...
TL;DR: SPARK is a real-time multi-camera 3D reconstruction framework addressing extrinsic uncertainty and multi-view fusion, excelling in accuracy and scalability.


<details>
  <summary>Details</summary>
Motivation: Real-time 3D reconstruction faces challenges in multi-view fusion, extrinsic calibration, and scalability for large setups.

Method: SPARK combines online extrinsic estimation with confidence-driven point cloud fusion, ensuring consistency and noise suppression.

Result: SPARK outperforms existing methods in accuracy, stability, and real-time performance for large-scale setups.

Conclusion: SPARK is effective and scalable for dynamic, large-scale multi-camera 3D reconstruction tasks.
...
TL;DR: Proposes MMLGNet, a framework aligning remote sensing modalities with natural language using CLIP-inspired contrastive learning, outperforming visual-only methods.


<details>
  <summary>Details</summary>
Motivation: Addresses the need for fusing spectral, spatial, and geometric information in multimodal Earth observation data for semantic understanding.

Method: Uses modality-specific encoders and aligns visual features with textual embeddings via bi-directional contrastive learning.

Result: Achieves strong performance with simple CNN-based encoders on benchmark datasets.

Conclusion: Demonstrates the significant benefit of language supervision in remote sensing tasks.
...
TL;DR: A local patch-based retargeting method transfers facial animations from source videos to stylized 3D characters, preserving semantic meaning despite variations in facial proportions.


<details>
  <summary>Details</summary>
Motivation: Retargeting facial motion to stylized or exaggerated 3D characters is challenging due to deviations from human facial structures. Preserving semantic meaning requires considering the target character's unique structure and motion range.

Method: Proposes a three-module approach: Automatic Patch Extraction, Reenactment Module, and Weight Estimation Module to transfer animations while maintaining semantics.

Result: Experiments show successful transfer of semantic facial expressions to stylized characters with varying feature proportions.

Conclusion: The method effectively addresses retargeting challenges for stylized characters, ensuring semantic preservation in animations.
...
TL;DR: The paper proposes Cardiac Reasoning Template (CRT) and CardiacMind to enhance echocardiographic reasoning in MLLMs, improving diagnostic accuracy and clinician agreement.


<details>
  <summary>Details</summary>
Motivation: Addressing the limitations of existing echocardiography foundation models and MLLMs in capturing relationships between measurements and clinical manifestations, and reducing costly reasoning path construction.

Method: Introduces CRT for stepwise diagnostic procedures and CardiacMind, a reinforcement learning scheme with novel rewards (PQtR, PQlR, ESR) to enhance reasoning.

Result: Achieves a 48% improvement in multiview echocardiographic diagnosis and 5% improvement on CardiacNet-PAH, with 93.33% clinician agreement.

Conclusion: The proposed framework effectively integrates cardiologist-like reasoning into MLLMs, streamlining diagnostics and improving accuracy.
...
TL;DR: The paper introduces NAR, a noise-adaptive regularization method for multi-label classification in remote sensing, addressing additive and subtractive label noise with a confidence-based approach.


<details>
  <summary>Details</summary>
Motivation: To handle noisy annotations in multi-label classification (MLC) for remote sensing, where existing methods fail to distinguish between additive and subtractive noise.

Method: Proposes NAR, a semi-supervised framework combining confidence-based label handling (retain, deactivate, or correct labels) with early-learning regularization (ELR).

Result: NAR outperforms existing methods, especially under subtractive and mixed noise, by adaptively suppressing and correcting noisy annotations.

Conclusion: NAR's noise-adaptive approach effectively improves robustness in MLC for remote sensing, particularly in noisy annotation scenarios.
...
TL;DR: The paper proposes a Static-Dynamic Collaboration (SDC) framework for Few-shot class-incremental learning (FSCIL), dividing the task into Static Retaining Stage (SRS) and Dynamic Learning Stage (DLS) to balance old knowledge retention and new class adaptation.


<details>
  <summary>Details</summary>
Motivation: To address the stability-plasticity dilemma in FSCIL, where retaining old knowledge while learning new classes with limited data is challenging.

Method: SDC framework divides FSCIL into SRS (training an initial model with base session data and preserving static memory) and DLS (introducing a dynamic projector for incremental learning).

Result: Extensive experiments on three benchmarks and a real-world dataset show state-of-the-art performance.

Conclusion: The SDC framework effectively balances stability and plasticity in FSCIL, achieving superior performance.
...
TL;DR: The study improves NACT response prediction in HGSOC using radiomics and ML, focusing on feature robustness and accuracy across different anatomical lesions.


<details>
  <summary>Details</summary>
Motivation: HGSOC is often diagnosed late, and ~40% of patients respond poorly to NACT. Radiomics with ML offers a non-invasive way to predict NACT response.

Method: Used automated randomization for robust feature selection, analyzing pre- and post-NACT CT scans with four response metrics. Validated on independent cohorts.

Result: Best prediction performance was AUC 0.83 for VolR using all lesions. CRS (AUC 0.77) and DiaR (AUC 0.76) predictions varied by lesion site.

Conclusion: Robust feature selection enhances radiomics model reliability for clinical use in HGSOC. Future research should focus on real-time clinical applications.
...
TL;DR: A Modality-Decoupled RGB-T detection framework (MDQF) balances modality complementation and separation by using query fusion between RGB and TIR branches, optimizing each independently and outperforming existing methods.


<details>
  <summary>Details</summary>
Motivation: Addresses the challenge of robust RGB-Thermal (RGB-T) detection under extreme conditions where one modality may degrade, disrupting detection.

Method: Proposes MDQF with DETR-like detectors for RGB and TIR images, using query fusion between branches to exclude degraded modality and improve predictions.

Result: Achieves superior performance and better modality independence compared to existing RGB-T detectors, with flexibility for unpaired data.

Conclusion: MDQF effectively balances modality complementation and separation, enhancing robustness and performance in diverse conditions.
...
TL;DR: The paper proposes an automated framework using Vision-Language Models (VLMs) for building massing generation, introduces the CoMa-20K dataset, and benchmarks VLMs' performance, revealing task complexity and future research potential.


<details>
  <summary>Details</summary>
Motivation: To reduce reliance on manual effort and intuition in architectural design by automating building massing generation using data-driven methods.

Method: Develops an automated framework leveraging VLMs for conditional massing generation, supported by the new CoMa-20K dataset.

Result: Experiments show VLMs can produce context-sensitive massing options, though task complexity remains high.

Conclusion: The CoMa-20K dataset and VLM benchmark provide a foundation for future research in data-driven architectural design.
...
TL;DR: A framework decouples driver appearance from behavior cues in VLMs to improve distracted driving detection.


<details>
  <summary>Details</summary>
Motivation: Distracted driving causes traffic collisions; existing VLM-based detectors struggle due to entanglement of appearance and behavior cues.

Method: Proposes a subject decoupling framework to remove appearance influence and orthogonalizes text embeddings via Stiefel manifold projection.

Result: Demonstrates consistent improvements over prior baselines.

Conclusion: The approach shows promise for practical road-safety applications by emphasizing distraction-relevant evidence.
...
TL;DR: HazardForge introduces a pipeline to generate hazardous scenarios for evaluating Vision Language Models (VLMs), addressing gaps in existing benchmarks. MovSafeBench, created using HazardForge, shows VLMs struggle with anomalous objects, especially in motion-related scenarios.


<details>
  <summary>Details</summary>
Motivation: Existing benchmarks lack coverage of diverse hazardous scenarios, particularly those with spatio-temporal dynamics, limiting the evaluation of VLMs in complex environments.

Method: HazardForge leverages image editing models and layout decision algorithms to synthesize hazardous scenarios, validated for realism. MovSafeBench, a MCQ benchmark, is constructed with 7,254 images and QA pairs across 13 object categories.

Result: VLMs perform notably worse in scenarios involving anomalous objects, with the largest performance drop observed in situations requiring nuanced motion understanding.

Conclusion: HazardForge and MovSafeBench effectively address the gap in evaluating VLMs for hazardous scenarios, revealing significant limitations in VLM performance under anomalous conditions.
...
TL;DR: CoEvo is a training-free, test-time framework for zero-shot OOD detection that dynamically adapts textual and visual proxies, improving detection accuracy and robustness under distribution shift.


<details>
  <summary>Details</summary>
Motivation: Reliable zero-shot OOD detection is crucial for vision-language models in open-world settings, but existing methods suffer from sparse semantic sampling and static proxies, leading to cross-modal misalignment and unstable predictions.

Method: CoEvo introduces a proxy-aligned co-evolution mechanism with two evolving proxy caches: it dynamically mines textual negatives based on test images and refines visual proxies, realigning cross-modal similarities and enlarging OOD margins. It also dynamically re-weights dual-modal proxy contributions for robust OOD scoring.

Result: CoEvo outperforms baselines, achieving a 1.33% AUROC improvement and a 45.98% reduction in FPR95 on ImageNet-1K.

Conclusion: CoEvo's bidirectional, adaptive approach effectively addresses the limitations of static proxies in zero-shot OOD detection, delivering state-of-the-art performance.
...
TL;DR: An IoT-based smart aquarium system using ESP32 and multiple sensors automates water quality monitoring and control, achieving high accuracy and reliability with minimal manual intervention.


<details>
  <summary>Details</summary>
Motivation: Traditional manual methods for aquarium water quality monitoring are inefficient and error-prone, necessitating a more reliable and automated solution.

Method: The system integrates ESP32 with pH, TDS, temperature, and turbidity sensors, along with actuators like servo feeders and water pumps. It includes edge processing, cloud connectivity via Blynk IoT, and intelligent alerts.

Result: The system achieved 96% sensor accuracy, 1.2-second anomaly response time, and 97% operational reliability in a 10-liter aquarium test.

Conclusion: The IoT solution proves cost-effective and efficient for aquarium maintenance, enhancing accessibility and reliability for residential and commercial use.
...
TL;DR: PKI enhances FSCIL by integrating prior knowledge through cascading projectors, addressing catastrophic forgetting and overfitting while reducing resource use.


<details>
  <summary>Details</summary>
Motivation: To tackle catastrophic forgetting and overfitting in FSCIL by leveraging prior knowledge effectively.

Method: PKI uses a backbone, projectors, classifier, and memory, finetuning new projectors and classifier incrementally.

Result: PKI outperforms state-of-the-art methods on benchmarks and offers resource-efficient variants.

Conclusion: PKI successfully balances prior knowledge utilization and new class learning, improving FSCIL performance.
...
TL;DR: EfficientFSL is a query-only fine-tuning framework for Vision Transformers (ViTs) in few-shot classification, reducing computational overhead while maintaining high accuracy.


<details>
  <summary>Details</summary>
Motivation: Fine-tuning large models like ViTs is resource-intensive, making them impractical for low-resource scenarios. EfficientFSL addresses this gap.

Method: Introduced lightweight trainable blocks (Forward, Combine, Support-Query Attention) to synthesize task-specific queries and fuse multi-layer outputs.

Result: Achieves state-of-the-art performance on four in-domain and six cross-domain few-shot datasets with minimal trainable parameters.

Conclusion: EfficientFSL effectively balances performance and computational efficiency, making ViTs viable for real-world low-resource applications.
...
TL;DR: The paper proposes using LLMs for Neural Architecture Search (NAS) to optimize channel configurations in deep neural networks, leveraging code generation and AST mutations to overcome data scarcity. Experiments on CIFAR-100 show significant accuracy improvements.


<details>
  <summary>Details</summary>
Motivation: Traditional methods for optimizing layer specifications in deep neural networks are constrained by combinatorial challenges and computational budgets. LLMs offer a novel approach to NAS by reasoning about architectural code structure.

Method: The authors frame channel configuration search as conditional code generation tasks, using LLMs to refine architectures based on performance data. AST mutations generate a large corpus of valid architectures to train the LLM.

Result: Experiments on CIFAR-100 demonstrate statistically significant accuracy improvements, showing the LLM can learn and apply complex design patterns.

Conclusion: The LLM-driven approach effectively acquires architectural priors, outperforming random search and proving the potential of language-driven design in deep learning.
...
TL;DR: The paper proposes CD$^2$, a framework combining dataset distillation (DDM) and distillation constraints (DCM) to tackle catastrophic forgetting in few-shot class-incremental learning (FSCIL).


<details>
  <summary>Details</summary>
Motivation: Existing FSCIL methods fail to preserve essential knowledge due to equal treatment of incremental classes. This paper aims to address catastrophic forgetting by focusing on knowledge distillation.

Method: CD$^2$ includes a dataset distillation module (DDM) to synthesize condensed samples and a distillation constraint module (DCM) with a designed loss to preserve prior knowledge.

Result: Experiments on three datasets demonstrate CD$^2$ outperforms state-of-the-art methods in FSCIL.

Conclusion: CD$^2$ effectively mitigates catastrophic forgetting by distilling and preserving essential knowledge, enhancing FSCIL performance.
...
TL;DR: VideoHEDGE is a framework for detecting hallucinations in video-VLMs, using entropy-based reliability scores. It outperforms existing metrics, especially with high distortion, and offers efficient embedding-based clustering.


<details>
  <summary>Details</summary>
Motivation: Hallucinations in video-VLMs are frequent and confident, but current uncertainty metrics don't align well with correctness, necessitating a better detection method.

Method: VideoHEDGE generates baseline and high-temperature answers from clean and perturbed video clips, clusters outputs into hypotheses, and computes reliability scores (SE, RadFlag, VASE). It uses NLI or embedding-based clustering.

Result: VASE achieves the highest ROC-AUC across three Video-VLMs, especially under distortion. Embedding-based clustering matches NLI performance with lower cost. Domain fine-tuning reduces hallucinations but improves calibration modestly.

Conclusion: VideoHEDGE effectively detects hallucinations in video-VLMs, with VASE as the top-performing metric. The framework is scalable and reproducible, supported by an open-source library.
...
TL;DR: REVNET is a rotation-equivariant framework for point cloud completion, addressing limitations of rotation-variant methods by using Vector Neuron networks and anchors.


<details>
  <summary>Details</summary>
Motivation: Existing point cloud completion methods struggle with rotation-variance and require canonical poses, limiting real-world applicability.

Method: Proposes REVNET, using Vector Neuron networks, equivariant anchors, and a Missing Anchor Transformer to predict missing details.

Result: Outperforms state-of-the-art on synthetic MVP dataset and achieves competitive results on real-world KITTI without pose alignment.

Conclusion: REVNET offers robust, rotation-equivariant point cloud completion, improving accuracy and practicality for real-world applications.
...
TL;DR: MoCha is a novel framework for controllable video character replacement using only a single frame mask, avoiding limitations like occlusions and illumination challenges through innovative techniques like condition-aware RoPE and RL post-training. It outperforms existing methods.


<details>
  <summary>Details</summary>
Motivation: The paper addresses the challenge of video character replacement without relying on paired data or explicit structural guidance, which often leads to artifacts in complex scenarios.

Method: MoCha uses a single arbitrary frame mask, introduces condition-aware RoPE, employs RL-based post-training, and constructs specialized datasets (UE5-rendered, expression-driven, and augmented) to enhance training.

Result: MoCha significantly outperforms state-of-the-art methods in handling occlusions, interactions, poses, and illumination, achieving better visual and temporal consistency.

Conclusion: MoCha presents a robust solution for video character replacement, leveraging minimal input and innovative training approaches. The code will be released for further research.
...
TL;DR: The paper introduces WaveFormer, a Transformer-based vision model using wave propagation to efficiently capture spatial semantics, improving speed and accuracy over traditional methods.


<details>
  <summary>Details</summary>
Motivation: Traditional Transformers lack principled spatial propagation of semantic information; wave-based modeling offers an explicit, controlled alternative for visual dependencies.

Method: Feature maps are treated as spatial signals evolving via an underdamped wave equation, implemented as the Wave Propagation Operator (WPO) for efficient global interactions.

Result: WaveFormer models outperform standard ViTs and CNNs in accuracy, throughput (1.6x), and FLOPs (30% fewer), capturing both global and high-frequency details.

Conclusion: Wave propagation complements heat-based methods, enhancing visual semantics modeling with competitive performance and efficiency.
...
TL;DR: The paper proposes two interpretable and patient-specific methods for automated knee MRI assessment: radiomic fingerprints and healthy personas, achieving comparable or superior performance to deep learning models.


<details>
  <summary>Details</summary>
Motivation: To improve accuracy and interpretability in automated knee MRI assessment, addressing limitations of traditional radiomics and end-to-end deep learning.

Method: Introduces radiomic fingerprints (patient-specific feature sets) and healthy personas (synthesized pathology-free baselines) using MRI data and diffusion models.

Result: Both approaches match or outperform state-of-the-art DL models while enhancing interpretability.

Conclusion: Combining radiomic fingerprints and healthy personas provides accurate, interpretable tools for clinical tasks and biomarker discovery.
...
TL;DR: SfMamba is a new framework for source-free domain adaptation (SFDA) that improves domain-invariant feature learning using channel-wise scanning and semantic-consistent shuffling, outperforming existing methods in performance and efficiency.


<details>
  <summary>Details</summary>
Motivation: Addressing the limitations of current SFDA methods in balancing perception field and computational efficiency, and improving domain alignment under significant domain shifts.

Method: Introduces Channel-wise Visual State-Space block for domain-invariant feature extraction and Semantic-Consistent Shuffle strategy to maintain spatial robustness.

Result: SfMamba achieves superior performance across multiple benchmarks while maintaining parameter efficiency.

Conclusion: SfMamba offers a practical and efficient solution for SFDA, advancing the field with its innovative techniques.
...
TL;DR: The paper addresses the overlooked issue of uncertainty calibration in vision-language models (VLMs) during test-time prompt-tuning (TPT), proposing Semantic Orthogonal Calibration (SoC) to improve calibration without sacrificing discriminative performance.


<details>
  <summary>Details</summary>
Motivation: The motivation is to address the lack of focus on uncertainty calibration in VLMs used for critical systems like healthcare or autonomous driving, where accurate uncertainty estimates are crucial.

Method: The method introduces Semantic Orthogonal Calibration (SoC), a Huber-based regularizer that ensures smooth separation of prototypes while maintaining semantic proximity, countering the overconfidence caused by fully orthogonal constraints.

Result: Empirical results show that SoC consistently enhances calibration performance and retains competitive discriminative capabilities compared to prior orthogonality-based approaches.

Conclusion: The paper concludes that SoC effectively improves calibration in VLMs, offering a balanced solution that avoids the pitfalls of fully orthogonal constraints.
...
TL;DR: CtrlFuse is a controllable infrared and visible image fusion framework that dynamically adapts to semantic prompts, improving both fusion quality and downstream task performance.


<details>
  <summary>Details</summary>
Motivation: Existing fusion methods lack adaptability to diverse semantic targets or ignore downstream task needs, prompting the need for an interactive, controllable approach.

Method: CtrlFuse uses a multi-modal feature extractor, reference prompt encoder (RPE), and prompt-semantic fusion module (PSFM) to dynamically encode and inject task-specific semantics guided by mask prompts.

Result: The framework achieves state-of-the-art fusion controllability and segmentation accuracy, with the adapted task branch outperforming the original segmentation model.

Conclusion: CtrlFuse successfully bridges the gap between image fusion and downstream tasks, offering interactive and dynamic fusion capabilities.
...
TL;DR: SafeRedir is a lightweight inference-time framework for robust unlearning in image generation models, avoiding costly retraining and maintaining benign generation quality by redirecting unsafe prompts.


<details>
  <summary>Details</summary>
Motivation: IGMs often memorize and reproduce unsafe or copyrighted content, posing safety risks. Existing unlearning methods are costly, degrade quality, or lack robustness.

Method: SafeRedir uses token-level embedding redirection without modifying models, featuring a safety classifier and delta generator for precise semantic control.

Result: Effective unlearning, high semantic preservation, robust image quality, and resistance to adversarial attacks across diffusion backbones.

Conclusion: SafeRedir offers plug-and-play compatibility, broad applicability, and improved safety for IGMs.
...
TL;DR: The paper proposes a reliability framework for deepfake detection, evaluating four key aspects: transferability, robustness, interpretability, and computational efficiency, while highlighting progress and limitations.


<details>
  <summary>Details</summary>
Motivation: Deepfakes have both positive and negative societal impacts, but existing detection methods lack comprehensive evaluation beyond classification performance.

Method: A reliability assessment framework is introduced, focusing on transferability, robustness, interpretability, and computational efficiency. Five state-of-the-art methods are analyzed.

Result: The analysis shows significant progress in deepfake detection but also uncovers critical limitations.

Conclusion: The proposed framework provides a more holistic evaluation of deepfake detection methods, addressing gaps in current assessments.
...
TL;DR: Salience-SGG addresses the long-tailed distribution issue in Scene Graph Generation (SGG) by focusing on spatially salient triplets, improving performance without sacrificing spatial understanding.


<details>
  <summary>Details</summary>
Motivation: SGG models suffer from biases due to long-tailed predicate distributions, leading to poor performance on rare relations. Existing debiasing methods often neglect spatial understanding.

Method: Salience-SGG uses an Iterative Salience Decoder (ISD) and semantic-agnostic salience labels to prioritize spatially salient triplets.

Result: The framework achieves state-of-the-art performance on Visual Genome, Open Images V6, and GQA-200 datasets and enhances spatial understanding in existing Unbiased-SGG methods.

Conclusion: Salience-SGG provides a balanced solution by improving spatial awareness while addressing bias, outperforming current debiasing approaches.
...
TL;DR: ISLA, a deep learning model for acute ischemic stroke lesion segmentation, was developed and optimized with a focus on loss function, architecture, and attention mechanisms, outperforming existing methods.


<details>
  <summary>Details</summary>
Motivation: Accurate and automatic segmentation of acute ischemic stroke lesions in MRI is crucial for diagnosis and management, but existing models vary in configuration and lack public availability.

Method: ISLA was developed by systematically optimizing loss functions, convolutional architecture, deep supervision, and attention mechanisms, and trained on multicenter data. Unsupervised domain adaptation was also explored.

Result: ISLA outperformed two state-of-the-art methods on an external test set, demonstrating robust performance for lesion segmentation.

Conclusion: ISLA provides an effective solution for acute ischemic stroke lesion segmentation, with publicly available codes and models to ensure reproducibility and reuse.
...
TL;DR: The paper introduces UR-Bench, a benchmark for evaluating multimodal large language models (MLLMs) on ultra-high-resolution imagery, and proposes an agent-based framework with specialized tools for efficient processing.


<details>
  <summary>Details</summary>
Motivation: Existing benchmarks lack ultra-high-resolution images, limiting evaluation of MLLMs' reasoning capabilities in complex visual scenarios.

Method: The authors create UR-Bench with ultra-high-resolution images and questions, and develop an agent-based framework using Semantic Abstraction and Retrieval tools.

Result: The proposed framework outperforms end-to-end MLLMs, demonstrating its effectiveness in handling ultra-high-resolution reasoning tasks.

Conclusion: UR-Bench and the agent-based framework address gaps in evaluating MLLMs for ultra-high-resolution imagery, showing promise for future applications.
...
TL;DR: CycleGAN translates multi-channel fluorescence microscopy images to pseudo H&E-stained histopathology images, preserving morphology and enabling integration with standard workflows.


<details>
  <summary>Details</summary>
Motivation: Fluorescence microscopy provides complementary data to H&E staining, but translating it to H&E-like format aids pathologists' interpretation and workflow integration.

Method: Uses CycleGAN with ResNet-based generators and PatchGAN discriminators, trained via adversarial, cycle-consistency, and identity losses on unpaired fluorescence and H&E images.

Result: Generates realistic pseudo H&E images retaining morphological structures and adopting H&E-like colors from fluorescence data.

Conclusion: The method successfully bridges fluorescence and H&E domains, facilitating familiar visualization and analysis pipeline compatibility.
...
TL;DR: MCAN introduces a Multi-Cue Aggregation Network leveraging spatial, frequency-domain, and chromaticity cues to enhance AI-generated image detection, achieving top performance on benchmarks.


<details>
  <summary>Details</summary>
Motivation: Existing AI-generated image detectors rely on model-specific features, causing poor generalization. MCAN addresses this by integrating diverse cues for robust detection.

Method: MCAN combines input images, high-frequency components, and Chromatic Inconsistency cues dynamically via a mixture-of-encoders adapter for adaptive feature representation.

Result: MCAN outperforms top methods by up to 7.4% in average ACC on the GenImage dataset across eight generators, demonstrating superior generalization.

Conclusion: MCAN's unified multi-cue framework enhances detection robustness and generalization, setting a new state-of-the-art in AI-generated image detection.
...
TL;DR: DentalX improves dental disease detection by integrating structural context from semantic segmentation of dental anatomy, outperforming existing methods.


<details>
  <summary>Details</summary>
Motivation: Current object detection models for natural images struggle with dental diseases due to subtle visual cues in radiographs.

Method: Proposes DentalX with a structural context extraction module that learns semantic segmentation of dental anatomy to enhance disease detection.

Result: Experiments show DentalX significantly outperforms prior methods in detecting dental diseases and semantic segmentation.

Conclusion: Integrating structural context improves dental disease detection, demonstrating mutual benefits through task correlation.
...
TL;DR: The paper evaluates computer-vision methods for identifying Hula painted frogs using ventral images, finding deep local-feature matching outperforms global-feature models and proposing a scalable two-stage workflow for field use.


<details>
  <summary>Details</summary>
Motivation: Monitoring critically endangered amphibians requires non-invasive identification methods, as traditional marking is unsuitable.

Method: Compares deep local-feature matching (zero-shot) and global-feature embedding models, then implements a two-stage workflow combining both for scalability and accuracy.

Result: Local-feature matching achieves 98% top-1 accuracy; a two-stage workflow reduces runtime significantly while maintaining high accuracy (~96%).

Conclusion: Deep local-feature matching is superior for photo-identification in this species, and the two-stage workflow enables practical, non-invasive monitoring.
...
TL;DR: S3-CLIP integrates video super-resolution with CLIP-ReID to improve tracklet quality in person re-identification, achieving competitive performance in cross-view scenarios.


<details>
  <summary>Details</summary>
Motivation: Existing ReID methods often overlook tracklet quality, especially in challenging real-world scenarios. S3-CLIP addresses this gap by enhancing video resolution for better ReID performance.

Method: S3-CLIP combines super-resolution networks with a task-driven pipeline, adapting them to video-based ReID in cross-view conditions.

Result: The method achieves 37.52% mAP (aerial-to-ground) and 29.16% mAP (ground-to-aerial), with significant improvements in ranking accuracy (e.g., +11.24% Rank-1).

Conclusion: Video super-resolution can effectively enhance tracklet quality for ReID, particularly in challenging cross-view settings, as demonstrated by S3-CLIP's performance.
...
TL;DR: The paper introduces a 3D visual grounding data pipeline for auto-generating data and reasoning processes, leading to Reason3DVG-8B, a model that outperforms prior methods with significantly less training data.


<details>
  <summary>Details</summary>
Motivation: Recent 3D visual grounding models struggle due to limited reasoning abilities and high annotation costs. Synthetic data scaling shows poor cost-performance trade-offs.

Method: Proposes a data pipeline to auto-synthesize 3D visual grounding data with reasoning processes. Uses this data to fine-tune LLMs, resulting in Reason3DVG-8B.

Result: Reason3DVG-8B outperforms 3D-GRAND using only 1.6% of its training data, showing the pipeline's effectiveness.

Conclusion: Automated data synthesis and reasoning integration are crucial for advancing 3D visual grounding.
...
TL;DR: Motive is a scalable framework for attributing motion influence in video generation, isolating dynamics from appearance to improve curating fine-tuning data and enhancing motion quality.


<details>
  <summary>Details</summary>
Motivation: Understanding the impact of data on motion in video generation is understudied; Motive addresses this gap.

Method: Uses motion-weighted loss masks for efficient, scalable motion-specific influence computation in text-to-video models.

Result: Improves motion smoothness and dynamic degree, achieving a 74.1% human preference win rate.

Conclusion: Motive is the first framework to attribute motion influence in video generation, successfully guiding data curation for better temporal consistency.
...
TL;DR: 3AM enhances SAM2 with 3D-aware features from MUSt3R, improving geometry-consistent recognition without needing camera poses or preprocessing, achieving significant performance gains.


<details>
  <summary>Details</summary>
Motivation: The paper addresses limitations of SAM2 (reliance on appearance features) and traditional 3D methods (requiring preprocessing), aiming for a lightweight, RGB-only solution.

Method: Integrates MUSt3R's 3D-aware features into SAM2 via a Feature Merger, uses field-of-view aware sampling for reliable 3D correspondence learning.

Result: Achieves 90.6% IoU and 71.7% Positive IoU on ScanNet++, surpassing SAM2 by +15.9 and +30.4 points.

Conclusion: 3AM provides a robust, efficient solution for geometry-consistent video object segmentation without additional input requirements.
...
TL;DR: The paper exposes a vulnerability in invisible watermarks by treating watermark removal as a view synthesis problem, revealing that watermarks robust to traditional attacks fail against semantic-preserving viewpoint changes. A zero-shot diffusion-based framework effectively removes watermarks without detector access.


<details>
  <summary>Details</summary>
Motivation: To evaluate and improve the reliability of invisible watermarking schemes by identifying their vulnerabilities, particularly against sophisticated removal attacks exploiting semantic-preserving transformations.

Method: A zero-shot diffusion-based framework that applies controlled geometric transformations in latent space, using view-guided correspondence attention to maintain structural consistency during watermark removal.

Result: The method outperforms 14 baseline attacks, achieving state-of-the-art watermark suppression across 15 watermarking methods while preserving visual fidelity.

Conclusion: The study highlights a critical vulnerability in current watermarking schemes and proposes a robust solution, emphasizing the need for designs resilient to semantic-preserving attacks.
...
### [97] [LLM Review: Enhancing Creative Writing via Blind Peer Review Feedback](https://arxiv.org/abs/2601.08003)
*Weiyue Li,Mingxiao Song,Zhenda Shen,Dachuan Zhao,Yunfan Long,Yi Li,Yongce Li,Ruyi Yang,Mengyu Wang*

Main category: cs.CL

TL;DR: LLM Review, a peer-review-inspired framework, enhances creativity in LLMs by preserving divergent creative trajectories through independent revisions and targeted feedback, outperforming multi-agent baselines and even larger single-agent models.


<details>
  <summary>Details</summary>
Motivation: Large Language Models struggle with creative generation, and multi-agent frameworks often hinder creativity by causing content homogenization, prompting the need for a solution that balances interaction and creativity.

Method: Introduces LLM Review, a framework inspired by blind peer review, where agents exchange targeted feedback while revising independently to preserve creativity. Also proposes SciFi-100, a dataset combining LLM-as-a-judge scoring, human annotation, and novelty metrics for evaluation.

Result: LLM Review outperforms multi-agent baselines, and smaller models using this framework can surpass larger single-agent models, indicating that interaction structure can compensate for model scale.

Conclusion: The LLM Review framework effectively enhances creativity in LLMs by balancing interaction and independent revision, demonstrating that structured interaction can substitute for larger model scales.
...
TL;DR: Introduces State-Centric Retrieval, a unified RAG paradigm using 'states' to connect embedding models and rerankers, improving efficiency and maintaining performance.


<details>
  <summary>Details</summary>
Motivation: Traditional RAG systems suffer inefficiency due to lack of shared information between retrieval stages.

Method: Fine-tunes RWKV-based LLM into EmbeddingRWKV for state representation, then designs a state-based reranker.

Result: Achieves 5.4x-44.8x speedup in reranking and maintains 98.62% performance with only 25% of layers.

Conclusion: State-Centric Retrieval enhances efficiency and effectiveness in retrieval and reranking.
...
TL;DR: MedES introduces a dynamic benchmark and guardian-in-the-loop framework to align LLMs with Chinese medical ethics, showing improved performance over baselines.


<details>
  <summary>Details</summary>
Motivation: Aligning large language models (LLMs) with nuanced medical ethics in real-world healthcare scenarios is underexplored, especially in the Chinese context.

Method: Developed MedES benchmark from 260 authoritative sources, introduced guardian-in-the-loop framework with automated evaluator, and aligned a 7B-parameter LLM via supervised fine-tuning and preference optimization.

Result: The aligned model outperformed larger baselines in ethical tasks within the Chinese medical ethics context, improving quality and composite metrics.

Conclusion: MedES provides a practical framework for aligning LLMs with medical ethics in Chinese healthcare, adaptable to other contexts via modular corpus replacement.
...
TL;DR: The paper explores how LLMs enact human values in decision-making, revealing strong consistency across models but gaps between knowledge and action, similar to humans.


<details>
  <summary>Details</summary>
Motivation: The study aims to understand how LLMs represent and enact human values in real-world contexts, addressing gaps in current research on AI safety and social compatibility.

Method: The authors use ValAct-15k, a dataset of advice-seeking scenarios and traditional value questionnaires, to evaluate ten LLMs and human participants.

Result: LLMs show high cross-model consistency in decisions but weak alignment between self-reported and enacted values, mirroring human inconsistencies. Performance drops when instructed to 'hold' values.

Conclusion: Alignment training leads to normative value convergence in LLMs but does not resolve the incoherence between knowing and acting on values, resembling human behavior.
...
TL;DR: AI-text detectors perform well in their original domains but struggle with generalization across prompts, models, and domains; linguistic analysis reveals features like tense and pronouns influence performance.


<details>
  <summary>Details</summary>
Motivation: Prior work identifies generalization gaps in AI-text detectors but lacks understanding of their causes, prompting a study to explain these gaps through linguistic analysis.

Method: A benchmark was created with diverse texts from 6 prompts, 7 LLMs, and 4 domains. Detectors were fine-tuned and tested for generalization, with performance analyzed via linguistic feature shifts.

Result: Generalization accuracy correlates with linguistic features like tense and pronoun frequency, explaining performance variance across conditions.

Conclusion: Linguistic features play a key role in the generalization gaps of AI-text detectors, highlighting their importance for improving robustness.
...
TL;DR: A tri-tier evaluation framework assesses VLMs' cultural understanding in art, revealing automated metrics' unreliability and Western bias.


<details>
  <summary>Details</summary>
Motivation: To address the under-validated ability of VLMs in interpreting cultural meaning in art and provide a reliable assessment framework.

Method: A tri-tier framework: Tier I (automated coverage/risk), Tier II (rubric-based scoring), Tier III (calibration to human ratings). Evaluated 15 VLMs on 294 expert anchors.

Result: 5.2% MAE reduction; automated metrics unreliable; Western bias observed; cross-judge mismatch requires calibration.

Conclusion: The framework offers calibrated cultural-understanding scores for model selection and diagnostics, highlighting biases and calibration needs.
...
TL;DR: The paper introduces a pipeline for constructing multimodal fact-checking datasets in French and German, leveraging LLMs for evidence extraction and justification generation, and demonstrates its effectiveness through evaluations.


<details>
  <summary>Details</summary>
Motivation: The need for robust, explainable, and multilingual fact-checking resources due to limited existing datasets lacking multimodal evidence and structured annotations.

Method: A comprehensive pipeline aggregating ClaimReview feeds, scraping articles, normalizing verdicts, and enriching with metadata and visual content, using LLMs for evidence extraction and justification generation.

Result: Evaluation shows the pipeline enables fine-grained comparison of fact-checking practices, supports interpretable models, and aids multilingual misinformation research.

Conclusion: The pipeline lays groundwork for future multilingual, multimodal misinformation verification research.
...
TL;DR: VULCA-Bench is a multicultural art-critique benchmark designed to evaluate Vision-Language Models' cultural understanding beyond basic visual perception, focusing on higher-order cultural interpretation across eight traditions.


<details>
  <summary>Details</summary>
Motivation: Existing benchmarks for Vision-Language Models (VLMs) primarily assess low-level capabilities like object recognition and scene description, neglecting deeper cultural interpretation. VULCA-Bench addresses this gap by evaluating VLMs' ability to understand and critique art across diverse cultural contexts.

Method: The benchmark includes 7,410 image-critique pairs spanning eight cultural traditions, with bilingual (Chinese-English) coverage. Cultural understanding is measured using a five-layer framework (L1-L5), covering aspects from visual perception to philosophical aesthetics, and supported by expert-written critiques.

Result: Pilot results show that higher-layer cultural reasoning (L3-L5) is more challenging for VLMs compared to basic visual and technical analysis (L1-L2).

Conclusion: VULCA-Bench provides a comprehensive tool for assessing VLMs' cultural understanding, highlighting the need for models to advance beyond surface-level perception to interpret art meaningfully across cultures.
...
TL;DR: The paper advocates for a longitudinal NLP paradigm to handle time-ordered, person-indexed behavioral sequences, updating evaluation splits, metrics, inputs, and model internals for better ecological validity.


<details>
  <summary>Details</summary>
Motivation: NLP typically treats documents as independent, but longitudinal studies reveal nested, time-ordered data. Traditional methods fail to capture within-person dynamics and between-person differences.

Method: Proposes (1) cross-sectional/prospective evaluation splits, (2) metrics separating between-person differences, (3) sequence inputs for history, and (4) model internals with varying coarseness of latent states.

Result: Shows traditional document-level evaluation yields reversed conclusions compared to the proposed longitudinal approach on 17k diary transcripts with PTSD symptoms.

Conclusion: Calls for a shift from word-sequence to behavior-sequence paradigms in NLP for ecologically valid modeling of longitudinal data.
...
TL;DR: DyCP is a lightweight method for dynamic context management in LLMs, improving answer quality and reducing latency without predefined topics or extra LLM calls.


<details>
  <summary>Details</summary>
Motivation: LLMs struggle with degraded performance as dialogues lengthen, and existing methods are inefficient or disrupt continuity.

Method: DyCP dynamically segments and retrieves relevant memory at query time, preserving dialogue structure.

Result: DyCP improves answer quality and reduces latency across multiple benchmarks and LLMs.

Conclusion: Effective context management remains crucial despite LLMs' expanded context windows.
...
TL;DR: Concept Vector Projections (CVP) provide continuous sentiment scores aligned with human judgments, showing robustness across domains but revealing limitations in linearity assumptions.


<details>
  <summary>Details</summary>
Motivation: Sentiment analysis in the humanities needs contextualized, continuous scores. CVP offers a multilingual solution, but its portability and assumptions are unclear.

Method: Evaluated CVP across genres, historical periods, languages, and affective dimensions, examining corpus transferability and the linearity assumption.

Result: CVP transfers well across corpora with minimal performance loss but its linearity assumption is approximate, indicating room for improvement.

Conclusion: CVP is portable and effective for capturing sentiment patterns, though refinements to its linearity assumption could enhance accuracy.
...
TL;DR: Latent features in LLMs can trigger reasoning without CoT prompting, achieving comparable performance more efficiently.


<details>
  <summary>Details</summary>
Motivation: Understand why CoT prompting improves reasoning in LLMs and explore if it's the only mechanism for triggering reasoning.

Method: Analyze and intervene on LLMs' internal representations using Sparse Autoencoders (SAEs) to identify reasoning-related latent features.

Result: Steering a single latent feature improves reasoning accuracy without CoT, matching performance while being more efficient.

Conclusion: Multi-step reasoning in LLMs is supported by latent activations, and CoT is one effective but not the only way to trigger it.
...
TL;DR: Language models can perform universal computation through autoregressive output chaining, even when untrained, with training improving programmability rather than computational expressiveness.


<details>
  <summary>Details</summary>
Motivation: The study explores the computational capabilities of language models, challenging traditional views by demonstrating their inherent universal computation potential.

Method: The authors prove that autoregressive output chaining enables universal computation and analyze programmability via prompt engineering.

Result: Randomly initialized language models can execute any algorithm, with training enhancing ease of use via natural language interfaces.

Conclusion: Language models possess intrinsic computational power; training refines their programmability, not their fundamental capabilities.
...
TL;DR: The paper critiques current confidence estimation (CE) methods for LLMs, which focus only on calibration and discrimination, ignoring robustness, stability, and sensitivity to language variations. It proposes a new evaluation framework and shows existing CE methods often fail these metrics.


<details>
  <summary>Details</summary>
Motivation: Existing CE evaluations overlook critical aspects like robustness to prompt changes and sensitivity to semantic variations, which are crucial for real-world LLM reliability and user trust.

Method: The authors introduce a comprehensive framework assessing CE methods on three new metrics: robustness to prompt perturbations, stability across semantically equivalent answers, and sensitivity to semantically different answers.

Result: Common CE methods perform poorly on these new metrics, despite excelling in calibration or discrimination, revealing their limitations in practical LLM applications.

Conclusion: The proposed framework highlights gaps in current CE evaluations and guides the selection or design of more reliable CE methods for LLMs.
...
TL;DR: AdaJudge is a framework addressing limitations of static pooling in reward modeling by refining representations and using adaptive pooling, outperforming traditional methods.


<details>
  <summary>Details</summary>
Motivation: Static pooling strategies in reward modeling misalign with task-dependent preferences and have representational mismatches, prompting the need for adaptable solutions.

Method: AdaJudge refines backbone representations with gated refinement blocks and uses an adaptive multi-view pooling module for dynamic evidence routing and combining.

Result: AdaJudge outperforms traditional reward models and pooling baselines in experiments on RM-Bench and JudgeBench.

Conclusion: AdaJudge effectively addresses static pooling limitations, enhancing reward modeling performance through adaptive representation and aggregation.
...
TL;DR: The paper introduces a method for suggesting answerable queries in agentic RAG to improve user interactions when initial questions are unanswerable.


<details>
  <summary>Details</summary>
Motivation: Current agentic RAG systems struggle with unanswerable questions, leading to issues like hallucination. Query suggestions can enhance user interactions by providing viable alternatives.

Method: The study proposes robust dynamic few-shot learning to retrieve examples from relevant workflows, ensuring suggestions are answerable and relevant.

Result: Experiments on real-world datasets show the method outperforms baselines, producing more relevant and answerable suggestions.

Conclusion: The approach enables safer and more effective user interactions with agentic RAG by dynamically suggesting viable queries.
...
TL;DR: ACPS framework improves LLM prompting by reducing token usage and enhancing generalizability using causal reasoning and Sketch-of-Thought.


<details>
  <summary>Details</summary>
Motivation: Existing prompting methods like Chain-of-Thought suffer from excessive token usage and lack generalizability across diverse reasoning tasks.

Method: ACPS leverages structural causal models to infer causal effects and adaptively selects interventions (e.g., front-door adjustments), replacing verbose CoT with Sketch-of-Thought.

Result: ACPS outperforms existing baselines in accuracy, robustness, and computational efficiency across multiple reasoning benchmarks and LLMs.

Conclusion: ACPS offers a scalable and efficient solution for enhancing causal reasoning in LLMs while reducing token usage and inference costs.
...
TL;DR: ExoFormer introduces exogenous anchor projections outside the sequential layer stack to resolve the tension between stability and computation in transformers, achieving better performance and efficiency.


<details>
  <summary>Details</summary>
Motivation: The paper addresses the tension in transformers where early-layer projections must serve as stable references and effective computational blocks simultaneously.

Method: ExoFormer learns dedicated exogenous anchor projections outside the sequential layer stack and uses a unified normalized mixing framework across attention pathways.

Result: ExoFormer variants outperform internal-anchor counterparts, improve downstream accuracy by 2.13 points, and show superior data efficiency (1.84x fewer tokens). It also reduces attention sink by 2x.

Conclusion: ExoFormer's external anchors preserve token identity, allowing layers to specialize in refinement, despite signs of representation collapse. Codes and models are released for future research.
...
TL;DR: The paper presents the Reasoning Model Confidence estimation Benchmark (RMCB), evaluates representation-based methods for LRM confidence estimation, and reveals a trade-off between discrimination and calibration.


<details>
  <summary>Details</summary>
Motivation: Miscalibration in Large Reasoning Models (LRMs) reduces reliability in high-stakes domains, creating a need for accurate confidence estimation in their multi-step outputs.

Method: Introduces RMCB with 347,496 reasoning traces from six LRMs. Evaluates ten representation-based methods (sequential, graph-based, text-based) across diverse datasets.

Result: Text-based encoders achieve best AUROC (0.672), structurally-aware models best ECE (0.148). Architectural complexity doesn't outperform simpler baselines.

Conclusion: RMCB provides a comprehensive benchmark, exposes limitations of current paradigms, and highlights trade-offs in confidence estimation methods.
...
TL;DR: The paper introduces Qalb, an Urdu language model, addressing the underrepresentation of Urdu in NLP systems. It achieves state-of-the-art performance through continued pre-training and fine-tuning.


<details>
  <summary>Details</summary>
Motivation: Urdu, spoken by over 230 million people, is underrepresented in NLP. Existing models perform poorly due to Urdu's complex morphology and script.

Method: Qalb is developed via continued pre-training on 1.97B tokens of diverse Urdu text and fine-tuned on the Alif Urdu-instruct dataset.

Result: Qalb scores 90.34, outperforming Alif-1.0-Instruct (87.1) and LLaMA-3.1 8B-Instruct, achieving SOTA in seven tasks.

Conclusion: Continued pre-training and fine-tuning effectively adapt foundation models to low-resource languages like Urdu.
...
TL;DR: CT-SFT is a method for adapting LLMs to low-resource languages by updating only task-relevant attention heads, reducing catastrophic forgetting and improving cross-lingual accuracy with minimal parameter updates.


<details>
  <summary>Details</summary>
Motivation: Adapting LLMs to low-resource languages is challenging due to scarce labeled data, unstable full-model fine-tuning, and catastrophic forgetting during cross-lingual tuning.

Method: CT-SFT identifies sparse task-relevant attention heads using a label-balanced mean baseline and task-directional relevance scoring, then transfer learns by updating only those heads and LayerNorm via gradient masking.

Result: CT-SFT outperforms full fine-tuning in cross-lingual accuracy on NusaX-Senti and XNLI while updating fewer parameters. It also reduces catastrophic forgetting, preserving source-language competence.

Conclusion: CT-SFT offers a trade-off between editing circuit heads for harder transfers and preserving source mechanisms for easier ones, providing efficient adaptation for low-resource languages.
...
TL;DR: WISE-Flow is a workflow-centric framework designed to improve LLM-based agents by converting historical interactions into reusable workflows, reducing errors and variability.


<details>
  <summary>Details</summary>
Motivation: LLM-based agents often struggle with errors, repeat failures, and variability in new tasks. Manual fixes are costly and unscalable, prompting the need for self-evolving solutions.

Method: WISE-Flow induces workflows from historical interactions using prerequisite-augmented action blocks. It aligns agent trajectories to these workflows and performs feasibility reasoning for grounded actions.

Result: Experiments on ToolSandbox and τ²-bench demonstrate consistent improvements across base models.

Conclusion: WISE-Flow effectively reduces errors and variability in LLM-based agents by leveraging reusable workflows, offering a scalable solution.
...
TL;DR: SwiftMem is a query-aware agentic memory system that uses specialized indexing for efficient retrieval, overcoming latency bottlenecks in existing frameworks.


<details>
  <summary>Details</summary>
Motivation: Existing memory frameworks suffer from exhaustive retrieval across the entire storage layer, causing latency issues as memory grows, which hinders real-time agent interactions.

Method: SwiftMem employs temporal and semantic indexing (DAG-Tag) for sub-linear retrieval and introduces an embedding-tag co-consolidation mechanism to address fragmentation.

Result: SwiftMem achieves 47× faster search than state-of-the-art baselines while maintaining competitive accuracy on LoCoMo and LongMemEval benchmarks.

Conclusion: SwiftMem enables practical deployment of memory-augmented LLM agents by significantly improving retrieval efficiency.
...
TL;DR: Fine-tuning function vectors improves performance on relation-based tasks, enhances decoding, and aligns better with human judgments. Composite function vectors further boost analogy-solving abilities.


<details>
  <summary>Details</summary>
Motivation: To enhance the representation and manipulation of relational knowledge in language models for better interpretability and reasoning.

Method: Fine-tune function vectors with few examples, create composite vectors for analogical reasoning, and evaluate performance on tasks and benchmarks.

Result: Fine-tuned vectors outperform original ones in relation-based tasks and analogy problems, showing better alignment with human judgments.

Conclusion: Activation patching via function vectors is promising for improving relational knowledge encoding and reasoning in language models.
...
TL;DR: The paper explores prompt-based clarity evaluation of LLM responses using the CLARITY dataset, showing GPT-5.2 outperforms GPT-3.5 with structured prompting, especially chain-of-thought with few-shot examples.


<details>
  <summary>Details</summary>
Motivation: To investigate how prompt design affects automatic clarity evaluation in LLM responses, particularly in political question-answering.

Method: Compare GPT-3.5 baseline with GPT-5.2 under three prompting strategies (simple, chain-of-thought, and chain-of-thought with few-shot examples) using accuracy and class-wise metrics.

Result: GPT-5.2 improves clarity prediction accuracy from 56% to 63% with chain-of-thought and few-shot prompting. Evasion accuracy peaks at 34% with chain-of-thought, but topic detection improves to 74%.

Conclusion: Prompt design reliably enhances high-level clarity evaluation, but fine-grained evasion and topic detection remain challenging.
...
TL;DR: LogiSafetyGen and LogiSafetyBench address the gap in evaluating LLMs' regulatory compliance in high-stakes domains by synthesizing safety-critical traces and benchmarking compliance tasks. Larger LLMs often prioritize task completion over safety.


<details>
  <summary>Details</summary>
Motivation: Existing benchmarks overlook implicit regulatory compliance in LLMs, especially in high-stakes domains, necessitating a framework to evaluate and enforce safety constraints.

Method: LogiSafetyGen converts unstructured regulations into Linear Temporal Logic oracles and uses logic-guided fuzzing to create safety-critical traces. LogiSafetyBench includes 240 human-verified tasks for LLMs to generate compliant Python programs.

Result: Evaluation of 13 SOTA LLMs shows that larger models achieve better functional correctness but often neglect safety, leading to non-compliant behavior.

Conclusion: The study highlights the need for frameworks like LogiSafetyGen and benchmarks like LogiSafetyBench to ensure LLMs adhere to regulatory standards, especially in critical applications.
...
TL;DR: T-SPIN improves SPIN by incorporating historical advantages and entropy constraint for stable, reference-free fine-tuning, outperforming SPIN and matching supervised fine-tuning with fewer samples.


<details>
  <summary>Details</summary>
Motivation: SPIN's limitations include unstable optimization due to vanishing reward advantages and misalignment from reference policy use, prompting the need for T-SPIN.

Method: T-SPIN integrates historical advantages between iteratively generated responses and initial policy outputs, along with an entropy constraint for reference-free fine-tuning.

Result: T-SPIN outperforms SPIN and achieves comparable/better performance than supervised fine-tuning with only 25% samples.

Conclusion: T-SPIN enhances stability and performance in self-play fine-tuning, making it effective for data-scarce scenarios.
...
TL;DR: GAG (Generation-Augmented Generation) introduces a compact, representation-level interface to inject private expertise into LLMs, outperforming RAG baselines while maintaining general performance and enabling scalable multi-domain deployment.


<details>
  <summary>Details</summary>
Motivation: High-stakes domains require private knowledge injection into LLMs, but existing methods like fine-tuning and RAG have significant drawbacks (e.g., cost, brittleness).

Method: GAG treats private expertise as an expert modality, aligning it into the LLM's semantic space via a compact interface to avoid prompt-time evidence serialization.

Result: GAG improves specialist performance by 15.34% and 14.86% over RAG on two benchmarks and maintains general benchmarks' performance with scalable multi-domain activation.

Conclusion: GAG offers a robust, efficient solution for injecting private knowledge into LLMs, outperforming existing methods while enabling flexible multi-domain deployment.
...
TL;DR: The study finds that Mixture-of-Experts (MoE) model performance is determined by total parameters and expert sparsity, not just active parameters or memory constraints. A design principle is proposed to maximize total parameters while minimizing sparsity and the number of experts.


<details>
  <summary>Details</summary>
Motivation: The paper aims to address the insufficiency of using only total parameters and active parameters to describe an optimal MoE architecture, highlighting the importance of expert sparsity in performance.

Method: The study conducts a systematic analysis of MoE architectures, focusing on the interplay between total parameters, expert sparsity, and the number of experts and top-k selections.

Result: Performance is primarily influenced by total parameters and expert sparsity, with larger numbers of experts slightly penalizing performance. A design principle is derived to optimize these factors.

Conclusion: The findings offer a clear framework for MoE architecture design, emphasizing the need to maximize total parameters while minimizing sparsity and expert count under constraints.
...
TL;DR: The paper introduces a user-oriented simulation paradigm to generate authentic multi-turn dialogues for large reasoning models, addressing limitations of static toolsets and purely task-oriented designs.


<details>
  <summary>Details</summary>
Motivation: Existing datasets and approaches for tool-use capabilities in large reasoning models are limited by static toolsets and fail to mimic realistic, iterative human-agent interactions.

Method: Developed a framework using an LRM-based simulator to dynamically generate domain-specific tools and decoupled task generation from a user simulator mimicking human behavior.

Result: Produced high-density datasets with extended, authentic multi-turn dialogues, reflecting real-world problem-solving and multifaceted human-agent interactions.

Conclusion: The user-oriented simulation paradigm enhances scalability and authenticity in generating tool-use data, bridging the gap between task-solving and realistic human-agent collaboration.
...
TL;DR: Med-CoReasoner addresses multilingual gaps in medical reasoning by combining English and local-language reasoning, improving multilingual performance by 5%, especially in low-resource languages.


<details>
  <summary>Details</summary>
Motivation: Large language models perform well in English medical tasks but lag in local languages, limiting equitable global medical deployment.

Method: Med-CoReasoner integrates parallel English and local-language reasoning, abstracts them into structured concepts, and aligns local clinical knowledge with English reasoning.

Result: Med-CoReasoner improves multilingual reasoning by 5% on average, with significant gains in low-resource languages.

Conclusion: Med-CoReasoner effectively bridges multilingual gaps and produces clinically sound reasoning, as validated by expert evaluations.
...
TL;DR: DART is a reinforcement learning framework that enables spontaneous tool-use in long CoT reasoning, improving performance on benchmarks like AIME and GPQA-Diamond.


<details>
  <summary>Details</summary>
Motivation: Integrating tool-use into long Chain-of-Thought reasoning is underexplored due to data scarcity and challenges in maintaining intrinsic reasoning.

Method: DART uses rollout trees to discover tool-use opportunities and tree-based advantage estimation to reinforce beneficial tool-integrated behaviors.

Result: DART outperforms existing methods on benchmarks AIME and GPQA-Diamond.

Conclusion: DART successfully harmonizes tool execution with long CoT reasoning, demonstrating significant performance improvements.
...
TL;DR: Advanced prompting techniques enhance sentiment analysis in LLMs, with few-shot learning excelling in GPT-4o-mini and chain-of-thought boosting irony detection in gemini-1.5-flash.


<details>
  <summary>Details</summary>
Motivation: To improve sentiment analysis performance in large language models (LLMs) using advanced prompting techniques.

Method: Evaluates few-shot learning, chain-of-thought prompting, and self-consistency against baseline methods across sentiment classification, aspect-based sentiment analysis, and irony detection.

Result: Advanced prompting significantly improves performance; few-shot works best for GPT-4o-mini (sentiment classification), while chain-of-thought excels in gemini-1.5-flash (irony detection, up to 46%).

Conclusion: Prompting strategies must be tailored to both the model and task, emphasizing alignment between prompt design, LLM architecture, and task complexity.
...
TL;DR: AgriAgent, a two-level agent framework for agriculture, handles tasks of varying complexity with hierarchical execution—direct reasoning for simple tasks and contract-driven planning for complex ones.


<details>
  <summary>Details</summary>
Motivation: Existing agent systems struggle with task complexity and tool availability in agriculture, prompting the need for a more adaptable approach.

Method: AgriAgent uses modality-specific agents for simple tasks and a contract-driven planning mechanism for complex tasks, enabling tool orchestration and dynamic generation.

Result: AgriAgent outperforms baseline methods in execution success and robustness for complex tasks.

Conclusion: AgriAgent's hierarchical strategy effectively addresses agricultural task variability, promoting reliable and adaptable agent performance.
...
TL;DR: CLaS-Bench is introduced as a benchmark for evaluating multilingual steering techniques in LLMs, with DiffMean emerging as the top-performing method across languages.


<details>
  <summary>Details</summary>
Motivation: The lack of dedicated benchmarks for evaluating steering techniques in multilingual NLP motivates the creation of CLaS-Bench to systematically assess language-forcing behavior.

Method: The study evaluates various steering techniques (e.g., DiffMean, probes, PCA/LDA vectors) across 32 languages, measuring performance via language control and semantic relevance.

Result: DiffMean consistently outperforms other methods, and language-specific structures are found in later layers, clustering by language family.

Conclusion: CLaS-Bench provides a standardized tool for evaluating multilingual steering, highlighting DiffMean's effectiveness and the utility of steering for low-cost model adaptation.
...
TL;DR: Study introduces SPEECHMENTALMANIP, the first synthetic benchmark for detecting mental manipulation in spoken dialogues, revealing lower model recall and human uncertainty compared to text.


<details>
  <summary>Details</summary>
Motivation: Prior work on mental manipulation focused only on text, ignoring its manifestation in speech. This study aims to bridge that gap.

Method: Augments a text dataset with high-quality Text-to-Speech audio, evaluates detection using few-shot audio-language models and human annotation.

Result: Models show high specificity but lower recall on speech vs. text, indicating reliance on missing acoustic/prosodic cues. Humans also struggle with audio ambiguity.

Conclusion: Highlights the need for modality-aware evaluation and safety alignment in multimodal dialogue systems.
...
TL;DR: The paper explores how LLM tutors can be personalized based on student personalities, improving educational outcomes by matching tutoring strategies to individual traits.


<details>
  <summary>Details</summary>
Motivation: Current LLM tutoring systems lack personalization based on student personality traits, which can lead to mismatches and counterproductive outcomes. This study aims to address this gap.

Method: The authors construct a taxonomy linking pedagogical methods to personality profiles, simulate student-teacher conversations, and adjust the LLM tutor's strategy to match simulated student personalities.

Result: Human teachers consistently preferred the personalized approach over baselines, and the method increased the use of high-impact strategies like role-playing, as preferred by annotators.

Conclusion: The findings support the development of more personalized and effective LLM tutors in education, leveraging student personality traits for better outcomes.
...
TL;DR: Latent-GRPO improves reasoning in LLMs by deriving intrinsic rewards from latent space geometry, reducing reliance on costly external verifiers.


<details>
  <summary>Details</summary>
Motivation: To address the computational costs and sparse rewards of GRPO, which relies on expensive verifiers or human rules.

Method: Uses latent space geometry to identify dense clusters of correct reasoning trajectories and introduces IRCE for robust reward estimation.

Result: Achieves 2x training speedup while maintaining performance, with strong generalization and robustness.

Conclusion: Latent-GRPO offers an efficient and robust alternative to GRPO by leveraging intrinsic rewards.
...
TL;DR: Fine-Mem is proposed to address reward sparsity in memory management for LLMs by providing fine-grained feedback via chunk-level rewards and evidence-anchored credit assignment, outperforming baselines.


<details>
  <summary>Details</summary>
Motivation: Existing memory management approaches suffer from reward sparsity due to reliance on final task performance, limiting effective credit assignment.

Method: Fine-Mem uses chunk-level step rewards for immediate supervision and evidence-anchored reward attribution to align memory operations with long-term utility.

Result: Fine-Mem achieves superior success rates on Memalpha and MemoryAgentBench, showing adaptability across model configurations.

Conclusion: Fine-Mem effectively aligns fine-grained feedback with memory operations, enhancing performance and generalization.
...
TL;DR: JudgeRLVR improves RLVR by training models to judge solutions before generating, optimizing accuracy and efficiency.


<details>
  <summary>Details</summary>
Motivation: Addresses the trade-off between efficiency and verification in RLVR by enhancing discriminative capability.

Method: Two-stage approach: first judges solutions, then fine-tunes for generation, improving search space pruning.

Result: +3.7 points accuracy gain with -42% generation length in-domain; +4.5 points accuracy improvement out-of-domain.

Conclusion: JudgeRLVR effectively balances quality and efficiency, demonstrating better generalization than vanilla RLVR.
...
TL;DR: Sui-1 is a 24B parameter model designed to generate summaries with inline citations, addressing unfaithful summaries in compliance-sensitive domains.


<details>
  <summary>Details</summary>
Motivation: To solve the issue of plausible but unfaithful summaries generated by large language models, especially in compliance-sensitive fields like government and legal analysis.

Method: Uses a synthetic data pipeline combining chain-of-thought prompting and multi-stage verification to create 22,000+ high-quality training examples from diverse sources.

Result: Sui-1 outperforms open-weight baselines, including larger models, showing task-specific training beats scale alone.

Conclusion: Task-specific training is more effective than mere scaling for citation-grounded summarization; model weights and demo are publicly available.
...
TL;DR: The paper proposes a framework combining NLP and formal verification to ensure empathy in therapy chatbots, showing promising initial results.


<details>
  <summary>Details</summary>
Motivation: Empathy is crucial in therapeutic chatbots, but current development lacks systematic ways to specify or verify it.

Method: Uses Transformer-based NLP to extract dialogue features, translates them into a Stochastic Hybrid Automaton, and applies Statistical Model Checking.

Result: Preliminary results indicate the model captures therapy dynamics well and improves empathy satisfaction.

Conclusion: The framework shows potential for systematically verifying and enhancing empathy in therapeutic chatbots.
...
TL;DR: Overflow in LLMs causes excessive outputs under normal prompts, increasing costs and environmental impact. BenchOverflow benchmarks nine strategies, showing output volume amplification. Mitigation with conciseness reminders reduces tail risk.


<details>
  <summary>Details</summary>
Motivation: Overflow in LLMs leads to higher serving costs, latency, and environmental impact, necessitating a standardized benchmark to measure and mitigate it.

Method: Introduce BenchOverflow, a benchmark with nine plain-text prompting strategies, evaluated on nine models using metrics like CSR and ECDFs. Mitigation involves conciseness reminders.

Result: Pronounced rightward shifts in output length distributions; mitigation reduces tail risk and CSR across models.

Conclusion: Overflow is a measurable reliability and cost issue. BenchOverflow enables standardized model comparison and mitigation strategies.
...
TL;DR: MHEL-LLaMo is an unsupervised ensemble method combining SLM and LLM for historical Entity Linking, reducing computational costs and outperforming SOTA models without fine-tuning.


<details>
  <summary>Details</summary>
Motivation: Historical EL is challenging due to linguistic variation, noisy inputs, and evolving semantics; existing solutions lack scalability or require extensive training data.

Method: Uses multilingual bi-encoder (BELA) for candidate retrieval and LLM for NIL prediction/candidate selection via prompt chaining, leveraging SLM confidence scores to prioritize LLM use for hard cases.

Result: Outperforms SOTA models on benchmarks across six European languages (19th-20th centuries) without fine-tuning.

Conclusion: MHEL-LLaMo offers a scalable, cost-effective solution for low-resource historical EL.
...
TL;DR: STAGE is a unified benchmark for evaluating narrative understanding in movie screenplays through four tasks grounded in shared story world representations.


<details>
  <summary>Details</summary>
Motivation: Prior benchmarks lack holistic evaluation of coherent story world construction and consistent reasoning/generation across subtasks.

Method: STAGE introduces four tasks (knowledge graph construction, event summarization, question answering, role-playing) using cleaned scripts, curated knowledge graphs, and annotations for 150 films.

Result: The benchmark enables evaluation of world representation, narrative abstraction, long-context reasoning, and character-consistent generation.

Conclusion: STAGE addresses gaps in narrative understanding benchmarks by providing a comprehensive, multi-task evaluation framework.
...
TL;DR: STAR detects inference-time backdoors in LLMs by analyzing output probability shifts caused by malicious reasoning paths, achieving near-perfect performance efficiently.


<details>
  <summary>Details</summary>
Motivation: Address the vulnerability of LLMs integrating reasoning mechanisms like CoT to inference-time backdoors, which evade conventional detection due to linguistic coherence.

Method: Propose STAR framework using state-transition amplification ratio and CUSUM algorithm to detect statistical discrepancies between prior and posterior probabilities of reasoning paths.

Result: STAR achieves robust generalization across diverse models (8B-70B) and datasets (AUROC ≈ 1.0), outperforming baselines by 42× efficiency.

Conclusion: STAR effectively detects backdoors with high efficiency and robustness, even against adaptive attacks.
...
TL;DR: The paper explores the differences between convergence types in infinite-dimensional spaces, linking them to computational algorithm stability.


<details>
  <summary>Details</summary>
Motivation: To clarify the distinctions among conditional, unconditional, and absolute convergence in infinite-dimensional spaces and their impact on computational algorithms.

Method: Presents a theorem unifying seven equivalent conditions for unconditional convergence, such as permutation invariance and bounded multiplier properties.

Result: The theoretical findings inform algorithmic stability, affecting gradient accumulation in Stochastic Gradient Descent and signal processing techniques.

Conclusion: The study connects classical functional analysis with modern computation, offering robust foundations for order-independent summation.
...
TL;DR: Deep Research Bench II is introduced to evaluate Deep Research Systems (DRS) with fine-grained rubrics derived from expert articles, revealing gaps between current systems and human experts.


<details>
  <summary>Details</summary>
Motivation: Existing benchmarks for DRS either lack rigorous testing or use biased evaluation criteria, necessitating a more reliable benchmark.

Method: Deep Research Bench II includes 132 tasks across 22 domains, evaluated using 9430 fine-grained rubrics derived from expert-written articles through a hybrid LLM+human pipeline.

Result: State-of-the-art DRS models meet fewer than 50% of the rubrics, highlighting significant shortcomings.

Conclusion: The benchmark addresses existing evaluation flaws and underscores the need for improvement in DRS capabilities.
...
TL;DR: Ministral 3 series offers efficient dense language models in 3B, 8B, and 14B sizes, with variants for general use, instruction finetuning, and reasoning. Derived via Cascade Distillation, they include image understanding and are Apache 2.0 licensed.


<details>
  <summary>Details</summary>
Motivation: To provide parameter-efficient models for compute and memory constrained applications.

Method: Cascade Distillation: iterative pruning and continued training with distillation.

Result: Three model sizes (3B, 8B, 14B) with variants for diverse tasks, including image understanding.

Conclusion: Ministral 3 series is versatile, efficient, and open-source, suitable for constrained environments.
...
TL;DR: ExpSeek introduces step-level proactive experience intervention for web agents, improving performance by adapting dynamically during interaction.


<details>
  <summary>Details</summary>
Motivation: Existing methods passively inject experience as global context, failing to adapt to dynamic changes during agent-environment interaction. ExpSeek addresses this limitation.

Method: ExpSeek uses step-level entropy thresholds to determine intervention timing and tailor-designed experience content for proactive seeking.

Result: Experiments show absolute improvements of 9.3% and 7.5% on Qwen3-8B and 32B models, validating entropy as a self-triggering signal and the benefits of small-scale experience models.

Conclusion: ExpSeek demonstrates feasibility and advantages of proactive experience intervention, enhancing web agent performance dynamically.
...
TL;DR: GraphSearch introduces a framework for zero-shot graph learning by leveraging graph-structured data in search-augmented reasoning, outperforming supervised methods in benchmarks.


<details>
  <summary>Details</summary>
Motivation: Current search-augmented reasoning models lack exploration of graph-structured data, which holds rich topological signals for improved retrieval and reasoning efficiency.

Method: GraphSearch uses a Graph-aware Query Planner and Retriever to separate search space from semantic queries and rank candidates via hybrid scoring, with two traversal modes (recursive and flexible).

Result: GraphSearch achieves state-of-the-art performance in zero-shot node classification and link prediction, outperforming supervised methods.

Conclusion: GraphSearch is a flexible and generalizable paradigm for reasoning over graphs, bridging the gap in leveraging graph-structured data.
...
TL;DR: OrderProbe introduces a benchmark for evaluating LLMs' ability to reconstruct scrambled inputs in Chinese, Japanese, and Korean, revealing that structural reconstruction remains challenging even for advanced models.


<details>
  <summary>Details</summary>
Motivation: To explore LLMs' underexplored ability to reconstruct internal structure from scrambled inputs, particularly in languages with canonical word orders like Chinese, Japanese, and Korean.

Method: OrderProbe uses fixed four-character expressions in CJK languages for deterministic evaluation, supported by a diagnostic framework assessing semantic fidelity, logical validity, etc.

Result: Experiments on twelve LLMs show structural reconstruction is difficult, with zero-shot recovery often below 35%, and dissociation between semantic recall and structural planning.

Conclusion: Structural robustness in LLMs is not inherently linked to semantic competence, highlighting a need for focused improvements.
...
TL;DR: LALITA improves machine translation quality for low-resource languages by selecting source sentences using lexical and linguistic features, reducing data needs by over 50%.


<details>
  <summary>Details</summary>
Motivation: Low-resource languages struggle with expensive human translations for sufficient training data, necessitating an efficient framework for curating parallel text.

Method: LALITA evaluates English-Hindi bi-text using lexical and linguistic features to select source sentences, focusing on complex sentences from existing and synthetic datasets.

Result: Training with LALITA-curated datasets (50K-800K sentences) improves translation quality and halves data requirements across Hindi, Odia, Nepali, Norwegian Nynorsk, and German.

Conclusion: LALITA optimizes MT system training in low-resource settings by reducing data needs and costs while enhancing translation quality.
...
TL;DR: This paper explores how moral values influence political orientation in LLMs by treating moral alignment as a controllable factor, revealing significant shifts in political positioning based on moral conditioning.


<details>
  <summary>Details</summary>
Motivation: The study aims to go beyond superficial political bias detection in LLMs by examining deeper causal links between moral values and political ideologies, grounded in social psychology.

Method: Researchers conditioned models to endorse or reject specific moral values and measured resulting shifts in political orientation using the Political Compass Test, analyzing effects of role framing and model scale.

Result: Moral conditioning induced pronounced, value-specific shifts in models' political coordinates, with effects modulated by role framing and model scale, and robustness across assessment tools.

Conclusion: The findings suggest that political alignment in LLMs must consider broader social values like morality, advancing more socially grounded alignment techniques.
...
TL;DR: XMPIE is a multilingual, multimodal dataset of potentially idiomatic expressions (PIEs) for evaluating NLP systems' linguistic and cultural capabilities across 34 languages and textual/visual modalities.


<details>
  <summary>Details</summary>
Motivation: Assess the linguistic and cultural capabilities of NLP systems by analyzing PIEs, which are tied to a language community's everyday experience.

Method: Created XMPIE, a high-quality dataset with 34 languages and over ten thousand PIEs, including textual and visual components crafted by language experts. Each PIE has five images representing idiomatic to literal meanings.

Result: The dataset enables comparative analyses of idiomatic patterns, cross-language PIE understanding, and multimodal (text vs. image) idiomatic comprehension.

Conclusion: XMPIE serves as a benchmark for evaluating multilingual and multimodal idiomatic language understanding, providing insights into shared cultural aspects.
...
TL;DR: The paper analyzes safe language generation, showing its impossibility and comparing its difficulty to language identification.


<details>
  <summary>Details</summary>
Motivation: To explore the implications of safe language generation in real-world settings and provide theoretical foundations.

Method: Formalizes safe language identification and generation using computational learning paradigms, proving impossibility results.

Result: Safe language identification is impossible; safe language generation is at least as hard as language identification, also impossible.

Conclusion: Highlights challenges and identifies tractable cases for future work.
...
TL;DR: RULERS is a framework that transforms natural language rubrics into executable specifications to improve LLM-based evaluation alignment with human standards, addressing rubric instability, unverifiable reasoning, and scale misalignment.


<details>
  <summary>Details</summary>
Motivation: Aligning frozen black-box LLMs with human standards is challenging due to generation stochasticity, prompting the need for a systematic solution.

Method: Introduces RULERS, a compiler-executor framework that compiles rubrics into versioned bundles, enforces structured decoding with evidence verification, and uses Wasserstein-based calibration.

Result: RULERS outperforms baselines in human agreement, shows stability against adversarial perturbations, and enables smaller models to compete with larger proprietary judges.

Conclusion: Reliable LLM judging requires executable rubrics, verifiable evidence, and calibrated scales, achieved by RULERS without updating model parameters.
...
TL;DR: LLMs often falsely refuse hate speech detoxification due to biases, especially for toxic or group-targeted content. A cross-translation strategy (English-Chinese-English) reduces false refusals effectively.


<details>
  <summary>Details</summary>
Motivation: To understand and mitigate false refusal behavior in LLMs during hate speech detoxification, analyzing biases and proposing solutions.

Method: Evaluated nine LLMs on English and multilingual datasets, identifying biases. Proposed cross-translation (English-Chinese-English) to reduce refusals.

Result: LLMs disproportionately refuse toxic or group-targeted inputs. Cross-translation reduced false refusals while preserving content.

Conclusion: Contextual and linguistic biases drive false refusals; cross-translation offers a lightweight mitigation strategy.
...
TL;DR: The paper discusses challenges in summarizing multi-party dialogues for industry, emphasizing evolving requirements and practical insights for developing adaptable summarization systems.


<details>
  <summary>Details</summary>
Motivation: The motivation is to address the gap in practical scenarios where summarization requirements evolve, unlike static datasets commonly used in research.

Method: The paper presents an industry case study using an agentic system, focusing on evaluation methods, component-wise optimization, upstream data bottlenecks, and vendor lock-in realities.

Result: Practical insights are shared to guide practitioners in building reliable, adaptable summarization systems and inform future research.

Conclusion: The study highlights the importance of robust evaluation, task decomposition, addressing data bottlenecks, and awareness of vendor lock-in for effective summarization systems.
...
TL;DR: QuantEval is a benchmark evaluating LLMs in financial quantitative tasks across knowledge-based QA, mathematical reasoning, and strategy coding, revealing performance gaps compared to human experts. Fine-tuning and reinforcement learning improve results.


<details>
  <summary>Details</summary>
Motivation: Existing evaluations of LLMs in finance are fragmented and limited to knowledge-based QA, lacking comprehensive assessments of quantitative abilities.

Method: QuantEval integrates a CTA-style backtesting framework to evaluate LLMs on three dimensions: knowledge-based QA, quantitative reasoning, and strategy coding, using financial performance metrics.

Result: LLMs show significant gaps compared to human experts, especially in reasoning and coding. Fine-tuning and reinforcement learning improve performance.

Conclusion: QuantEval aims to enhance LLMs' quantitative finance capabilities and practical adoption, with reproducible configurations released.
...
TL;DR: LLMs outperform neural models in predicting nationality from names, with performance gaps narrowing at coarser granularity. Error analysis highlights LLMs' reliance on world knowledge and tendency for 'near-miss' errors.


<details>
  <summary>Details</summary>
Motivation: Predicting nationality from names is useful for marketing, demographics, and genealogy. Neural models struggle with low-frequency nationalities and distinguishing similar ones, while LLMs may leverage pre-trained world knowledge to address these challenges.

Method: The study compares six neural models and six LLM prompting strategies across three granularity levels (nationality, region, continent). It includes frequency-based stratified analysis and error analysis.

Result: LLMs outperform neural models at all granularity levels, with gaps narrowing as granularity becomes coarser. Neural models show higher frequency robustness, while LLMs degrade for low-frequency nationalities. LLMs make 'near-miss' errors, while neural models exhibit cross-regional errors and bias.

Conclusion: LLM superiority comes from world knowledge, model selection should align with granularity needs, and evaluation should consider error quality beyond accuracy.
...
TL;DR: RAGShaper automates the creation of RAG tasks and agent trajectories to address the lack of high-quality training data, improving robustness in noisy retrieval tasks.


<details>
  <summary>Details</summary>
Motivation: Current RAG development lacks scalable, high-quality training data that mirrors real-world noise and complex reasoning, limiting agent robustness.

Method: RAGShaper uses InfoCurator to build dense information trees with adversarial distractors and a constrained navigation strategy to train agents on error correction.

Result: Models trained with RAGShaper outperform baselines, showing enhanced robustness in noisy and complex retrieval scenarios.

Conclusion: RAGShaper effectively bridges the data gap for RAG agents, enabling better performance in real-world retrieval tasks.
...
TL;DR: PrivGemo is a privacy-preserving framework for KG-grounded reasoning with exposure control, outperforming baselines and enabling smaller models to match GPT-4-Turbo's performance.


<details>
  <summary>Details</summary>
Motivation: Addressing privacy risks and limitations in existing methods for KG-grounded LLM reasoning.

Method: Dual-tower design anonymizes KG views, supports multi-hop reasoning, and reduces remote interactions via hierarchical control and privacy-aware memory.

Result: Achieves state-of-the-art results (up to 17.1% improvement) and enables smaller models to match GPT-4-Turbo's reasoning.

Conclusion: PrivGemo effectively balances privacy and reasoning performance for KG-grounded tasks.
...
TL;DR: FRTR-Bench is introduced as a benchmark for multimodal spreadsheet reasoning, and FRTR is proposed as a retrieval-augmented framework to improve LLMs' reasoning over complex spreadsheets, outperforming prior methods.


<details>
  <summary>Details</summary>
Motivation: LLMs struggle with reasoning over large-scale, multimodal enterprise spreadsheets, and existing methods are limited in scalability and realism.

Method: FRTR decomposes workbooks into granular embeddings, uses hybrid retrieval with RRF, and integrates multimodal embeddings for numerical and visual reasoning.

Result: FRTR achieved 74% accuracy on FRTR-Bench and 87% on SpreadsheetLLM, outperforming prior methods with reduced token usage.

Conclusion: FRTR significantly improves LLMs' reasoning capabilities for complex spreadsheets and outperforms state-of-the-art approaches.
...
TL;DR: Attributional NLI (Att-NLI) enhances traditional NLI by incorporating social psychology principles, enabling LLMs to infer latent intentions and verify conclusions, with neuro-symbolic agents outperforming others in complex multi-agent environments.


<details>
  <summary>Details</summary>
Motivation: Traditional NLI lacks nuanced intention-driven reasoning needed for complex interactions, prompting the development of Att-NLI to bridge this gap.

Method: Att-NLI introduces abductive-deductive inference, tested via a textual game (Undercover-V) with three LLM agent types: standard NLI, Att-NLI, and neuro-symbolic Att-NLI.

Result: Neuro-symbolic agents achieved the highest performance (17.08% win rate), showcasing superior attributional inference capabilities.

Conclusion: Att-NLI advances LLM reasoning in multi-agent systems, highlighting neuro-symbolic AI's potential for developing rational agents.
...
TL;DR: TableCache speeds up Text-to-SQL tasks by precomputing and reusing table KV caches, reducing latency without significant performance loss.


<details>
  <summary>Details</summary>
Motivation: Existing LLM-based methods suffer from long context lengths and prefilling latency due to redundant KV cache copies in Text-to-SQL tasks.

Method: The approach involves offline precomputation of table KV caches, preserving key relationships, a Table Trie for efficient lookup, and a cache management system with reranking and parallel loading.

Result: TableCache achieves up to 3.62x speedup in TTFT with minimal performance degradation.

Conclusion: Precomputing and reusing table caches efficiently addresses latency issues in Text-to-SQL tasks.
...
TL;DR: ACE is a dynamic framework that alternates between retrieval and reasoning, outperforming rigid methods in accuracy and efficiency.


<details>
  <summary>Details</summary>
Motivation: Current retrieval-augmented methods are inefficient and noisy, prompting the need for a smarter, adaptive approach.

Method: ACE uses a central orchestrator agent to decide between retrieval and reasoning via majority voting, optimizing context evolution.

Result: ACE outperforms baselines in accuracy and token efficiency on multi-hop QA benchmarks.

Conclusion: ACE advances context-evolved generation for complex tasks by reducing redundancy and noise.
...
TL;DR: The paper proposes an attention-based model integrating aerial imagery and geolocated text to improve ecological predictions, outperforming unimodal baselines.


<details>
  <summary>Details</summary>
Motivation: Textual data offers unique ecological insights but is sparse and irregular. Integrating it with geospatial data is challenging, requiring a novel approach.

Method: An attention-based model combines vision, text, and geolocation encodings, dynamically selecting useful spatial neighbours for predictions.

Result: The model outperforms single-location or unimodal baselines, especially for climatic, edaphic, population, and land use variables.

Conclusion: Including spatial context when combining text and image data significantly enhances ecological prediction performance.
...
TL;DR: Multiplex Thinking introduces a stochastic soft reasoning mechanism for large language models, improving reasoning efficiency and sequence length compared to traditional Chain-of-Thought methods.


<details>
  <summary>Details</summary>
Motivation: Inspired by human soft reasoning, the method aims to overcome the inefficiency of long token sequences in Chain-of-Thought reasoning by maintaining distributions over plausible next steps.

Method: Multiplex Thinking samples K candidate tokens at each step, aggregates their embeddings into a continuous multiplex token, and optimizes trajectories using on-policy reinforcement learning.

Result: The method outperforms discrete Chain-of-Thought and RL baselines across math reasoning benchmarks, delivering better performance with shorter sequences.

Conclusion: Multiplex Thinking effectively balances confidence-driven reasoning and uncertainty representation, enhancing efficiency and performance.
...
TL;DR: Simulation study of LLM agent reviewers in an Elo-ranked system shows improved decision accuracy and adaptive strategies by reviewers.


<details>
  <summary>Details</summary>
Motivation: To understand the dynamics of LLM agent reviewers in a real-world conference paper submission context, particularly focusing on the impact of Elo ratings and reviewer memory.

Method: Multiple LLM agent reviewers with different personas interact in multi-round reviews moderated by an Area Chair, comparing baseline conditions with those incorporating Elo ratings and reviewer memory.

Result: Findings include improved Area Chair decision accuracy with Elo ratings and reviewers adapting strategies to exploit the system without increasing effort.

Conclusion: Incorporating Elo ratings enhances review system dynamics, though reviewer behavior may adapt strategically without additional effort.
...
### [168] [Emergent Coordination in Multi-Agent Systems via Pressure Fields and Temporal Decay](https://arxiv.org/abs/2601.08129)
*Roland Rodriguez*

Main category: cs.MA

TL;DR: Pressure-field coordination matches hierarchical control in performance, outperforms other methods, and scales well with agent count.


<details>
  <summary>Details</summary>
Motivation: To address poor scalability and coordination overhead in current multi-agent LLM frameworks by mimicking natural coordination mechanisms.

Method: Agents operate on shared artifacts guided by pressure gradients with temporal decay, formalized as optimization over a pressure landscape.

Result: Empirical results show comparable performance to hierarchical control (38.2% vs 38.8% solve rate) and superiority over sequential, random, and dialogue-based methods.

Conclusion: Implicit coordination via pressure gradients is simpler and as effective as explicit hierarchical control, offering a better foundation for multi-agent AI.
...
### [169] [Agent Contracts: A Formal Framework for Resource-Bounded Autonomous AI Systems](https://arxiv.org/abs/2601.08815)
*Qing Ye,Jing Tan*

Main category: cs.MA

TL;DR: Agent Contracts extend the Contract Net Protocol to enforce resource and temporal constraints in multi-agent systems, ensuring predictable and auditable execution.


<details>
  <summary>Details</summary>
Motivation: Existing protocols lack formal mechanisms to govern resource consumption and operational duration in multi-agent systems, limiting predictability and auditability.

Method: Introduces Agent Contracts, unifying input/output specs, resource constraints, temporal boundaries, and success criteria into a governance framework with lifecycle semantics.

Result: Empirical validation shows 90% token reduction, 525x lower variance, zero conservation violations, and measurable quality-resource tradeoffs.

Conclusion: Agent Contracts provide a formal foundation for resource-bounded, predictable, and auditable autonomous AI deployment.
...
TL;DR: A hybrid explainable AI (XAI) framework combining fuzzy logic and SHAP explanations improves trust and accuracy in maternal health risk prediction, validated by clinician feedback.


<details>
  <summary>Details</summary>
Motivation: Address the lack of explainability and trust hindering clinical adoption of machine learning in maternal health risk prediction in resource-constrained settings.

Method: Developed a fuzzy-XGBoost model using 1,014 maternal health records, integrating ante-hoc fuzzy logic with post-hoc SHAP explanations, and validated through clinician feedback.

Result: Achieved 88.67% accuracy (ROC-AUC: 0.9703) and validation with healthcare professionals showed 71.4% preference for hybrid explanations and 54.8% trust for clinical use.

Conclusion: Combining interpretable fuzzy rules with feature importance explanations enhances utility and trust, offering practical insights for XAI deployment in maternal healthcare.
...
### [171] [When Models Know When They Do Not Know: Calibration, Cascading, and Cleaning](https://arxiv.org/abs/2601.07965)
*Chenjie Hao,Weyl Lu,Yuko Ishiwaka,Zengyi Li,Weier Wan,Yubei Chen*

Main category: cs.AI

TL;DR: The paper proposes a training-free method for model calibration to help models recognize uncertainty, enabling applications like efficient model cascading and effective data cleaning.


<details>
  <summary>Details</summary>
Motivation: To improve AI reliability and efficiency by enabling models to recognize when they are uncertain, leveraging calibrated confidence estimates.

Method: A training-free calibration approach using internal model signals, applied to vision and language models, with empirical validation of confidence reliability.

Result: Improved efficiency via calibrated model cascading and enhanced data cleaning, demonstrated on ImageNet and MMLU datasets.

Conclusion: Recognizing model uncertainty through calibrated confidence is practical for building more efficient and trustworthy AI systems.
...
### [172] [Reasoning over Precedents Alongside Statutes: Case-Augmented Deliberative Alignment for LLM Safety](https://arxiv.org/abs/2601.08000)
...
TL;DR: CADA, a case-augmented deliberative alignment method for LLMs, improves safety and robustness without degrading helpfulness by using reinforcement learning on self-generated safety reasoning chains instead of rigid rule-based approaches.


<details>
  <summary>Details</summary>
Motivation: The challenge is to ensure LLMs adhere to safety principles without refusing benign requests, especially for open-source LLMs lacking advanced reasoning capabilities.

Method: The study evaluates specifying safety codes vs. illustrating them through cases and introduces CADA, which uses reinforcement learning on case-augmented reasoning chains.

Result: Case-augmented training improves robustness and generalization, while explicit codes degrade helpfulness. CADA enhances harmlessness and reduces over-refusal without losing utility.

Conclusion: CADA offers a practical, adaptable alternative to rule-only deliberative alignment for improving LLM safety while maintaining helpfulness.
...
### [173] [Internal Deployment Gaps in AI Regulation](https://arxiv.org/abs/2601.08005)
*Joe Kwon,Stephen Casper*

Main category: cs.AI

TL;DR: The paper explores gaps in frontier AI regulations for internal deployments in companies, identifies three key issues, analyzes their persistence, and suggests solutions.


<details>
  <summary>Details</summary>
Motivation: Frontier AI regulations overlook internal deployments, which are high-stakes but less visible, risking unintended oversight gaps.

Method: The study examines U.S. and EU regulations in 2025, identifying gaps like scope ambiguity, compliance timing, and information asymmetry.

Result: Three gaps persist due to tensions around measurability, incentives, and access, enabling internal AI systems to evade oversight.

Conclusion: Proposes deliberate policy approaches to address oversight gaps in internally deployed AI systems.
...
### [174] [Integrating Attendance Tracking and Emotion Detection for Enhanced Student Engagement in Smart Classrooms](https://arxiv.org/abs/2601.08049)
*Keith Ainebyona,Ann Move Oguti,Joseph Walusimbi,Ritah Kobusingye*

Main category: cs.AI

TL;DR: SCASED integrates automated attendance tracking with facial emotion recognition to monitor student engagement in smart classrooms, achieving 89.5% emotion classification accuracy.


<details>
  <summary>Details</summary>
Motivation: Existing smart classroom technologies focus on attendance automation but neglect emotional and cognitive engagement, limiting instructors' ability to adapt teaching strategies.

Method: SCASED uses Raspberry Pi cameras, OpenCV for face detection, and a fine-tuned MobileNetV2 model to classify engagement, boredom, confusion, and frustration. Attendance is recorded once per session, followed by continuous emotion analysis.

Result: Experimental evaluation on the DAiSEE dataset showed 89.5% accuracy in emotion classification.

Conclusion: Combining attendance data with emotion analytics enhances instructors' insights into classroom dynamics, enabling more responsive teaching.
...
### [175] [Forecast Aware Deep Reinforcement Learning for Efficient Electricity Load Scheduling in Dairy Farms](https://arxiv.org/abs/2601.08052)
*Nawazish Alia,Rachael Shawb,Karl Mason*

Main category: cs.AI

TL;DR: The paper proposes a Deep Reinforcement Learning framework for efficient load scheduling in dairy farms, addressing challenges like intermittent renewables and dynamic tariffs, achieving cost and energy savings.


<details>
  <summary>Details</summary>
Motivation: To reduce grid dependence and operational costs in dairy farming by optimizing energy usage through intelligent load scheduling, aligning with SDG 7 goals.

Method: Introduces Forecast Aware PPO and PID KL PPO variants, leveraging short-term forecasts and adaptive KL divergence control for stable training.

Result: Achieves lower electricity costs (1% vs. PPO, 4.8% vs. DQN, 1.5% vs. SAC) and reduces grid imports by 13.1% for battery scheduling.

Conclusion: The framework is scalable and effective for sustainable energy management in dairy farms, outperforming existing methods.
...
### [176] [A New Strategy for Verifying Reach-Avoid Specifications in Neural Feedback Systems](https://arxiv.org/abs/2601.08065)
*Samuel I. Akinwande,Sydney M. Katz,Mykel J. Kochenderfer,Clark Barrett*

Main category: cs.AI

TL;DR: New algorithms for backward reachability analysis are introduced to enhance verification of neural feedback systems by integrating with forward methods.


<details>
  <summary>Details</summary>
Motivation: Existing backward reachability methods lack scalability, limiting their use in verifying neural feedback systems.

Method: Developed new algorithms for computing over- and under-approximations of backward reachable sets and integrated them with forward analysis techniques.

Result: A unified verification framework for neural feedback systems was created, combining backward and forward reachability analyses.

Conclusion: The integration of backward and forward methods improves verification capabilities for neural feedback systems.
...
### [177] [Semantic Gravity Wells: Why Negative Constraints Backfire](https://arxiv.org/abs/2601.08070)
*Shailesh Rana*

Main category: cs.AI

TL;DR: Negative constraints (e.g., 'do not use word X') often fail in large language models due to two mechanistically distinct failure modes: priming (87.5%) and override (12.5%). Semantic pressure predicts violation probability tightly.


<details>
  <summary>Details</summary>
Motivation: To understand why negative constraints fail so frequently in large language models, despite their simplicity, and to explore the mechanisms behind these failures.

Method: Used semantic pressure as a quantitative measure, analyzed layer-wise signals via logit lens, and identified two failure modes (priming and override) through activation patching.

Result: Violation probability follows a logistic relationship with semantic pressure ($p=σ(-2.40+2.27\cdot P_0)$). Priming failure dominates (87.5%), while override failure is rarer (12.5%). Layers 23--27 are causally responsible.

Conclusion: Negative constraints inherently prime forbidden words, creating a fundamental tension in their design.
...
### [178] [MemoBrain: Executive Memory as an Agentic Brain for Reasoning](https://arxiv.org/abs/2601.08079)
*Hongjin Qian,Zhao Cao,Zheng Liu*

Main category: cs.AI

TL;DR: MemoBrain is an executive memory model for tool-augmented agents, addressing the challenge of memory accumulation in long-horizon reasoning tasks by organizing reasoning steps and managing context efficiently.


<details>
  <summary>Details</summary>
Motivation: Long-horizon reasoning strains the bounded working context of large language models due to accumulation of reasoning traces and tool artifacts, disrupting logical continuity and task alignment.

Method: MemoBrain constructs a dependency-aware memory over reasoning steps, pruning invalid steps, folding completed sub-trajectories, and preserving a compact reasoning backbone under fixed context constraints.

Result: Evaluation on benchmarks like GAIA, WebWalker, and BrowseComp-Plus shows consistent improvements over baselines.

Conclusion: Memory is crucial for sustaining coherent reasoning in long-horizon tasks, and MemoBrain effectively addresses this by managing context and maintaining logical continuity.
...
### [179] [MirrorBench: An Extensible Framework to Evaluate User-Proxy Agents for Human-Likeness](https://arxiv.org/abs/2601.08118)
*Ashutosh Hathidara,Julien Yu,Vaishali Senthil,Sebastian Schreiber,Anil Babu Ankisettipalli*

Main category: cs.AI

TL;DR: MIRRORBENCH is a benchmarking framework designed to evaluate user proxy agents' ability to generate human-like utterances, decoupled from task success, using modular tools and diverse metrics.


<details>
  <summary>Details</summary>
Motivation: The need for principled evaluation of user proxies arises from naive prompting yielding unrealistic utterances, highlighting gaps in current methods.

Method: MIRRORBENCH employs a modular engine with typed interfaces, metadata-driven registries, and multi-backend support, incorporating six metrics (lexical-diversity and LLM-judge-based).

Result: Tests on four datasets show variance-aware results and systematic gaps between user proxies and real humans.

Conclusion: MIRRORBENCH provides a reproducible, extensible solution for evaluating user proxies, with open-source availability.
...
TL;DR: The paper analyzes post-crash lane changes (LCs), identifying unique behavioral traits and higher crash risks compared to mandatory or discretionary LCs. It introduces a novel trajectory prediction framework using a graph-based attention module to improve accuracy and crash risk assessment.


<details>
  <summary>Details</summary>
Motivation: The study aims to understand and predict vehicle behavior during post-crash LCs, where non-yielding behaviors increase crash risks, filling a gap in existing research.

Method: A dataset of post-crash LCs is created from drone videos. A trajectory prediction framework is developed, featuring a graph-based attention module to model yielding behavior, integrated with a conditional variational autoencoder and Transformer decoder.

Result: Post-crash LCs show longer durations, lower speeds, and higher crash risks (79.4% involve non-yielding). The new model reduces prediction errors by over 10% and improves crash risk analysis accuracy.

Conclusion: The proposed framework effectively predicts post-crash LC trajectories and enhances crash risk assessment, demonstrating transferability across datasets.
...
TL;DR: A memory paradigm for edge-device AI companions alternates between active (low-latency retrieval) and inactive (computationally intensive tasks) phases, balancing latency and personalization under resource constraints.


<details>
  <summary>Details</summary>
Motivation: Addressing the challenge of embedding AI companions on edge devices with limited computational resources and latency concerns.

Method: Proposes a memory paradigm with alternating active (real-time dialog) and inactive (memory consolidation) phases, using lightweight retrieval and computationally intensive tasks.

Result: Outperforms raw LLMs without memory and matches GPT-3.5 with a 16k context window, demonstrating effectiveness under hardware constraints.

Conclusion: The system effectively balances performance and resource limitations, offering a viable solution for embedded AI companions.
...
### [182] [Project Synapse: A Hierarchical Multi-Agent Framework with Hybrid Memory for Autonomous Resolution of Last-Mile Delivery Disruptions](https://arxiv.org/abs/2601.08156)
*Arin Gopalan Yadav,Varad Dherange,Kumar Shivam*

Main category: cs.AI

TL;DR: Synapse is a multi-agent framework for autonomous last-mile delivery disruption resolution, validated with real-world data and LLM evaluation.


<details>
  <summary>Details</summary>
Motivation: Addressing last-mile delivery disruptions autonomously to improve efficiency and reliability.

Method: Hierarchical multi-agent architecture with a Resolution Supervisor delegating tasks to worker agents, managed by LangGraph.

Result: Validated using a benchmark of 30 scenarios from real-world reviews, evaluated via LLM-as-a-Judge with bias mitigation.

Conclusion: Synapse effectively resolves disruptions autonomously, with validation showing practical utility.
...
### [183] [ZeroDVFS: Zero-Shot LLM-Guided Core and Frequency Allocation for Embedded Platforms](https://arxiv.org/abs/2601.08166)
*Mohammad Pivezhandi,Mahdi Banisharif,Abusayeed Saifullah,Ali Jannesari*

Main category: cs.AI

TL;DR: A hierarchical MARL framework is proposed for thermal- and energy-aware scheduling on multi-core systems, leveraging model-based planning and LLM-extracted features for faster convergence and zero-shot deployment.


<details>
  <summary>Details</summary>
Motivation: Existing DVFS and task-to-core allocation methods either overlook stall times or require extensive offline profiling, limiting runtime adaptation.

Method: Uses a hierarchical MARL framework with two collaborative agents, an accurate environment model, and LLM-based semantic feature extraction for zero-shot deployment.

Result: Achieves 7.09x better energy efficiency and 4.0x better makespan than Linux ondemand governor, with 358ms latency for subsequent decisions.

Conclusion: The framework enables practical deployment in dynamic embedded systems by reducing latency and eliminating workload-specific profiling.
...
### [184] [The Agent's First Day: Benchmarking Learning, Exploration, and Scheduling in the Workplace Scenarios](https://arxiv.org/abs/2601.08173)
*Daocheng Fu,Jianbiao Mei,Rong Wu,Xuemeng Yang,Jia Xu,Ding Wang,Pinlong Cai,Yong Liu,Licheng Wen,Botian Shi*

Main category: cs.AI

TL;DR: The paper introduces \method{}, a dynamic evaluation environment for MLLMs, addressing real-world challenges like task scheduling, active exploration, and continuous learning. It highlights deficiencies in current agents and shifts focus to realistic scenarios.


<details>
  <summary>Details</summary>
Motivation: Existing MLLM research focuses on static performance limits, ignoring robustness in stochastic real-world settings. The work aims to address this gap by evaluating agents in dynamic, production-like environments.

Method: The authors propose \method{}, a dynamic environment simulating a trainee agent exploring novel settings. It evaluates agents on context-aware scheduling, active exploration, and continuous learning from dynamically generated tasks.

Result: Experiments reveal significant shortcomings in cutting-edge agents, particularly in active exploration and continual learning, emphasizing the need for robust evaluation frameworks.

Conclusion: The paper establishes a framework for assessing agent reliability in realistic scenarios, moving beyond static benchmarks to better reflect real-world deployment challenges.
...
TL;DR: HS2C improves LLM performance on TAGs by structurally and semantically compressing graph data using homophily-aware techniques, enhancing both compression and accuracy.


<details>
  <summary>Details</summary>
Motivation: Existing methods randomly sample graph data for LLMs, introducing noise and instability; exploiting graph homophily can unlock better reasoning performance.

Method: HS2C uses structural entropy minimization for global hierarchical partitioning to identify cohesive communities and semantic aggregation based on community type, compressing redundant contexts.

Result: HS2C enhances compression and downstream accuracy across 10 node-level benchmarks and generalizes to 7 graph-level tasks.

Conclusion: HS2C's homophily-aware compression effectively improves LLM performance on TAGs, demonstrating superiority and scalability.
...
TL;DR: The paper addresses fairness issues in online Official International Mahjong by analyzing AI self-play data, identifying first-mover advantage and subgoal scoring problems, and proposing rule adaptations like compensatory points for online play.


<details>
  <summary>Details</summary>
Motivation: Traditional Mahjong rules are designed for offline play with fixed opponents, but online play involves fragmented sessions and unfixed opponents, requiring fairness adjustments.

Method: A world champion AI is used for self-play competitions and statistical analysis to identify imbalances.

Result: The study reveals a first-mover advantage and subgoal scoring issues, leading to proposed rule adaptations like compensatory points and refined scoring.

Conclusion: The revised rules make Mahjong more suitable for online play, balancing fairness without requiring multiple rounds, and a revised version is implemented for online players.
...
TL;DR: SANC(E3) proposes an axiomatic framework where representational units emerge through competitive selection and energy minimization, unifying perception, imagination, and action under finite resources.


<details>
  <summary>Details</summary>
Motivation: Existing systems assume fixed primitive units, ignoring how representational units emerge. This paper aims to address this gap by proposing a framework where units self-organize.

Method: SANC(E3) is based on five core axioms governing finite capacity, association, competition, stabilization, and trade-offs between reconstruction and compression. It uses pseudo-memory-mapped I/O mechanisms.

Result: The framework unifies perception, imagination, prediction, planning, and action under a single representational process. Twelve propositions derive hierarchical organization and unsupervised learning from Gestalt completion.

Conclusion: SANC(E3) provides a principled way for representational units to emerge, bridging gaps in general intelligence by unifying cognitive processes under energy minimization.
...
TL;DR: MPCI-Bench is introduced as a multimodal benchmark to evaluate privacy behavior in AI agents, addressing gaps in existing text-centric CI benchmarks by including visual data and balancing privacy and utility.


<details>
  <summary>Details</summary>
Motivation: Existing CI benchmarks are limited to text and focus on negative refusal scenarios, neglecting multimodal privacy risks and the privacy-utility trade-off.

Method: MPCI-Bench comprises paired positive and negative instances from visual sources, organized into three tiers (Seed, Story, Traces) and refined via a Tri-Principle Iterative Refinement pipeline.

Result: Evaluations show multimodal models fail to balance privacy and utility, with visual data leaking sensitive information more than text.

Conclusion: MPCI-Bench fills a critical gap in CI evaluation, providing a tool for future research on privacy behavior in AI agents.
...
TL;DR: The paper discusses shifting from manual reward engineering in multi-agent reinforcement learning to using language-based objectives via LLMs, highlighting benefits like semantic specification and dynamic adaptation, but noting challenges like computational overhead and scalability.


<details>
  <summary>Details</summary>
Motivation: Reward engineering is challenging in multi-agent reinforcement learning due to credit assignment ambiguity, environmental non-stationarity, and complex interactions. Advances in LLMs suggest a shift to language-based specifications could address these issues.

Method: Proposes transitioning from hand-crafted numerical rewards to language-based objectives using LLMs, leveraging frameworks like EUREKA and CARD for reward synthesis and adaptation, and RLVR for language-mediated supervision.

Result: Language-based reward specification offers semantic clarity, dynamic adaptation, and better alignment with human intent, but faces challenges like computational cost and scalability.

Conclusion: Future research should focus on coordination via shared semantic representations rather than engineered numerical signals, addressing open challenges like robustness and scalability.
...
### [190] [Large Artificial Intelligence Model Guided Deep Reinforcement Learning for Resource Allocation in Non Terrestrial Networks](https://arxiv.org/abs/2601.08254)
*Abdikarim Mohamed Ibrahim,Rosdiadee Nordin*

Main category: cs.AI

TL;DR: The paper proposes a DRL agent guided by an LLM for NTN applications, showing significant performance improvements over traditional DRL and heuristics.


<details>
  <summary>Details</summary>
Motivation: To enhance NTN performance by leveraging LAMs for better generalization and reduced task-specific training.

Method: A DRL agent is guided by an LLM, which provides high-level textual guidance to shape rewards during training.

Result: LAM-DRL outperforms traditional DRL by 40% in nominal weather and 64% in extreme weather scenarios, excelling in throughput, fairness, and outage probability.

Conclusion: Integrating LLMs with DRL improves NTN performance significantly, especially in extreme conditions.
...
### [191] [T3: Benchmarking Sycophancy and Skepticism in Causal Judgment](https://arxiv.org/abs/2601.08258)
*Edward Y. Chang*

Main category: cs.AI

TL;DR: T3 is a diagnostic benchmark evaluating LLMs' causal judgment across Pearl's Ladder of Causality, identifying pathologies like Skepticism Trap and Scaling Paradox, and validating a restoration protocol.


<details>
  <summary>Details</summary>
Motivation: To rigorously assess LLMs' causal reasoning and diagnose specific failure modes.

Method: 454 expert-curated vignettes analyzed across Utility, Safety, and Wise Refusal metrics.

Result: Identified Skepticism Trap (L1) and Scaling Paradox (L3), with GPT-5.2 underperforming GPT-4-Turbo.

Conclusion: T3 effectively diagnoses and validates improvements in LLM causal judgment.
...
### [192] [VGG Induced Deep Hand Sign Language Detection](https://arxiv.org/abs/2601.08262)
*Subham Sharma,Sharmila Subudhi*

Main category: cs.AI

TL;DR: The paper proposes a hand gesture recognition system using VGG-16 CNN, achieving ~98% accuracy with transfer learning and data augmentation.


<details>
  <summary>Details</summary>
Motivation: To improve human-computer interaction and assist differently-abled individuals, particularly for sign language interpretation.

Method: Uses VGG-16 CNN trained on an image dataset with Python/Keras, validated using NUS dataset, and tested with gestures captured via Google API.

Result: Achieved ~98% accuracy by combining transfer learning and image data augmentation.

Conclusion: The VGG-16 model with enhancements is highly effective for hand gesture recognition.
...
### [193] [Sparsity Is Necessary: Polynomial-Time Stability for Agentic LLMs in Large Action Spaces](https://arxiv.org/abs/2601.08271)
*Angshul Majumdar*

Main category: cs.AI

TL;DR: The paper introduces Sparse Agentic Control (SAC) for tool-augmented LLM systems, focusing on policies with sparse representations and rewards with sparse effects. It provides theoretical guarantees for policy learning and highlights the inefficiency of dense policies.


<details>
  <summary>Details</summary>
Motivation: To address the challenge of sequential decision-making in LLM systems with a vast action space (tools, APIs) where only a small subset is relevant for tasks.

Method: Formalizes SAC, uses ell_{1,2}-regularized policy learning, and analyzes estimation, value suboptimality, and tool-support recovery under specific conditions.

Result: Shows estimation scales with k (log M / T)^{1/2}, exact recovery requires T > k log M, and dense policies need Omega(M) samples. Also, LLMs under partial observability add O(epsilon_b) error.

Conclusion: SAC offers efficient policy learning with theoretical guarantees, outperforming dense policies, and remains robust under partial observability.
...
### [194] [ToolACE-MCP: Generalizing History-Aware Routing from MCP Tools to the Agent Web](https://arxiv.org/abs/2601.08276)
*Zhiyuan Yao,Zishan Xu,Yifu Guo,Zhiguang Han,Cheng Yang,Shuo Zhang,Weinan Zhang,Xingshan Zeng,Weiwen Liu*

Main category: cs.AI

TL;DR: ToolACE-MCP is a pipeline for training history-aware routers to enhance scalability and generality in large-scale agent ecosystems, demonstrating superior performance and robustness.


<details>
  <summary>Details</summary>
Motivation: Current architectures struggle with scalability and generality in the evolving agent ecosystem, prompting the need for improved solutions.

Method: Leverages a dependency-rich candidate Graph to synthesize multi-turn trajectories for training routers with dynamic context understanding, creating Light Routing Agents.

Result: Superior performance on benchmarks MCP-Universe and MCP-Mark, with generalization to multi-agent collaboration and robustness against noise.

Conclusion: ToolACE-MCP provides a strong foundation for universal orchestration in open-ended agent ecosystems.
...
### [195] [Greedy Is Enough: Sparse Action Discovery in Agentic LLMs](https://arxiv.org/abs/2601.08280)
*Angshul Majumdar*

Main category: cs.AI

TL;DR: The paper proposes a greedy algorithm for discovering relevant actions in large-action environments under structured sparsity, proving its effectiveness and optimality.


<details>
  <summary>Details</summary>
Motivation: Modern agentic systems face large action spaces, but only a few actions impact performance. The paper aims to identify these relevant actions efficiently.

Method: A contextual linear reward model with structured sparsity is used. A greedy algorithm, inspired by Orthogonal Matching Pursuit, is analyzed for action discovery.

Result: The algorithm recovers relevant actions with high probability, using polynomial samples in sparsity and latent dimension, and logarithmic samples in total actions. Estimation error guarantees and near-optimality are shown.

Conclusion: Sparse action discovery is fundamental for large-action decision-making, providing a theoretical basis for action pruning in agentic systems.
...
### [196] [OpenMic: A Multi-Agent-Based Stand-Up Comedy Generation System](https://arxiv.org/abs/2601.08288)
*Yuyang Wu,Hanzhong Cao,Jianhao Chen,Yufei Li*

Main category: cs.AI

TL;DR: OpenMic is a multi-agent system for generating culturally grounded Chinese stand-up comedy, addressing challenges like humor timing and dataset-task mismatch through iterative planning, RAG, and fine-tuning.


<details>
  <summary>Details</summary>
Motivation: Chinese stand-up comedy generation requires culturally nuanced humor, timing, and performance cues, but existing datasets are misaligned with long-form generation.

Method: OpenMic uses AutoGen for multi-agent collaboration, iterative planning, retrieval-augmented generation (RAG), and fine-tuning a JokeWriter for stand-up-specific structures.

Result: The system transforms a life topic into a 3-5 minute stand-up performance and narrated comedy video.

Conclusion: OpenMic effectively tackles stand-up comedy generation challenges by combining multi-agent orchestration, RAG, and specialized fine-tuning.
...
### [197] [AtomMem : Learnable Dynamic Agentic Memory with Atomic Memory Operation](https://arxiv.org/abs/2601.08323)
*Yupeng Huo,Yaxi Lu,Zhong Zhang,Haotian Chen,Yankai Lin*

Main category: cs.AI

TL;DR: AtomMem introduces a learning-based memory framework by reframing memory management as a dynamic decision-making process, outperforming static methods in benchmarks.


<details>
  <summary>Details</summary>
Motivation: Existing memory mechanisms rely on static, hand-crafted workflows, limiting performance and generalization. A flexible, learning-based approach is needed.

Method: AtomMem deconstructs memory processes into atomic CRUD operations, using supervised fine-tuning and reinforcement learning to learn task-aligned memory policies.

Result: AtomMem-8B consistently outperforms prior static methods across 3 long-context benchmarks, demonstrating structured, task-aligned strategies.

Conclusion: The learning-based approach of AtomMem offers superior adaptability and performance compared to predefined static workflows.
...
### [198] [Semantic Laundering in AI Agent Architectures: Why Tool Boundaries Do Not Confer Epistemic Warrant](https://arxiv.org/abs/2601.08333)
*Oleg Romanchuk,Roman Bondar*

Main category: cs.AI

TL;DR: LLM-based agent architectures often mix information transport with epistemic justification, leading to 'semantic laundering' where poorly justified propositions gain undue credibility. This mirrors the Gettier problem but is architecturally inherent. The paper proves circular epistemic justification is unavoidable under standard assumptions, with scaling and LLM-as-judge schemes unable to resolve this systemic issue.


<details>
  <summary>Details</summary>
Motivation: To expose and formalize the inherent flaw in LLM-based architectures where information transport and epistemic justification mechanisms are conflated, leading to systematic epistemic failures.

Method: The authors formalize the issue as 'semantic laundering,' liken it to the Gettier problem, and prove the inevitability of circular epistemic justification under standard architectural assumptions. They introduce the Warrant Erosion Principle to explain the phenomenon.

Result: The paper demonstrates that semantic laundering is architecturally determined and reproducible, with circular epistemic justification being unavoidable. Scaling or improving models cannot eliminate this systemic flaw.

Conclusion: LLM-based architectures inherently suffer from semantic laundering, making them systematically prone to epistemic failures like circular justification. This issue persists regardless of model improvements or scaling, highlighting a fundamental limitation.
...
### [199] [Thematic Working Group 5 -- Artificial Intelligence (AI) literacy for teaching and learning: design and implementation](https://arxiv.org/abs/2601.08380)
...
TL;DR: Summary of TWG 5's work on enhancing AI literacy and agency for teachers through curriculum, professional development, classroom applications, and policy guidelines.


<details>
  <summary>Details</summary>
Motivation: To empower educators with the knowledge and skills to integrate AI into teaching, fostering student understanding of AI.

Method: Developed strategies including curriculum design, professional development programs, practical classroom applications, and policy guidelines.

Result: Equipped teachers to confidently use AI tools and deepen students' AI comprehension.

Conclusion: Effective strategies were developed to enhance AI literacy and agency among teachers, enabling better AI integration in education.
...
### [200] [A Qualitative Model to Reason about Object Rotations (QOR) applied to solve the Cube Comparison Test (CCT)](https://arxiv.org/abs/2601.08382)
*Zoe Falomir*

Main category: cs.AI

TL;DR: The paper introduces a Qualitative model (QOR) for reasoning about object rotations, specifically solving the Cube Comparison Test using a conceptual neighborhood graph (CNGRLO) to relate rotation, location, and orientation changes.


<details>
  <summary>Details</summary>
Motivation: The motivation is to develop a qualitative model that can effectively reason about object rotations, particularly for solving the Cube Comparison Test.

Method: The method involves building a conceptual neighborhood graph (CNGRLO) that links rotation movements to location and orientation changes, and generating composition tables for inference calculations.

Result: The result is a framework (QOR) that successfully applies the CNGRLO graph and composition tables to reason about rotations in the Cube Comparison Test.

Conclusion: The QOR model, with its CNGRLO graph and composition tables, provides an effective qualitative approach for reasoning about object rotations.
...
### [201] [Deconstructing Pre-training: Knowledge Attribution Analysis in MoE and Dense Models](https://arxiv.org/abs/2601.08383)
*Bo Wang,Junzhuo Li,Hong Chen,Yuanlin Chu,Yuxuan Fan,Xuming Hu*

Main category: cs.AI

TL;DR: The paper explores how Mixture-of-Experts (MoE) architectures differ from dense models in knowledge acquisition during pre-training, introducing Gated-LPI to analyze neuron-level updates. Key findings include a low-entropy backbone, early consolidation, and functional robustness in MoE models.


<details>
  <summary>Details</summary>
Motivation: To understand how MoE architectures shape knowledge acquisition compared to dense models, addressing gaps in interpretability and efficiency.

Method: Uses Gated-LPI for neuron-level attribution and compares MoE and dense models over extensive training steps (1.2M for MoE, 600K for dense).

Result: MoE models exhibit a high-utility core (top 1% neurons), early stability (<100K steps), and robustness (masking heads reduces performance less than dense models).

Conclusion: Sparsity in MoE fosters stable, distributed knowledge storage, improving interpretability and bridging gaps with dense models.
...
### [202] [Creativity in AI as Emergence from Domain-Limited Generative Models](https://arxiv.org/abs/2601.08388)
*Corina Chutaux*

Main category: cs.AI

TL;DR: The paper proposes a generative perspective on AI creativity, treating it as an emergent property of domain-limited models, and decomposes creativity into four components for analysis.


<details>
  <summary>Details</summary>
Motivation: To move beyond evaluative frameworks of creativity and instead model it as an emergent phenomenon in AI systems, leveraging advances in generative models.

Method: Introduces a conceptual decomposition of creativity into four components (pattern-based generation, induced world models, contextual grounding, arbitrarity) and examines their manifestation in multimodal generative systems.

Result: Provides a technical framework for studying creativity as an emergent property in AI, grounded in generative dynamics and domain-specific interactions.

Conclusion: Shifts the focus from post hoc evaluation to modeling creativity explicitly, offering a structured approach to understanding and fostering machine creativity.
...
### [203] [Owen-Shapley Policy Optimization (OSPO): A Principled RL Algorithm for Generative Search LLMs](https://arxiv.org/abs/2601.08403)
*Abhijnan Nath,Alireza Bagheri Garakani,Tianchen Zhou,Fan Yang,Nikhil Krishnaswamy*

Main category: cs.AI

TL;DR: OSPO addresses the credit assignment gap in reinforcement learning for recommendation tasks by redistributing sequence-level rewards based on tokens' marginal contributions.


<details>
  <summary>Details</summary>
Motivation: Standard methods like GRPO rely on sparse rewards, making it unclear which tokens drive success, especially when inferring latent user intent without ground truth labels.

Method: OSPO uses Shapley-Owen attributions to redistribute rewards based on tokens' marginal contributions, avoiding the need for additional parametric value models.

Result: Experiments on Amazon ESCI and H&M Fashion datasets show consistent improvements over baselines and robustness to unseen retrievers.

Conclusion: OSPO effectively addresses the credit assignment gap and improves performance in recommendation tasks.
...
### [204] [WebTrap Park: An Automated Platform for Systematic Security Evaluation of Web Agents](https://arxiv.org/abs/2601.08406)
*Xinyi Wu,Jiagui Chen,Geng Hong,Jiayi Dong,Xudong Pan,Jiarun Dai,Min Yang*

Main category: cs.AI

TL;DR: WebTrap Park is an automated platform for systematically evaluating the security of Web Agents by observing their interactions with live web pages, testing 1,226 tasks across three major security risks.


<details>
  <summary>Details</summary>
Motivation: Addressing the fragmented and challenging standardization of security evaluations for Web Agents deployed in real web environments.

Method: WebTrap Park evaluates Web Agents by directly observing their interactions with live web pages, creating 1,226 executable tasks based on three major security risks.

Result: Reveals significant security differences across agent frameworks, emphasizing the role of agent architecture independent of the underlying model.

Conclusion: WebTrap Park offers a scalable, reproducible foundation for Web Agent security evaluations and is publicly accessible.
...
### [205] [Hybrid Distillation with CoT Guidance for Edge-Drone Control Code Generation](https://arxiv.org/abs/2601.08412)
*Yizhan Feng,Hichem Snoussi,Yuhang Wang,Jing Teng,Abel Cherouat,Tian Wang*

Main category: cs.AI

TL;DR: The paper proposes an integrated approach combining knowledge distillation, chain-of-thought guidance, and fine-tuning to enable lightweight UAV control using smaller language models.


<details>
  <summary>Details</summary>
Motivation: The contradiction between the high resource demands of large language models and the lightweight needs of UAV platforms drives this research.

Method: Uses knowledge distillation, chain-of-thought guidance, supervised fine-tuning, and a hybrid distillation strategy with a quantized teacher model and weighted loss.

Result: The distilled model maintains high accuracy in code generation while improving deployment and inference efficiency.

Conclusion: The approach effectively achieves precise and lightweight UAV control, demonstrating feasibility and superiority.
...
### [206] [RubricHub: A Comprehensive and Highly Discriminative Rubric Dataset via Automated Coarse-to-Fine Generation](https://arxiv.org/abs/2601.08430)
*Sunzhu Li,Jiale Zhao,Miteto Wei,Huimin Ren,Yang Zhou,Jingwen Yang,Shunyu Liu,Kaike Zhang,Wei Chen*

Main category: cs.AI

TL;DR: The paper introduces RubricHub, a large-scale dataset for reinforcement learning with verifiable rewards, and a post-training pipeline (RuFT and RuRL) to enhance open-ended generation tasks.


<details>
  <summary>Details</summary>
Motivation: Existing methods for optimizing open-ended generation lack scalability and nuanced evaluation criteria, limiting their effectiveness.

Method: Proposed a Coarse-to-Fine Rubric Generation framework combining principle-guided synthesis, multi-model aggregation, and difficulty evolution. Introduced RubricHub dataset and a post-training pipeline (RuFT and RuRL).

Result: Qwen3-14B post-trained with RubricHub achieved SOTA results on HealthBench (69.3), outperforming proprietary models like GPT-5.

Conclusion: RubricHub and the proposed pipeline significantly improve performance in open-ended generation tasks, addressing existing limitations.
...
### [207] [YaPO: Learnable Sparse Activation Steering Vectors for Domain Adaptation](https://arxiv.org/abs/2601.08441)
*Abdelaziz Bounhar,Rania Hossam Elmohamady Elbadry,Hadi Abdine,Preslav Nakov,Michalis Vazirgiannis,Guokan Shang*

Main category: cs.AI

TL;DR: YaPO introduces a reference-free method using sparse steering vectors for fine-grained alignment of LLMs, outperforming dense baselines in speed, performance, and stability.


<details>
  <summary>Details</summary>
Motivation: Addressing limitations of dense steering vectors in disentangling latent factors for fine-grained alignment tasks like cultural distinctions.

Method: YaPO learns sparse steering vectors in a Sparse Autoencoder's latent space, optimizing sparse codes for disentangled and interpretable directions.

Result: YaPO converges faster, performs better, and is more stable than dense steering methods, with no degradation on general knowledge tasks (MMLU).

Conclusion: YaPO offers an efficient, stable, and fine-grained alignment solution for LLMs, applicable to various alignment-related behaviors.
...
### [208] [Beyond Linearization: Attributed Table Graphs for Table Reasoning](https://arxiv.org/abs/2601.08444)
*Yuxiang Wang,Junhao Gan,Shengxiang Gao,Shenghao Ye,Zhengyi Yang,Jianzhong Qi*

Main category: cs.AI

TL;DR: The paper introduces TABGR, a training-free model for table reasoning that uses Attributed Table Graphs (ATG) to preserve table structures and enable explainable reasoning, outperforming existing methods by up to 9.7% in accuracy.


<details>
  <summary>Details</summary>
Motivation: The prevalence of tabular data storage and the limitations of current linearization methods for table reasoning motivate the need for a solution that preserves table structures, provides explicit reasoning paths, and avoids the 'lost-in-the-middle' issue.

Method: The proposed method, TABGR, represents tables as Attributed Table Graphs (ATG) to maintain row-column-cell structures and employs a Question-Guided Personalized PageRank (QG-PPR) mechanism to rerank tabular data and enhance reasoning.

Result: Extensive experiments on standard benchmarks demonstrate that TABGR consistently outperforms state-of-the-art models by up to 9.7% in accuracy.

Conclusion: TABGR addresses critical issues in table reasoning by leveraging graph-based representations and reranking mechanisms, offering improved performance and explainability.
...
### [209] [An Under-Explored Application for Explainable Multimodal Misogyny Detection in code-mixed Hindi-English](https://arxiv.org/abs/2601.08457)
*Sargam Yadav,Abhishek Kaushik,Kevin Mc Daid*

Main category: cs.AI

TL;DR: The paper presents a multi-modal, explainable AI system for detecting misogyny in text and memes in Hindi-English code-mixed content, using transformer models and explainability tools.


<details>
  <summary>Details</summary>
Motivation: To address the lack of interpretability and low-resource language support in AI models for combating online hate speech, particularly misogyny.

Method: The system uses XLM-RoBERTa and mBERT for text-based detection, and mBERT + EfficientNet/ResNET for multimodal meme analysis. SHAP and LIME provide explainability.

Result: Evaluated on datasets of ~4,193 comments and ~4,218 memes, the system's usability was assessed via CUQ and UEQ by human evaluators.

Conclusion: The application aids researchers and moderators in fighting gender-based digital violence, promoting safe digital spaces.
...
### [210] [SUMMPILOT: Bridging Efficiency and Customization for Interactive Summarization System](https://arxiv.org/abs/2601.08475)
*JungMin Yun,Juhwan Choi,Kyohoon Jin,Soojin Jang,Jinhee Jang,YoungBin Kim*

Main category: cs.AI

TL;DR: SummPilot is an interactive summarization system that uses a large language model to create personalized summaries, featuring tools like semantic graphs and explainable evaluation.


<details>
  <summary>Details</summary>
Motivation: To address the challenge of generating summaries tailored to individual users' interests and needs by combining automatic summarization with interactive customization.

Method: Introduces SummPilot, leveraging a large language model for both automatic and interactive summarization, utilizing semantic graphs, entity clustering, and explainable evaluation.

Result: SummPilot proves adaptable and useful for customizable summarization, as shown in demo and user studies.

Conclusion: SummPilot effectively bridges the gap between automatic summarization and personalized user requirements through interactive features.
...
### [211] [What If TSF: A Benchmark for Reframing Forecasting as Scenario-Guided Multimodal Forecasting](https://arxiv.org/abs/2601.08509)
*Jinkwan Jang,Hyunbin Jin,Hyungjin Park,Kyubyung Chae,Taesup Kim*

Main category: cs.AI

TL;DR: Introducing What If TSF (WIT), a multimodal forecasting benchmark evaluating models' ability to leverage contextual text, especially future scenarios, for improved forecasting.


<details>
  <summary>Details</summary>
Motivation: To address the lack of benchmarks assessing whether multimodal models meaningfully use textual inputs for forecasting, inspired by human experts' scenario-based approaches.

Method: WIT provides expert-crafted plausible or counterfactual scenarios alongside historical data, testing models' ability to condition forecasts on contextual text.

Result: The benchmark offers a rigorous testbed for scenario-guided multimodal forecasting, evaluating models' performance under varying scenarios.

Conclusion: WIT fills a gap in multimodal forecasting evaluation, enabling models to mimic human experts' scenario-driven forecasting approaches.
...
### [212] [Sketch-Based Facade Renovation With Generative AI: A Streamlined Framework for Bypassing As-Built Modelling in Industrial Adaptive Reuse](https://arxiv.org/abs/2601.08531)
*Warissara Booranamaitree,Xusheng Du,Yushu Cai,Zhengyang Wang,Ye Zhang,Haoran Xie*

Main category: cs.AI

TL;DR: A framework using generative AI and vision-language models simplifies facade renovation by generating proposals from rough sketches and descriptions, bypassing detailed as-built modelling.


<details>
  <summary>Details</summary>
Motivation: Current facade renovation workflows are inefficient, requiring time-consuming detailed modelling and revisions.

Method: A three-stage framework combines VLM for predicting modifications, stable diffusion for generating new elements, and ControlNet for refining images.

Result: The framework successfully generates renovation proposals preserving original structures while improving facade details.

Conclusion: The approach enables faster design exploration and clearer communication of renovation intentions.
...
### [213] [Learner-Tailored Program Repair: A Solution Generator with Iterative Edit-Driven Retrieval Enhancement](https://arxiv.org/abs/2601.08545)
*Zhenlong Dai,Zhuoluo Zhao,Hengning Wang,Xiu Tang,Sai Wu,Chang Yao,Zhipeng Gao,Jingyuan Chen*

Main category: cs.AI

TL;DR: The paper introduces Learner-Tailored Program Repair (LPR) and proposes a framework called Learner-Tailored Solution Generator (LSG) to improve program repair by providing bug descriptions. It uses retrieval-based and iterative methods to enhance performance.


<details>
  <summary>Details</summary>
Motivation: Existing research focuses on fixing bugs in learner code but lacks explanations for their causes. The paper addresses this gap by proposing LPR and LSG to offer both fixes and underlying reasons.

Method: LSG employs a repair solution retrieval framework and edit-driven code retrieval to guide LLMs in fixing bugs. It also introduces an iterative retrieval enhancement method to optimize repair strategies.

Result: The framework outperforms baselines significantly, demonstrating its effectiveness in the LPR task.

Conclusion: LSG effectively repairs code and provides bug descriptions, advancing intelligent programming coaching systems.
...
### [214] [WaterCopilot: An AI-Driven Virtual Assistant for Water Management](https://arxiv.org/abs/2601.08559)
*Keerththanan Vickneswaran,Mariangel Garcia Andarcia,Hugo Retief,Chris Dickens,Paulo Silva*

Main category: cs.AI

TL;DR: WaterCopilot, an AI-driven virtual assistant, integrates diverse water management data for the Limpopo River Basin, achieving high performance in relevancy and precision.


<details>
  <summary>Details</summary>
Motivation: Address fragmented data, limited real-time access, and integration challenges in transboundary water resource management.

Method: Uses Retrieval-Augmented Generation (RAG) and tool-calling architectures with custom plugins for semantic search and real-time data queries.

Result: Achieves an overall score of 0.8043 (RAGAS framework), with high answer relevancy (0.8571) and context precision (0.8009).

Conclusion: Demonstrates AI's potential to enhance water governance in transboundary basins, despite limitations in non-English document processing and API latency.
...
### [215] [ViDoRe V3: A Comprehensive Evaluation of Retrieval Augmented Generation in Complex Real-World Scenarios](https://arxiv.org/abs/2601.08620)
...
TL;DR: ViDoRe v3 is a multimodal RAG benchmark addressing complex tasks like visual element interpretation and multi-document synthesis, featuring diverse datasets and human-verified queries in 6 languages.


<details>
  <summary>Details</summary>
Motivation: Existing benchmarks lack complexity in handling multimodal data, multi-document synthesis, and accurate source grounding, limiting RAG pipeline evaluation.

Method: Introduces ViDoRe v3, covering 10 datasets with ~26,000 document pages and 3,099 queries, supported by 12,000 hours of human annotation for retrieval relevance, bounding boxes, and verified answers.

Result: Visual retrievers outperform textual ones; late-interaction models and textual reranking improve performance; hybrid or visual contexts enhance answer generation.

Conclusion: Current models struggle with non-textual elements and fine-grained visual grounding. ViDoRe v3 is released to foster progress in multimodal RAG.
...
### [216] [Resisting Manipulative Bots in Memecoin Copy Trading: A Multi-Agent Approach with Chain-of-Thought Reasoning](https://arxiv.org/abs/2601.08641)
*Yichen Luo,Yebo Feng,Jiahua Xu,Yang Liu*

Main category: cs.AI

TL;DR: The paper proposes a multi-agent system for meme coin copy trading, addressing challenges like manipulative bots and LLMs' limitations, achieving high precision and profitability.


<details>
  <summary>Details</summary>
Motivation: Copy trading in meme coins faces issues like bots, uncertainty, and trade execution lag. LLMs lack domain-specific knowledge for complex tasks like asset allocation.

Method: An explainable multi-agent system decomposes tasks, uses few-shot CoT prompting for trading knowledge, and interprets multi-modal data collaboratively.

Result: The system outperforms traditional models and single LLMs, with 73% precision for meme coins and 70% for KOL wallets, generating $500K profit.

Conclusion: The multi-agent system effectively addresses meme coin copy trading challenges, demonstrating superior performance and profitability.
...
### [217] [Prism: Towards Lowering User Cognitive Load in LLMs via Complex Intent Understanding](https://arxiv.org/abs/2601.08653)
*Zenghua Liao,Jinzhi Liao,Xiang Zhao*

Main category: cs.AI

TL;DR: Prism, a framework inspired by Cognitive Load Theory, enhances LLM-based complex intent understanding by decomposing intents, generating logical clarifications, and iteratively refining interactions.


<details>
  <summary>Details</summary>
Motivation: Existing methods fail to model logical dependencies among clarification questions, hindering effective human-LLM collaboration for ambiguous and dynamic user goals.

Method: Prism includes four modules: intent decomposition, logical clarification generation, intent-aware reward evaluation via Monte Carlo Sampling, and self-evolved intent tuning.

Result: Prism outperforms benchmarks, achieving 11.5% logical conflicts, 14.4% higher user satisfaction, and 34.8% faster task completion.

Conclusion: Prism sets a new standard for logical consistency and efficiency in LLM-based intent clarification.
...
### [218] [From Classical to Quantum Reinforcement Learning and Its Applications in Quantum Control: A Beginner's Tutorial](https://arxiv.org/abs/2601.08662)
*Abhijit Sen,Sonali Panda,Mahima Arya,Subhajit Patra,Zizhan Zheng,Denys I. Bondar*

Main category: cs.AI

TL;DR: A tutorial simplifying reinforcement learning for undergraduates with practical examples and explanations.


<details>
  <summary>Details</summary>
Motivation: To make RL accessible by bridging theory-practice gaps and addressing student challenges.

Method: Uses hands-on examples and clear explanations.

Result: Equips students with foundational RL skills for real-world applications.

Conclusion: The tutorial effectively prepares students to confidently apply RL techniques.
...
### [219] [Parallel Context-of-Experts Decoding for Retrieval Augmented Generation](https://arxiv.org/abs/2601.08670)
*Giulio Corallo,Paolo Papotti*

Main category: cs.AI

TL;DR: Pced is a framework that improves Retrieval Augmented Generation by synchronizing predictions of isolated 'experts' (documents) during decoding, enabling cross-document reasoning without shared attention bottlenecks.


<details>
  <summary>Details</summary>
Motivation: Address the trade-off in Retrieval Augmented Generation between multi-document reasoning (slow due to long prompts) and speed (limited by isolated document encoding).

Method: Introduces Parallel Context-of-Experts Decoding (Pced), a training-free framework that aggregates evidence during decoding via a retrieval-aware contrastive rule, treating documents as isolated 'experts'.

Result: Recovers cross-document reasoning capabilities without requiring shared attention across documents, improving efficiency.

Conclusion: Pced offers a viable solution for balancing speed and multi-document reasoning in Retrieval Augmented Generation.
...
### [220] [Why AI Alignment Failure Is Structural: Learned Human Interaction Structures and AGI as an Endogenous Evolutionary Shock](https://arxiv.org/abs/2601.08673)
*Didier Sornette,Sandro Claudio Lera,Ke Wu*

Main category: cs.AI

TL;DR: The paper argues that LLMs' 'unethical' behaviors are statistical generalizations of human interactions, not emergent malign agency, and reframes AGI risks as structural accelerators of human contradictions.


<details>
  <summary>Details</summary>
Motivation: To challenge the misinterpretation of LLMs' behaviors as malign agency and reframe AGI risks by understanding their role as amplifiers of human social dynamics.

Method: The paper draws on relational models theory and analyzes LLM behaviors as structural generalizations of human interaction regimes under power asymmetries.

Result: Behaviors like blackmail are contextual extremes of normal human interactions, not anomalies, and AGI's real risk lies in amplifying human contradictions and governance gaps.

Conclusion: AGI alignment failure is structural, requiring governance approaches focused on stability and complexity, not just model intent.
...
### [221] [Advancing ESG Intelligence: An Expert-level Agent and Comprehensive Benchmark for Sustainable Finance](https://arxiv.org/abs/2601.08676)
*Yilei Zhao,Wentao Zhang,Xiao Lei,Yandan Zheng,Mengpu Liu,Wei Yang Bryan Lim*

Main category: cs.AI

TL;DR: ESGAgent, a hierarchical multi-agent system with specialized tools, outperforms LLMs in ESG analysis, aided by a new benchmark.


<details>
  <summary>Details</summary>
Motivation: Addressing limitations in ESG analysis due to fragmented data and LLMs' struggles with complex workflows.

Method: Introduces ESGAgent, leveraging retrieval augmentation, web search, and domain-specific functions, plus a three-level benchmark.

Result: Achieves 84.15% accuracy on atomic tasks and excels in professional report generation with verifiable references.

Conclusion: Confirms benchmark's diagnostic value for assessing agentic capabilities in high-stakes domains.
...
TL;DR: PersonaDual is a framework enabling LLMs to switch between general-purpose and personalized reasoning, reducing interference while maintaining benefits.


<details>
  <summary>Details</summary>
Motivation: Balance personalized information with objectivity in LLM interactions.

Method: Train with SFT for reasoning patterns, optimize via DualGRPO reinforcement learning for mode selection.

Result: Near interference-free performance, better objective problem-solving with personalized signals.

Conclusion: PersonaDual effectively balances personalization and objectivity.
...
### [223] [MEMEWEAVER: Inter-Meme Graph Reasoning for Sexism and Misogyny Detection](https://arxiv.org/abs/2601.08684)
*Paolo Italiani,David Gimeno-Gomez,Luca Ragazzi,Gianluca Moro,Paolo Rosso*

Main category: cs.AI

TL;DR: MemeWeaver is a multimodal framework detecting online sexism and misogyny via inter-meme graph reasoning, outperforming existing methods on benchmarks like MAMI and EXIST.


<details>
  <summary>Details</summary>
Motivation: Women face disproportionate online harassment, yet current moderation tools ignore social dynamics like group identity reinforcement. Graph-based methods show promise but suffer from limitations.

Method: MemeWeaver uses an end-to-end trainable multimodal framework with inter-meme graph reasoning, evaluating various visual-textual fusion strategies.

Result: It outperforms state-of-the-art baselines on MAMI and EXIST benchmarks, with faster training convergence. The graph structure captures meaningful relational patterns in online hate.

Conclusion: MemeWeaver effectively addresses gaps in detecting gendered harassment, offering insights into relational hate dynamics.
...
### [224] [All Required, In Order: Phase-Level Evaluation for AI-Human Dialogue in Healthcare and Beyond](https://arxiv.org/abs/2601.08690)
*Shubham Kulkarni,Alexander Lyzhov,Shiva Chaitanya,Preetam Joshi*

Main category: cs.AI

TL;DR: OIP-SCE is a conversational AI evaluation method ensuring clinical compliance by tracking required obligations in the right order with clear evidence for clinicians.


<details>
  <summary>Details</summary>
Motivation: Existing evaluation methods miss how compliance depends on the full conversation, creating gaps between technical progress and clinical needs.

Method: OIP-SCE checks if every clinical obligation is met in the right order with clear evidence, demonstrated in two case studies (respiratory history, benefits verification).

Result: The method turns policy into actionable steps, aligns AI with clinical workflows, and supports safe use.

Conclusion: OIP-SCE bridges the gap between AI capabilities and clinical needs by providing an auditable, practical evaluation surface.
...
### [225] [Evaluating the Ability of Explanations to Disambiguate Models in a Rashomon Set](https://arxiv.org/abs/2601.08703)
*Kaivalya Rawal,Eoin Delaney,Zihao Fu,Sandra Wachter,Chris Russell*

Main category: cs.AI

TL;DR: The paper introduces AXE, a method for evaluating feature-importance explanations in XAI, focusing on principles that highlight model differences without relying on ground truth. AXE detects adversarial fairwashing with 100% success and identifies use of protected attributes.


<details>
  <summary>Details</summary>
Motivation: To address the variability and potential bias in explanations provided by different explainers for similarly performing models (Rashomon set), ensuring reliable explanation evaluation without ground truth.

Method: Proposed three principles for explanation evaluation and developed AXE, a method to assess feature-importance explanations by highlighting model differences and detecting adversarial cases.

Result: AXE successfully detects adversarial fairwashing (100% success rate) and identifies when protected attributes influence predictions, outperforming prior strategies.

Conclusion: AXE offers a robust way to evaluate explanations within Rashomon sets, emphasizing behavioral differences and preventing misleading evaluations, aiding in model selection.
...
### [226] [Learning from Demonstrations via Capability-Aware Goal Sampling](https://arxiv.org/abs/2601.08731)
*Yuanlin Duan,Yuning Wang,Wenjie Qiu,He Zhu*

Main category: cs.AI

TL;DR: Cago improves imitation learning by dynamically tracking agent competence and selecting intermediate goals for steady progress.


<details>
  <summary>Details</summary>
Motivation: Mitigate imitation learning's brittleness in long-horizon tasks where small errors accumulate catastrophically.

Method: Cago tracks agent competence along expert trajectories and selects intermediate goals just beyond current reach.

Result: Cago enhances sample efficiency and final performance, outperforming baselines in sparse-reward tasks.

Conclusion: Cago's adaptive curriculum effectively guides learning in imitation tasks.
...
### [227] [AI as Entertainment](https://arxiv.org/abs/2601.08768)
*Cody Kommers,Ari Holtzman*

Main category: cs.AI

TL;DR: The paper highlights the overlooked role of AI in entertainment, arguing that current evaluation practices focus too narrowly on harms and ignore potential cultural benefits.


<details>
  <summary>Details</summary>
Motivation: To address the gap in evaluating AI's societal impact beyond productivity, especially its growing use for entertainment and cultural purposes.

Method: Analyzes current AI evaluation practices and proposes 'thick entertainment' as a framework inspired by humanities to assess cultural benefits.

Result: Identifies widespread AI adoption for entertainment, particularly among youth, and predicts it will shape future AI development and business models.

Conclusion: AI's societal impact may shift from productivity to cultural and social roles, necessitating new evaluation frameworks like 'thick entertainment'.
...
### [228] [Pervasive Annotation Errors Break Text-to-SQL Benchmarks and Leaderboards](https://arxiv.org/abs/2601.08778)
*Tengjun Jin,Yoojin Choi,Yuxuan Zhu,Daniel Kang*

Main category: cs.AI

TL;DR: The paper examines annotation errors in text-to-SQL benchmarks BIRD and Spider 2.0-Snow, reveals high error rates, and shows their impact on performance rankings.


<details>
  <summary>Details</summary>
Motivation: To assess the validity of annotations in text-to-SQL benchmarks and their effect on agent performance and leaderboard rankings.

Method: Empirical study analyzing annotation errors in BIRD and Spider 2.0-Snow, correcting subsets, and re-evaluating agents.

Result: High error rates (52.8% for BIRD, 62.8% for Spider 2.0-Snow) significantly alter agent rankings (-9 to +9 position changes).

Conclusion: Annotation errors distort reported performance and rankings, potentially misguiding research and deployment decisions.
...
### [229] [Uncovering Political Bias in Large Language Models using Parliamentary Voting Records](https://arxiv.org/abs/2601.08785)
*Jieying Chen,Karen de Jong,Andreas Poole,Jan Burakowski,Elena Elderson Nosti,Joep Windt,Chendi Wang*

Main category: cs.AI

TL;DR: The paper introduces a methodology to assess political bias in LLMs using voting records from three countries, revealing left-leaning tendencies and biases against right-conservative parties.


<details>
  <summary>Details</summary>
Motivation: To address the limited systematic studies on political bias in LLMs, given their societal impact, by creating benchmarks aligned with parliamentary voting records.

Method: Constructing political bias benchmarks using verified parliamentary voting records and visualizing LLM ideologies in a shared CHES space for interpretable comparisons.

Result: LLMs show left-leaning or centrist tendencies and negative biases toward right-conservative parties.

Conclusion: Cross-national evaluation grounded in parliamentary behavior is valuable for auditing political bias in LLMs.
...
### [230] [Hierarchical Sparse Plus Low Rank Compression of LLM](https://arxiv.org/abs/2601.07839)
*Pawan Kumar,Aditi Gupta*

Main category: cs.LG

TL;DR: HSS compression reduces memory and compute pressure in LLMs by combining sparse matrix removal and hierarchical low-rank factorization, achieving efficient performance with minimal perplexity increase.


<details>
  <summary>Details</summary>
Motivation: Large language models demand high memory and compute resources, necessitating effective compression techniques for deployment and training.

Method: HSS compression involves two stages: removing large-magnitude weights into a sparse matrix and applying recursive hierarchical low-rank factorization to the residual matrix. Techniques like recursive rank reduction and RCM permutation enhance compressibility.

Result: Tests on LLaMA-7B show HSS retains comparable perplexity scores (e.g., 1.64 on WikiText) with significant memory savings, outperforming dense and sparse-plus-SVD baselines.

Conclusion: HSS compression is hardware-friendly and effective, balancing performance and resource efficiency for LLMs.
...
### [231] [Adaptive Requesting in Decentralized Edge Networks via Non-Stationary Bandits](https://arxiv.org/abs/2601.08760)
*Yi Zhuang,Kun Yang,Xingran Chen*

Main category: cs.LG

TL;DR: AGING BANDIT WITH ADAPTIVE RESET algorithm improves information freshness in decentralized edge networks by addressing non-stationary reward challenges.


<details>
  <summary>Details</summary>
Motivation: Optimize information freshness for time-sensitive clients in decentralized edge networks with partial observability and coupled rewards.

Method: Propose AGING BANDIT WITH ADAPTIVE RESET algorithm combining adaptive windowing and periodic monitoring to track evolving reward distributions.

Result: Theoretical guarantees show near-optimal performance; simulations validate effectiveness.

Conclusion: The algorithm effectively addresses non-stationary, coupled rewards, improving information freshness for clients.
...
### [232] [Affect and Effect: Limitations of regularisation-based continual learning in EEG-based emotion classification](https://arxiv.org/abs/2601.07858)
*Nina Peire,Yupei Li,Björn Schuller*

Main category: cs.LG

TL;DR: Regularisation-based continual learning methods like EWC, SI, and MAS show limited performance in EEG-based emotion classification due to misalignment in stability-plasticity trade-offs and unreliable parameter importance heuristics.


<details>
  <summary>Details</summary>
Motivation: To address generalisation challenges in EEG-based emotion classification caused by high inter- and intra-subject variability, the study explores the suitability of regularisation-based continual learning methods.

Method: The study theoretically and empirically evaluates regularisation-based CL methods (EWC, SI, MAS) on EEG datasets (DREAMER, SEED) under subject-incremental sequences.

Result: Regularisation-based CL methods struggle due to unreliable parameter importance heuristics, gradient interference, sensitivity to subject order, and lack of significant forward transfer improvement.

Conclusion: Regularisation-based continual learning approaches are limited for robust generalisation in EEG-based emotion classification and may not be suitable for unseen subjects.
...
### [233] [RewriteNets: End-to-End Trainable String-Rewriting for Generative Sequence Modeling](https://arxiv.org/abs/2601.07868)
*Harshil Vejendla*

Main category: cs.LG

TL;DR: RewriteNets is a neural architecture using explicit, parallel string rewriting for efficient and systematic sequence modeling, outperforming Transformers and LSTMs on certain tasks.


<details>
  <summary>Details</summary>
Motivation: The paper aims to address the quadratic complexity of implicit structure modeling in Transformers by introducing explicit, parallel string rewriting.

Method: RewriteNets use learnable rules for fuzzy matching, conflict resolution, rule application, and token propagation, with a Gumbel-Sinkhorn estimator for differentiable training.

Result: RewriteNets achieve 98.7% accuracy on SCAN's length split and are computationally more efficient than Transformers.

Conclusion: The architecture offers a promising approach for sequence modeling with explicit structural inductive biases.
...
### [234] [HOSC: A Periodic Activation with Saturation Control for High-Fidelity Implicit Neural Representations](https://arxiv.org/abs/2601.07870)
*Michal Jan Wlodarczyk,Danzel Serrano,Przemyslaw Musialski*

Main category: cs.LG

TL;DR: The paper introduces HOSC activation, a hyperbolic oscillator with saturation control, addressing gradient instability and multi-scale limitations in periodic activations for implicit neural representations (INRs).


<details>
  <summary>Details</summary>
Motivation: Existing periodic activations like sine preserve high-frequency data but struggle with gradient instability and lack control over multi-scale behavior. HOSC aims to solve these issues.

Method: HOSC activation uses $	anhigl(βsin(ω_0 x)igr)$, where $β$ explicitly controls Lipschitz bounds and gradient magnitudes while retaining periodic properties. Mathematical analysis and empirical tests across domains validate its performance.

Result: HOSC outperforms or matches SIREN, FINER, and similar methods in INR tasks, offering better gradient control and scalability. Domain-specific hyperparameter guidelines are provided.

Conclusion: HOSC is a practical periodic activation for INRs, balancing high-frequency preservation with stable gradients and tunable behavior, making it suitable for diverse applications.
...
### [235] [Multiplicative Orthogonal Sequential Editing for Language Models](https://arxiv.org/abs/2601.07873)
*Hao-Xiang Xu,Jun-Yu Ma,Ziqi Peng,Yuhao Sun,Zhen-Hua Ling,Jia-Chen Gu*

Main category: cs.LG

TL;DR: The paper introduces MOSE, a multiplicative orthogonal sequential editing method for LLMs, preserving numerical stability and improving editing performance compared to additive methods.


<details>
  <summary>Details</summary>
Motivation: Existing additive knowledge editing methods compromise numerical stability, reducing performance and general abilities in LLMs, especially in sequential edits.

Method: Proposes MOSE, a multiplicative paradigm using orthogonal matrices to update LLM parameters without altering numerical stability.

Result: MOSE improves sequential editing performance by 12.08% and retains 95.73% of general abilities in downstream tasks.

Conclusion: MOSE effectively maintains numerical stability and outperforms additive methods in knowledge editing for LLMs.
...
### [236] [NOVAK: Unified adaptive optimizer for deep neural networks](https://arxiv.org/abs/2601.07876)
*Sergii Kavun*

Main category: cs.LG

TL;DR: NOVAK is a novel gradient-based optimizer combining adaptive techniques, rectified learning rates, and advanced momentum, showing superior speed and accuracy across benchmarks.


<details>
  <summary>Details</summary>
Motivation: To create a unified, high-performance optimizer addressing limitations like numerical instability and architectural robustness in deep networks.

Method: Integrates adaptive moment estimation, rectified learning rates, decoupled regularization, Nesterov momentum variants, and lookahead synchronization with custom CUDA kernels for speed.

Result: Achieves 3-5x speedups, state-of-the-art accuracy on CIFAR/ImageNet, and exceptional robustness (e.g., VGG-16/ImageNette).

Conclusion: NOVAK's design breaks limitations in adaptive optimization, proving critical for training deep networks without skip connections.
...
### [237] [E^2-LLM: Bridging Neural Signals and Interpretable Affective Analysis](https://arxiv.org/abs/2601.07877)
*Fei Ma,Han Lin,Yifan Xie,Hongwei Ren,Xiaoyu Shen,Wenbo Ding,Qi Tian*

Main category: cs.LG

TL;DR: E^2-LLM is the first multimodal large language model adapted for interpretable emotion analysis from EEG signals, achieving superior performance in classification and reasoning tasks.


<details>
  <summary>Details</summary>
Motivation: Existing multimodal LLMs aren't designed for neural signals' unique spatiotemporal properties, creating a gap in interpretable emotion analysis from EEG.

Method: E^2-LLM integrates a pretrained EEG encoder with Qwen-based LLMs via learnable projections, using multi-stage training including emotion pretraining, cross-modal alignment,

Result: achieved excellent performance on emotion classification tasks with enhanced reliability and zero-shot generalization capabilities.

Conclusion: establishes a new paradigm combining physiological signals with LLMs for affective computing.
...
### [238] [Sliced-Wasserstein Distribution Alignment Loss Improves the Ultra-Low-Bit Quantization of Large Language Models](https://arxiv.org/abs/2601.07878)
*Deyu Cao,Yixin Yin,Samin Aref*

Main category: cs.LG

TL;DR: The paper introduces a sliced Wasserstein loss function for ultra-low-bit quantization in large language models, improving efficiency and performance without added computational overhead during inference.


<details>
  <summary>Details</summary>
Motivation: Large language models incur high economic and environmental costs due to resource inefficiency. Quantization below 4-bits often degrades performance, necessitating a solution.

Method: A sliced Wasserstein loss function aligns output distributions of full-precision and quantized models under random linear projections, complementing standard mean-squared error loss.

Result: The proposed loss recovers 0.93-20.37% of lost accuracy across models like LLaMA-2-7B, OPT-6.7B, and LLaMA-2-13B, and improves TesseraQ's performance by 3.63-7.63%.

Conclusion: Distributional alignment via the sliced Wasserstein loss effectively enhances frontier quantization methods, pushing the limits of ultra-low-bit performance.
...
### [239] [Max-Min Neural Network Operators For Approximation of Multivariate Functions](https://arxiv.org/abs/2601.07886)
*Abhishek Yadav,Uaday Singh,Feng Dai*

Main category: cs.LG

TL;DR: The paper introduces multivariate max-min neural network operators for approximation, extending univariate methods, and proves their efficiency and stability.


<details>
  <summary>Details</summary>
Motivation: To extend the success of univariate max-min neural network operators to multivariate cases for better theoretical and practical approximation.

Method: Developed multivariate operators activated by sigmoidal functions, analyzed convergence theorems, and derived quantitative approximation estimates.

Result: Established pointwise and uniform convergence with quantitative efficiency and stability proofs.

Conclusion: Multivariate max-min operators are effective and stable tools for approximation in theory and applications.
...
### [240] [KVzap: Fast, Adaptive, and Faithful KV Cache Pruning](https://arxiv.org/abs/2601.07891)
*Simon Jegou,Maximilian Jeblick*

Main category: cs.LG

TL;DR: KVzap is a fast, input-adaptive KV cache approximation method that achieves significant compression with minimal accuracy loss, outperforming existing methods.


<details>
  <summary>Details</summary>
Motivation: The KV cache in transformer-based models has become a bottleneck due to growing context lengths, and existing pruning methods face speed--accuracy trade-offs.

Method: KVzap approximates KVzip adaptively during prefilling and decoding phases, enabling efficient KV cache compression.

Result: KVzap achieves 2--4× compression with negligible accuracy loss on models like Qwen3-8B and Llama-3.1-8B-Instruct, topping the KVpress leaderboard.

Conclusion: KVzap provides a practical solution for KV cache compression, balancing speed and accuracy effectively.
...
### [241] [Sherry: Hardware-Efficient 1.25-Bit Ternary Quantization via Fine-grained Sparsification](https://arxiv.org/abs/2601.07892)
*Hong Huang,Decheng Wu,Qiangqiang Hu,Guanghua Yu,Jinhai Yang,Jianchen Zhu,Xue Liu,Dapeng Wu*

Main category: cs.LG

TL;DR: Sherry is a hardware-efficient ternary quantization framework for LLMs, addressing misalignment with commodity hardware by introducing 3:4 fine-grained sparsity and Arenas mechanism for training stability.


<details>
  <summary>Details</summary>
Motivation: To reduce memory and computational requirements for deploying LLMs on edge devices by improving ternary quantization methods.

Method: Sherry uses 3:4 fine-grained sparsity to pack weights into 5 bits (1.25-bit width) and Arenas to prevent representational collapse during training.

Result: Sherry achieves state-of-the-art ternary performance with 25% bit savings, 10% speedup, and zero accuracy loss on benchmarks.

Conclusion: Sherry offers an efficient solution for deploying LLMs on resource-constrained devices by balancing hardware compatibility and model performance.
...
### [242] [Revealing the Attention Floating Mechanism in Masked Diffusion Models](https://arxiv.org/abs/2601.07894)
*Xin Dai,Pengcheng Huang,Zhenghao Liu,Shuo Wang,Yukun Yan,Chaojun Xiao,Yu Gu,Ge Yu,Maosong Sun*

Main category: cs.LG

TL;DR: Masked diffusion models (MDMs) show dynamic attention behaviors ('Attention Floating'), differing from autoregressive models (ARMs). This explains MDMs' superior in-context learning, doubling ARM performance in knowledge tasks.


<details>
  <summary>Details</summary>
Motivation: To explore the under-studied attention mechanisms in MDMs, revealing their unique 'Attention Floating' behavior and its impact on model performance.

Method: Analyzes attention behaviors in MDMs, identifying dynamic attention anchors and their evolution across denoising steps and layers.

Result: MDMs exhibit shallow structure-aware and deep content-focused attention, enabling stronger in-context learning and outperforming ARMs in knowledge tasks.

Conclusion: Attention Floating in MDMs provides a mechanistic advantage over ARMs, enhancing their performance in knowledge-intensive tasks.
...
### [243] [Large Language Models and Algorithm Execution: Application to an Arithmetic Function](https://arxiv.org/abs/2601.07898)
*Farah Ben Slama,Frédéric Armetta*

Main category: cs.LG

TL;DR: LLMs struggle with algorithm execution, but LLM-DAL training improves their algorithmic inference and generalization.


<details>
  <summary>Details</summary>
Motivation: Address LLMs' limitations in executing algorithms by enhancing their reasoning decomposition capabilities.

Method: Introduce LLM-DAL, a specialized supervised training model focused on algorithmic learning.

Result: LLM-DAL significantly improves LLMs' ability to perform complex algorithmic inferences.

Conclusion: Properly designed training methods can enhance LLMs' algorithmic learning and generalization.
...
### [244] [Enhancing Large Language Models for Time-Series Forecasting via Vector-Injected In-Context Learning](https://arxiv.org/abs/2601.07903)
*Jianqi Zhang,Jingyao Wang,Wenwen Qiang,Fanjiang Xu,Changwen Zheng*

Main category: cs.LG

TL;DR: Proposes LVICL, a vector-injected in-context learning method for improving LLM-based time series forecasting without fine-tuning, reducing computational overhead.


<details>
  <summary>Details</summary>
Motivation: Addresses the gap between pretraining corpora and time series data in LLMs, balancing forecasting performance and compute overhead.

Method: Uses LVICL (vector-injected ICL) to adaptively extract a context vector from examples and inject it into LLM layers, avoiding prompt length increase.

Result: Effectively improves forecasting performance while freezing LLM parameters, demonstrated through extensive experiments.

Conclusion: LVICL offers a computationally efficient solution for enhancing LLM-based time series forecasting by leveraging in-context learning.
...
### [245] [Towards Specialized Generalists: A Multi-Task MoE-LoRA Framework for Domain-Specific LLM Adaptation](https://arxiv.org/abs/2601.07935)
*Yuxin Yang,Aoxiong Zeng,Xiangquan Yang*

Main category: cs.LG

TL;DR: Med-MoE-LoRA combines Mixture-of-Experts (MoE) and Low-Rank Adaptation (LoRA) to address challenges in adapting LLMs to medicine, avoiding catastrophic forgetting and task interference while excelling in specialized tasks.


<details>
  <summary>Details</summary>
Motivation: Adapting LLMs to specialized fields like medicine faces challenges like preserving general knowledge and avoiding task interference, motivating the need for Med-MoE-LoRA.

Method: The framework integrates MoE with LoRA, using asymmetric expert distribution and a Knowledge-Preservation Plugin to balance specialized and general knowledge.

Result: Med-MoE-LoRA outperforms standard LoRA and MoE architectures in medical tasks while retaining general cognitive capabilities.

Conclusion: The proposed framework effectively addresses domain-specific adaptation challenges in LLMs, achieving superior performance in medical applications.
...
### [246] [Coupled Diffusion-Encoder Models for Reconstruction of Flow Fields](https://arxiv.org/abs/2601.07946)
*AmirPouya Hemmasian,Amir Barati Farimani*

Main category: cs.LG

TL;DR: DiffCoder integrates a diffusion model with a ResNet encoder for flow-field reconstruction, outperforming VAEs in preserving statistical and spectral properties, especially under strong compression.


<details>
  <summary>Details</summary>
Motivation: Existing methods like VAEs fail to preserve higher-order statistical structure in fluid flows under compression, necessitating a more robust solution.

Method: DiffCoder combines a probabilistic diffusion model with a convolutional ResNet encoder, trained end-to-end, to learn generative priors over reconstructions.

Result: DiffCoder outperforms VAEs in spectral accuracy and distributional fidelity under aggressive compression, while VAEs remain competitive at moderate compression levels.

Conclusion: Generative decoding via diffusion models provides compact, statistically consistent representations for complex flow fields, especially in severe compression scenarios.
...
### [247] [Reinforcement Learning Methods for Neighborhood Selection in Local Search](https://arxiv.org/abs/2601.07948)
*Yannick Molinghen,Augustin Delecluse,Renaud De Landtsheer,Stefano Michelini*

Main category: cs.LG

TL;DR: RL-based neighborhood selection strategies are explored in local search metaheuristics, showing varying performance across problems, with ε-greedy being consistently effective while deep RL methods face computational overhead.


<details>
  <summary>Details</summary>
Motivation: To examine the effectiveness of reinforcement learning in improving combinatorial optimization methods, specifically within local search metaheuristics.

Method: Evaluation of RL-based neighborhood selection strategies (multi-armed bandits and deep RL methods) against baselines across three problems: TSP, PDPTW, and car sequencing.

Result: Performance varies by problem; ε-greedy ranks consistently high, while deep RL methods require longer runtime to compete.

Conclusion: Deep RL shows promise but has practical limitations in local search due to computational costs.
...
### [248] [Hybrid SARIMA LSTM Model for Local Weather Forecasting: A Residual Learning Approach for Data Driven Meteorological Prediction](https://arxiv.org/abs/2601.07951)
*Shreyas Rajeev,Karthik Mudenahalli Ashoka,Amit Mallappa Tiparaddi*

Main category: cs.LG

TL;DR: A hybrid SARIMA-LSTM model is proposed to improve long-term temperature forecasting by combining SARIMA's stability for seasonal trends with LSTM's ability to capture nonlinear residuals.


<details>
  <summary>Details</summary>
Motivation: Accurate long-term atmospheric forecasting is challenging due to chaotic, nonlinear systems. Existing models like SARIMA fail to capture abrupt changes, while LSTMs struggle with open-loop stability.

Method: A hybrid SARIMA-LSTM architecture decomposes temperature data into predictable (SARIMA) and nonlinear (LSTM) components using residual learning.

Result: The hybrid model minimizes error propagation, combining SARIMA's statistical stability with LSTM's plasticity for enhanced accuracy.

Conclusion: The proposed hybrid approach outperforms standalone models by addressing their limitations, improving long-term forecasting reliability.
...
### [249] [DataScribe: An AI-Native, Policy-Aligned Web Platform for Multi-Objective Materials Design and Discovery](https://arxiv.org/abs/2601.07966)
*Divyanshu Singh,Doguhan Sarıtürk,Cameron Lea,Md Shafiqul Islam,Raymundo Arroyave,Vahid Attari*

Main category: cs.LG

TL;DR: DataScribe is an AI-driven, cloud-based platform for materials discovery, integrating data harmonization, optimization, and machine learning to enable closed-loop research workflows.


<details>
  <summary>Details</summary>
Motivation: The need for advanced digital platforms to accelerate materials discovery by embedding learning, optimization, and decision-making directly into research workflows.

Method: DataScribe uses ontology-backed data ingestion, FAIR-compliant metadata, surrogate modeling, and multi-objective Bayesian optimization to unify experimental and computational pipelines.

Result: Validated through case studies in electrochemical materials and high-entropy alloys, showcasing data fusion, real-time optimization, and reproducible exploration of trade spaces.

Conclusion: DataScribe serves as a versatile backbone for labs of any scale, supporting self-driving labs and distributed materials acceleration platforms with built-in objectives for performance, sustainability, and supply chains.
...
### [250] [Beyond the Next Port: A Multi-Task Transformer for Forecasting Future Voyage Segment Durations](https://arxiv.org/abs/2601.08013)
*Nairui Liu,Fang He,Xindi Tang*

Main category: cs.LG

TL;DR: The paper introduces a transformer-based model for predicting future-port ETAs by leveraging historical sailing data, port congestion proxies, and vessel details, outperforming baselines in accuracy.


<details>
  <summary>Details</summary>
Motivation: Traditional ETA models lack future segment predictions due to reliance on real-time AIS data, creating a gap this study aims to fill.

Method: A transformer architecture with causally masked attention and multi-task learning is used to predict sailing durations and port congestion states.

Result: The model reduces MAE by 4.85% and MAPE by 4.95% compared to sequence baselines, and by 9.39% (MAE) and 52.97% (MAPE) against gradient boosting machines.

Conclusion: The proposed framework significantly improves segment-level ETA predictions, aiding maritime schedule reliability and port operations.
...
### [251] [InfGraND: An Influence-Guided GNN-to-MLP Knowledge Distillation](https://arxiv.org/abs/2601.08033)
*Amir Eskandari,Aman Anand,Elyas Rashno,Farhana Zulkernine*

Main category: cs.LG

TL;DR: InfGraND is a framework that uses influence-guided knowledge distillation to transfer critical structural knowledge from GNNs to MLPs, improving efficiency without compromising performance.


<details>
  <summary>Details</summary>
Motivation: GNNs face latency and resource challenges, while MLPs lack performance. InfGraND aims to bridge this gap by focusing on structurally important nodes.

Method: InfGraND identifies influential nodes for distillation and pre-computes multi-hop neighborhood features to embed structural awareness in MLPs.

Result: InfGraND outperforms existing KD methods across seven datasets in both transductive and inductive settings.

Conclusion: InfGraND offers a practical solution for latency-critical applications by efficiently transferring structural knowledge from GNNs to MLPs.
...
### [252] [Riemannian Zeroth-Order Gradient Estimation with Structure-Preserving Metrics for Geodesically Incomplete Manifolds](https://arxiv.org/abs/2601.08039)
*Shaocong Ma,Heng Huang*

Main category: cs.LG

TL;DR: The paper proposes a method for Riemannian zeroth-order optimization in geodesically incomplete settings by constructing structure-preserving metrics and analyzing convergence guarantees.


<details>
  <summary>Details</summary>
Motivation: To address challenges in Riemannian optimization where the metric is incomplete, ensuring stable convergence without relying on ambient embeddings.

Method: Constructs geodesically complete metrics that preserve stationary points, revisits a symmetric two-point zeroth-order estimator, and analyzes its intrinsic mean-squared error.

Result: Convergence guarantees for stochastic gradient descent are established, with empirical validation on synthetic and practical problems.

Conclusion: The framework achieves stable convergence even without geodesic completeness, matching best-known complexity in complete settings.
...
### [253] [LUT-Compiled Kolmogorov-Arnold Networks for Lightweight DoS Detection on IoT Edge Devices](https://arxiv.org/abs/2601.08044)
*Oleksandr Kuznetsov*

Main category: cs.LG

TL;DR: The paper proposes a LUT compilation pipeline for KANs to enable real-time DoS detection on IoT devices, achieving high accuracy and significant speedups with minimal resource overhead.


<details>
  <summary>Details</summary>
Motivation: DoS attacks threaten IoT ecosystems, but intrusion detection on resource-constrained edge devices is challenging. KANs offer compactness but suffer from computational overhead.

Method: A LUT compilation pipeline replaces spline computations with precomputed tables and linear interpolation, reducing latency while preserving accuracy.

Result: The lightweight KAN model achieves 99.0% accuracy, maintains 98.96% after LUT compilation, and shows 68x–5000x speedups with only 2x memory overhead.

Conclusion: LUT-compiled KANs enable real-time DoS detection on IoT gateways with deterministic latency and minimal resources.
...
### [254] [Q-realign: Piggybacking Realignment on Quantization for Safe and Efficient LLM Deployment](https://arxiv.org/abs/2601.08089)
*Qitao Tan,Xiaoying Song,Ningxi Cheng,Ninghao Liu,Xiaoming Zhai,Lingzi Hong,Yanzhi Wang,Zhen Xiang,Geng Yuan*

Main category: cs.LG

TL;DR: Q-realign is a post-hoc method using post-training quantization to enhance safety alignment in LLMs without coupling it to fine-tuning, reducing computational costs.


<details>
  <summary>Details</summary>
Motivation: Safety alignment in LLMs degrades during task-specific fine-tuning, creating risks; existing defenses are resource-heavy and complex.

Method: Q-realign reframes quantization as dual-objective (compression and safety), decoupling safety from fine-tuning.

Result: Achieves reduced unsafe behaviors and resource usage (e.g., safety recovery on a 7B LLM in 40 minutes).

Conclusion: Q-realign offers a practical solution for safety-aware LLM deployment.
...
### [255] [Local-Global Feature Fusion for Subject-Independent EEG Emotion Recognition](https://arxiv.org/abs/2601.08094)
*Zheng Zhou,Isabella McEvoy,Camilo E. Valderrama*

Main category: cs.LG

TL;DR: A dual-branch transformer framework combines local and global EEG descriptors for improved subject-independent emotion recognition, achieving ~40% accuracy on SEED-VII.


<details>
  <summary>Details</summary>
Motivation: Addressing challenges in EEG emotion recognition due to inter-subject variability and noisy data by leveraging multi-view representations.

Method: Fuses local (channel-wise) and global (trial-level) descriptors using attention-based fusion and domain-adversarial regularization, with intensity-based sample filtering.

Result: Outperforms baselines in leave-one-subject-out tests, achieving ~40% mean accuracy for 7-class emotion recognition.

Conclusion: The proposed fusion framework enhances cross-subject generalization, validated on SEED-VII.
...
### [256] [STO-RL: Offline RL under Sparse Rewards via LLM-Guided Subgoal Temporal Order](https://arxiv.org/abs/2601.08107)
*Chengyang Gu,Yuxin Pan,Hui Xiong,Yize Chen*

Main category: cs.LG

TL;DR: STO-RL leverages LLMs to generate temporally ordered subgoals for offline RL, improving policy performance with potential-based reward shaping.


<details>
  <summary>Details</summary>
Motivation: Address limitations of existing goal-conditioned and hierarchical offline RL methods by addressing temporal dependencies and imprecise reward shaping.

Method: Uses LLMs to generate ordered subgoal sequences and state-subgoal mappings, then applies potential-based reward shaping to transform sparse rewards.

Result: Outperforms state-of-the-art baselines on benchmarks, achieving faster convergence, higher success rates, and shorter trajectories.

Conclusion: LLM-guided subgoal temporal structures with grounded reward shaping offer a scalable solution for long-horizon offline RL.
...
### [257] [Intra-tree Column Subsampling Hinders XGBoost Learning of Ratio-like Interactions](https://arxiv.org/abs/2601.08121)
*Mykola Pinchuk*

Main category: cs.LG

TL;DR: The study examines whether intra-tree column subsampling in XGBoost hinders the synthesis of signal combinations like ratios, using synthetic data with cancellation-style structure. Results show reduced performance with subsampling unless engineered ratios are included.


<details>
  <summary>Details</summary>
Motivation: To understand if intra-tree column subsampling in XGBoost complicates the synthesis of combined signals (e.g., ratios) from raw features.

Method: Two synthetic data processes with cancellation-style structure were used, testing varying levels of colsample_bylevel and colsample_bynode (s ∈ {0.4, 0.6, 0.8, 0.9}). Performance was compared with and without engineered ratios.

Result: Intra-tree subsampling reduced test PR-AUC in primitives-only settings, with a 54% decrease at s=0.4. Performance issues disappeared when engineered ratios were included.

Conclusion: If ratio-like structure is plausible, avoid intra-tree subsampling or include engineered ratio features to maintain performance.
...
### [258] [Generalization Analysis and Method for Domain Generalization for a Family of Recurrent Neural Networks](https://arxiv.org/abs/2601.08122)
*Atefeh Termehchi,Ekram Hossain,Isaac Woungang*

Main category: cs.LG

TL;DR: The paper addresses interpretability and generalization challenges in deep learning, focusing on RNNs. It proposes a method using Koopman operator theory for interpretability and spectral analysis for OOD generalization, validated on temporal tasks.


<details>
  <summary>Details</summary>
Motivation: Deep learning models lack interpretability and generalization, especially in safety-critical applications. The paper aims to tackle these issues, particularly for RNNs with temporal data.

Method: The approach models RNN states as nonlinear closed-loop systems, approximates them linearly using Koopman operator theory, and uses spectral analysis to quantify OOD generalization error. A domain generalization method is also proposed.

Result: The method improves interpretability, reduces OOD generalization error, and enhances robustness to distribution shifts, validated on temporal pattern-learning tasks.

Conclusion: The proposed framework successfully addresses interpretability and generalization in RNNs, offering a theoretical and practical solution for robust deployment in varying domains.
...
### [259] [Reverse Flow Matching: A Unified Framework for Online Reinforcement Learning with Diffusion and Flow Policies](https://arxiv.org/abs/2601.08136)
*Zeyang Li,Sunbochen Tang,Navid Azizan*

Main category: cs.LG

TL;DR: The paper proposes reverse flow matching (RFM), a unified framework for training diffusion and flow policies in online RL, improving efficiency and stability by combining Q-value and Q-gradient information.


<details>
  <summary>Details</summary>
Motivation: Training diffusion and flow policies efficiently is challenging due to the lack of direct samples from the target distribution, which is an unnormalized Boltzmann distribution defined by the Q-function.

Method: Introduces reverse flow matching (RFM), which frames training as a posterior mean estimation problem using Langevin Stein operators to reduce variance.

Result: RFM unifies existing noise-expectation and gradient-expectation methods, enabling better efficiency and performance in continuous-control benchmarks.

Conclusion: RFM provides a principled way to train diffusion and flow policies, extending their capabilities and improving stability.
...
### [260] [Dynamic Graph Structure Learning via Resistance Curvature Flow](https://arxiv.org/abs/2601.08149)
*Chaoqun Fei,Huanjiang Liu,Tinglve Zhou,Yangyang Li,Tianyong Hao*

Main category: cs.LG

TL;DR: Proposes Resistance Curvature Flow (RCF) as a computationally efficient alternative to Ollivier-Ricci Curvature Flow (OCF) for geometric representation learning, achieving significant speedups while maintaining performance.


<details>
  <summary>Details</summary>
Motivation: Traditional static graph methods fail to capture intrinsic manifold curvature, and OCF's computational complexity limits its use. RCF addresses these issues by leveraging effective resistance for efficient curvature optimization.

Method: Introduces RCF, which uses effective resistance to transform curvature optimization into efficient matrix operations, and designs the DGSL-RCF algorithm for graph optimization.

Result: RCF achieves over 100x computational acceleration compared to OCF while maintaining comparable geometric optimization capabilities. DGSL-RCF improves representation quality and downstream task performance.

Conclusion: RCF and DGSL-RCF provide a scalable and efficient solution for geometric representation learning, enhancing manifold structures and noise suppression in large-scale datasets and deep learning frameworks.
...
### [261] [VBO-MI: A Fully Gradient-Based Bayesian Optimization Framework Using Variational Mutual Information Estimation](https://arxiv.org/abs/2601.08172)
*Farhad Mirkarimi*

Main category: cs.LG

TL;DR: VBO-MI introduces a gradient-based Bayesian optimization framework using variational mutual information estimation, eliminating costly inner-loop optimization for efficiency gains.


<details>
  <summary>Details</summary>
Motivation: Existing Bayesian optimization methods using Bayesian neural networks suffer from expensive posterior sampling and acquisition function optimization, limiting scalability.

Method: Proposes VBO-MI, utilizing an actor-critic architecture (action-net and variational critic) for gradient-based optimization and mutual information estimation.

Result: Achieves significant computational savings (up to 100× reduction in FLOPs) while matching or surpassing baseline performance across diverse benchmarks.

Conclusion: VBO-MI offers an efficient and scalable alternative to traditional BNN-BO frameworks without compromising optimization performance.
...
### [262] [TabPFN Through The Looking Glass: An interpretability study of TabPFN and its internal representations](https://arxiv.org/abs/2601.08181)
*Aviral Gupta,Armaan Sethi,Dhruv Kumar*

Main category: cs.LG

TL;DR: The paper investigates the internal representations and computations of tabular foundational models, revealing structured and interpretable information encoded in their layers.


<details>
  <summary>Details</summary>
Motivation: To understand how tabular foundational models process and transform input features, addressing their lack of interpretability.

Method: Probing experiments analyze hidden representations for linear regression coefficients, intermediate values, and final answers across layers.

Result: Evidence shows meaningful, structured information is stored in the models' representations, with clear signals of intermediate and final quantities.

Conclusion: The findings enhance understanding of these models' internal mechanics, making their decision processes more transparent and trustworthy.
...
### [263] [Scalable Multiagent Reinforcement Learning with Collective Influence Estimation](https://arxiv.org/abs/2601.08210)
*Zhenglong Luo,Zhiyong Chen,Aoxiang Liu,Ke Pan*

Main category: cs.LG

TL;DR: The paper introduces CIEN, a scalable MARL framework that models collective influence to enable efficient coordination without extensive communication, tested successfully in simulations and real robotics.


<details>
  <summary>Details</summary>
Motivation: Existing MARL methods require frequent communication for coordination, which is impractical in real systems. Estimator networks also scale poorly with team size.

Method: The proposed CIEN framework models collective influence from local observations and task states, avoiding explicit action exchanges and network expansion.

Result: CIEN achieves stable coordination in communication-limited settings and scales well. Real-robot tests show improved robustness and reduced communication dependence.

Conclusion: CIEN offers scalable, communication-efficient MARL, validated in simulations and real deployments.
...
### [264] [One-Shot Federated Ridge Regression: Exact Recovery via Sufficient Statistic Aggregation](https://arxiv.org/abs/2601.08216)
*Zahir Alsulaimawi*

Main category: cs.LG

TL;DR: one-shot aggregation.


<details>
  <summary>Details</summary>
Motivation: eliminates iterative communication.

Method: formulated federated ridge regression.

Result: exact recovery.

Conclusion: not an approximation.
...
### [265] [A Preliminary Agentic Framework for Matrix Deflation](https://arxiv.org/abs/2601.08219)
*Paimon Goulart,Evangelos E. Papalexakis*

Main category: cs.LG

TL;DR: An agentic approach for rank-1 SVD updates combines an LLM and VLM to deflate matrices without fixed thresholds, achieving competitive results across datasets.


<details>
  <summary>Details</summary>
Motivation: To explore if a small team of agents can perform matrix deflation efficiently by combining solver stability and visual coherence checks.

Method: Uses an LLM for rank-1 SVD updates and a VLM to accept/reject updates, leveraging ICL and row/column permutations. Evaluated on Digits, CIFAR-10, and synthetic matrices.

Result: Achieves close RMSE to noise targets in synthetic cases and meets Frobenius norm targets for Digits/CIFAR-10, showing competitive performance.

Conclusion: Agentic, threshold-free deflation is viable and competitive with classical numerical methods.
...
### [266] [GADPN: Graph Adaptive Denoising and Perturbation Networks via Singular Value Decomposition](https://arxiv.org/abs/2601.08230)
*Hao Deng,Bo Liu*

Main category: cs.LG

TL;DR: GADPN is a graph structure learning framework that improves graph topology via adaptive denoising and structural perturbation, achieving high efficiency and performance.


<details>
  <summary>Details</summary>
Motivation: Address limitations of GNNs caused by noisy or misaligned graph structures, avoiding costly methods.

Method: Uses low-rank denoising, Bayesian optimization for adaptive denoising, and SVD-based perturbation.

Result: Achieves state-of-the-art performance and efficiency, especially on disassortative graphs.

Conclusion: GADPN is effective and robust for diverse graph types, enhancing GNN performance.
...
### [267] [Incorporating Cognitive Biases into Reinforcement Learning for Financial Decision-Making](https://arxiv.org/abs/2601.08247)
*Liu He*

Main category: cs.LG

TL;DR: This study explores integrating cognitive biases into RL models for financial trading to mimic human behavior and improve risk-adjusted returns, though results were inconclusive or negative.


<details>
  <summary>Details</summary>
Motivation: Traditional RL models assume rationality, ignoring psychological factors. The study aims to address this gap by modeling human-like biases in financial decision-making.

Method: Cognitive biases (e.g., overconfidence, loss aversion) are incorporated into RL frameworks via reward structures and decision-making processes, tested in simulated and real-world environments.

Result: The results were inconclusive or negative, highlighting challenges in mimicking human biases in RL models.

Conclusion: Despite mixed results, the study offers insights into integrating human-like biases into RL, aiding future development of robust financial AI systems.
...
### [268] [Hyperbolic Heterogeneous Graph Transformer](https://arxiv.org/abs/2601.08251)
*Jongmin Park,Seunghoon Han,Hyewon Lee,Won-Yong Shin,Sungsu Lim*

Main category: cs.LG

TL;DR: HypHGT is a hyperbolic heterogeneous graph transformer that learns representations entirely in hyperbolic space, using transformer architecture and a relation-specific attention mechanism to capture both local and global dependencies efficiently.


<details>
  <summary>Details</summary>
Motivation: Existing hyperbolic methods for heterogeneous graphs rely on tangent-space operations, causing distortions, and focus on local neighborhoods, missing global hierarchical structures and long-range dependencies.

Method: HypHTG uses a transformer-based architecture and a relation-specific hyperbolic attention mechanism to capture dependencies efficiently without tangent-space operations.

Result: HypHGT outperforms state-of-the-art methods in node classification, with reduced training time and memory usage.

Conclusion: HypHGT effectively learns heterogeneous graph representations by addressing the limitations of existing methods, demonstrating superior performance and efficiency.
...
### [269] [LDLT L-Lipschitz Network Weight Parameterization Initialization](https://arxiv.org/abs/2601.08253)
*Marius F. R. Juston,Ramavarapu S. Sreenivas,Dustin Nottage,Ahmet Soylemezoglu*

Main category: cs.LG

TL;DR: The paper analyzes initialization dynamics for LDLT-based Lipschitz layers, derives output variance formulas, and compares initialization methods.


<details>
  <summary>Details</summary>
Motivation: To understand why deep Lipschitz networks lose information quickly at initialization and to improve initialization hyperparameters.

Method: Derived marginal output variance using Wishart distribution, combinatorial expansions, and Monte Carlo experiments.

Result: He initialization performs better empirically despite theoretical improvements in variance preservation.

Conclusion: The study provides insights into initialization dynamics but highlights gaps between theory and practice.
...
### [270] [On Evaluation of Unsupervised Feature Selection for Pattern Classification](https://arxiv.org/abs/2601.08257)
*Gyu-Il Kim,Dae-Won Kim,Jaesung Lee*

Main category: cs.LG

TL;DR: The paper critiques using single-label datasets for evaluating unsupervised feature selection methods, proposing multi-label evaluation instead for fairer comparisons.


<details>
  <summary>Details</summary>
Motivation: Existing evaluations of unsupervised feature selection methods rely on single-label datasets, which can lead to inconsistent rankings due to arbitrary label selection.

Method: The study adopts a multi-label classification framework, testing several representative methods on 21 multi-label datasets.

Result: Performance rankings differ significantly from single-label evaluations, highlighting the inconsistency.

Conclusion: Multi-label evaluation provides a fairer and more reliable comparison for unsupervised feature selection methods.
...
### [271] [A Usable GAN-Based Tool for Synthetic ECG Generation in Cardiac Amyloidosis Research](https://arxiv.org/abs/2601.08260)
*Francesco Speziale,Ugo Lomoio,Fabiola Boccuto,Pierangelo Veltri,Pietro Hiram Guzzi*

Main category: cs.LG

TL;DR: A GAN-based tool generates synthetic ECG beats for cardiac amyloidosis diagnosis, addressing small, imbalanced datasets.


<details>
  <summary>Details</summary>
Motivation: Cardiac amyloidosis is underdiagnosed due to small, imbalanced datasets, necessitating synthetic data generation.

Method: Developed a GAN and graphical CLI to create realistic synthetic ECG beats, focusing on usability for researchers.

Result: The tool enables interactive generation of large volumes of labeled synthetic beats, preserving minority class distributions.

Conclusion: This approach supports early CA diagnosis and patient stratification by mitigating dataset limitations.
...
### [272] [Demystifying the Slash Pattern in Attention: The Role of RoPE](https://arxiv.org/abs/2601.08297)
*Yuan Cheng,Fengzhuo Zhang,Yunlong Hou,Cunxiao Du,Chao Du,Tianyu Pang,Aixin Sun,Zhuoran Yang*

Main category: cs.LG

TL;DR: The paper investigates why Slash-Dominant Heads (SDHs) emerge in Large Language Models, attributing their intrinsic nature to specific conditions in queries, keys, and Rotary Position Embedding (RoPE), supported by empirical and theoretical analysis.


<details>
  <summary>Details</summary>
Motivation: Understanding the emergence of SDHs in LLMs, which play a crucial role in token information flow.

Method: Analyzes open-source LLMs empirically and theoretically, focusing on queries, keys, and RoPE, and models training dynamics in shallow Transformers.

Result: Identifies rank-one queries/keys and RoPE's medium-high frequency dominance as key conditions for SDHs, proving their emergence via training dynamics.

Conclusion: SDHs are intrinsic to LLMs under specific conditions and generalize beyond training data, with theoretical and empirical validation.
...
### [273] [ORBIT: On-policy Exploration-Exploitation for Controllable Multi-Budget Reasoning](https://arxiv.org/abs/2601.08310)
*Kun Liang,Clive Bai,Xin Xu,Chenming Tang,Sanwoo Lee,Weijie Liu,Saiyong Yang,Yunfang Wu*

Main category: cs.LG

TL;DR: ORBIT introduces a controllable multi-budget reasoning framework using multi-stage reinforcement learning and distillation to optimize reasoning cost and accuracy dynamically.


<details>
  <summary>Details</summary>
Motivation: Uniformly applying long-form reasoning in LRMs is computationally costly, and prior methods lack flexibility in balancing cost and accuracy.

Method: ORBIT uses multi-stage RL to identify Pareto-optimal reasoning behaviors and distills them into a unified model.

Result: Achieves controllable reasoning modes, competitive reasoning density, and preserves performance across modes.

Conclusion: ORBIT offers a flexible and efficient solution for dynamic reasoning budgets in LRMs.
...
### [274] [Deep Exploration of Epoch-wise Double Descent in Noisy Data: Signal Separation, Large Activation, and Benign Overfitting](https://arxiv.org/abs/2601.08316)
*Tomoki Kubo,Ryuken Uda,Yusuke Iida*

Main category: cs.LG

TL;DR: The study investigates epoch-wise double descent in deep learning, focusing on internal structures. It shows re-generalization after overfitting noisy data, delayed noisy data learning, and emergence of large activations in shallow layers.


<details>
  <summary>Details</summary>
Motivation: To understand the generalization capability of deep learning models by examining delayed generalization (epoch-wise double descent) and internal signal evolution.

Method: Trained fully connected neural networks on CIFAR-10 with label noise, analyzed loss curves by decomposing clean/noisy data signals, and studied internal activations.

Result: Models re-generalized after overfitting noisy data ('benign overfitting'), learned noisy data after clean, and exhibited large shallow-layer activations correlating with inputs.

Conclusion: The findings connect deep double descent, benign overfitting, and large activations, proposing a new scenario for understanding deep double descent.
...
### [275] [Automated Machine Learning in Radiomics: A Comparative Evaluation of Performance, Efficiency and Accessibility](https://arxiv.org/abs/2601.08334)
*Jose Lozano-Montoya,Emilio Soria-Olivas,Almudena Fuster-Matanzo,Angel Alberich-Bayarri,Ana Jimenez-Pastor*

Main category: cs.LG

TL;DR: AutoML frameworks, both general-purpose and radiomics-specific, were evaluated for radiomics classification tasks. Simplatab (radiomics-specific) performed best in AUC, while LightAutoML (general-purpose) was fastest. Most radiomics-specific tools were outdated or inefficient, whereas general-purpose tools were more accessible. Future work should address radiomics-specific gaps like survival analysis and feature harmonization.


<details>
  <summary>Details</summary>
Motivation: To assess the effectiveness of AutoML frameworks in radiomics for performance, efficiency, and accessibility, highlighting unmet needs.

Method: Evaluated six general-purpose and five radiomics-specific frameworks on 10 diverse datasets using predefined parameters and standardized cross-validation. Metrics included AUC, runtime, and qualitative aspects (software status, accessibility, interpretability).

Result: Simplatab achieved the highest average test AUC (81.81%); LightAutoML was fastest (78.74% AUC in six minutes). Most radiomics-specific tools were obsolete or inefficient, while general-purpose tools were more accessible.

Conclusion: Simplatab balances performance and accessibility for radiomics, but gaps persist (e.g., survival analysis, feature harmonization). Future AutoML efforts should address radiomics-specific challenges.
...
### [276] [Decodable but not structured: linear probing enables Underwater Acoustic Target Recognition with pretrained audio embeddings](https://arxiv.org/abs/2601.08358)
*Hilde I. Hummel,Sandjai Bhulai,Rob D. van der Mei,Burooj Ghani*

Main category: cs.LG

TL;DR: Automated ship noise monitoring using transfer learning outperforms manual analysis, leveraging pretrained audio models for effective underwater acoustic target recognition with minimal labeled data.


<details>
  <summary>Details</summary>
Motivation: Ship noise pollution harms marine ecosystems, necessitating efficient monitoring. Manual analysis of passive acoustic data is impractical, prompting automated solutions.

Method: Uses transfer learning with pretrained audio models, freezing weights and analyzing embeddings via classification, clustering, and similarity evaluations. Linear probing isolates ship-type features.

Result: Embedding space reflects recording-specific traits, but linear probing effectively extracts ship-type features, enabling low-cost UATR with minimal labeled data.

Conclusion: Transfer learning with linear probing offers a scalable, efficient solution for underwater acoustic target recognition, reducing reliance on labeled datasets.
...
### [277] [Training-Free Distribution Adaptation for Diffusion Models via Maximum Mean Discrepancy Guidance](https://arxiv.org/abs/2601.08379)
*Matina Mahdizadeh Sani,Nima Jamali,Mohammad Jalali,Farzan Farnia*

Main category: cs.LG

TL;DR: MMD Guidance is a training-free method enhancing diffusion models by aligning generated samples with reference data using Maximum Mean Discrepancy (MMD), improving domain adaptation without retraining.


<details>
  <summary>Details</summary>
Motivation: Address mismatches between diffusion model outputs and target data characteristics in domain adaptation tasks, especially with few reference examples.

Method: Uses MMD gradients during reverse diffusion to align samples with reference data, efficiently differentiable and suitable for latent diffusion models.

Result: Achieves distributional alignment while maintaining sample fidelity, validated on synthetic and real-world benchmarks.

Conclusion: MMD Guidance effectively adapts diffusion models to target distributions without retraining, leveraging MMD's reliability and efficiency.
...
### [278] [Controlled LLM Training on Spectral Sphere](https://arxiv.org/abs/2601.08393)
...
TL;DR: SSO introduces spectral sphere constraints for stable optimization, outperforming AdamW and Muon.


<details>
  <summary>Details</summary>
Motivation: Address limitations of existing optimizers (Muon) in alignment with $μ$P constraints.

Method: Enforce module-wise spectral constraints on weights and updates, implemented efficiently in Megatron.

Result: Outperforms AdamW and Muon in pretraining diverse models, improving stability and activation control.

Conclusion: SSO offers a fully $μ$P-aligned, stable, and scalable optimization solution.
...
### [279] [Out-of-distribution generalization of deep-learning surrogates for 2D PDE-generated dynamics in the small-data regime](https://arxiv.org/abs/2601.08404)
*Binh Duong Nguyen,Stefan Sandfeld*

Main category: cs.LG

TL;DR: The paper evaluates autoregressive deep-learning surrogates for 2D PDEs, focusing on generalization to unseen initial conditions and small-data settings. A multi-channel U-Net outperforms more complex models in accuracy and efficiency.


<details>
  <summary>Details</summary>
Motivation: High-fidelity PDE simulations are computationally expensive, motivating data-driven forecasting for scientific machine learning.

Method: A multi-channel U-Net is introduced and evaluated on five PDE families, compared to ViT, AFNO, PDE-Transformer, and KAN-UNet under small-data conditions.

Result: me-UNet matches or outperforms complex models in accuracy and speed, generalizing well with minimal training data.

Conclusion: Convolutional architectures with appropriate inductive biases excel in small-data, periodic 2D PDE settings.
...
### [280] [Taxon: Hierarchical Tax Code Prediction with Semantically Aligned LLM Expert Guidance](https://arxiv.org/abs/2601.08418)
*Jihang Li,Qing Liu,Zulong Chen,Jing Wang,Wei Wang,Chuanfei Xu,Zeyi Wen*

Main category: cs.LG

TL;DR: Taxon is a framework for hierarchical tax code prediction that integrates feature-gating and semantic consistency models, achieving state-of-the-art performance and deployment success at Alibaba.


<details>
  <summary>Details</summary>
Motivation: Accurate tax code prediction is essential for e-commerce compliance but lacks robust solutions, risking financial and regulatory issues.

Method: Taxon combines a feature-gating mixture-of-experts architecture with semantic consistency models and multi-source training to handle noisy data.

Result: Taxon outperforms baselines on TaxCode and public benchmarks, with improved accuracy and structural consistency, handling millions of queries daily.

Conclusion: Taxon successfully addresses tax code prediction challenges, demonstrating scalability, accuracy, and robustness in real-world deployment.
...
### [281] [Coverage Improvement and Fast Convergence of On-policy Preference Learning](https://arxiv.org/abs/2601.08421)
*Juno Kim,Jihun Yun,Jason D. Lee,Kwang-Sung Jun*

Main category: cs.LG

TL;DR: On-policy preference learning algorithms like DPO outperform offline methods due to better coverage evolution during training, enabling faster convergence. Theoretical analysis shows exponential convergence for DPO with sufficient batch size, while offline methods suffer slower rates. A hybrid sampler and reward distillation schemes further improve performance.


<details>
  <summary>Details</summary>
Motivation: The paper seeks to explain why on-policy preference learning algorithms (e.g., DPO) outperform offline methods and proposes solutions to enhance their efficiency and convergence.

Method: The study analyzes coverage evolution during on-policy training, introduces the coverage improvement principle, and proposes a hybrid sampler and reward distillation schemes. Theoretical proofs are provided for convergence rates.

Result: On-policy DPO converges exponentially with sufficient batch size, while offline methods lag. The hybrid sampler removes coverage dependence, ensuring two-round convergence. Experiments confirm the superiority of on-policy methods.

Conclusion: On-policy training, aided by coverage improvement and novel samplers, significantly outperforms offline methods, offering stable and rapid performance gains.
...
### [282] [DiffMM: Efficient Method for Accurate Noisy and Sparse Trajectory Map Matching via One Step Diffusion](https://arxiv.org/abs/2601.08482)
*Chenxu Han,Sean Bin Yang,Jilin Hu*

Main category: cs.LG

TL;DR: DiffMM is an encoder-diffusion-based framework for map matching sparse trajectories, outperforming existing methods like HMM and encoder-decoder frameworks in accuracy and efficiency.


<details>
  <summary>Details</summary>
Motivation: Traditional map matching methods struggle with noisy or sparsely sampled GPS trajectories, necessitating a more effective solution.

Method: DiffMM uses a road segment-aware trajectory encoder to embed trajectories and candidate road segments into a shared latent space via attention, followed by a one-step diffusion process for matching.

Result: Extensive experiments show DiffMM achieves superior accuracy and efficiency, especially for sparse trajectories and complex road networks.

Conclusion: DiffMM provides a robust solution for map matching sparse trajectories, addressing limitations of existing methods.
...
### [283] [Temporal Fusion Nexus: A task-agnostic multi-modal embedding model for clinical narratives and irregular time series in post-kidney transplant care](https://arxiv.org/abs/2601.08503)
...
TL;DR: TFN is a multi-modal, task-agnostic model integrating irregular time series and clinical narratives, outperforming SOTA models in post-KTx care with improved AUCs for graft loss, rejection, and mortality. It also showed better performance than unimodal baselines and aligns with clinical reasoning.


<details>
  <summary>Details</summary>
Motivation: The need to integrate heterogeneous clinical data (irregular time series and unstructured narratives) for improved predictive performance in post-KTx care and other clinical tasks.

Method: TFN uses multi-modal embeddings to combine irregular time series and unstructured clinical narratives, evaluated retrospectively on 3382 KTx patients for graft loss, rejection, and mortality outcomes.

Result: TFN achieved higher AUCs (0.96 vs. 0.94 for graft loss, 0.84 vs. 0.74 for rejection) and 0.86 for mortality, outperforming unimodal baselines (~10% AUC improvement). Clinical text integration enhanced performance.

Conclusion: TFN's robust and interpretable latent factors, along with its superior performance, suggest broad applicability in clinical tasks with heterogeneous data.
...
### [284] [Your Group-Relative Advantage Is Biased](https://arxiv.org/abs/2601.08521)
...
TL;DR: RLVR methods like GRPO rely on biased group-relative advantage estimation, causing imbalanced exploration. The paper proposes HA-DW, an adaptive reweighting scheme, to correct this bias and improve performance.


<details>
  <summary>Details</summary>
Motivation: To address the inherent bias in group-relative advantage estimation used by RLVR methods, which underestimates advantages for hard prompts and overestimates them for easy prompts.

Method: Proposes History-Aware Adaptive Difficulty Weighting (HA-DW), an adaptive reweighting scheme adjusting advantage estimates based on difficulty anchors and training dynamics.

Result: HA-DW consistently improves performance when integrated into GRPO and its variants, as demonstrated on five mathematical reasoning benchmarks.

Conclusion: Correcting biased advantage estimation is crucial for robust and efficient RLVR training.
...
### [285] [Contrastive and Multi-Task Learning on Noisy Brain Signals with Nonlinear Dynamical Signatures](https://arxiv.org/abs/2601.08549)
*Sucheta Ghosh,Zahra Monfared,Felix Dietrich*

Main category: cs.LG

TL;DR: A two-stage multitask learning framework for EEG signal analysis integrates denoising, dynamical modeling, and representation learning, outperforming baselines in robustness and generalization.


<details>
  <summary>Details</summary>
Motivation: The paper aims to enhance EEG signal analysis by combining denoising, dynamical modeling, and representation learning to improve robustness, generalization, and decoding performance.

Method: The framework uses a denoising autoencoder (stage 1) and a multitask architecture (stage 2) for classification, regime discrimination, and contrastive learning, leveraging convolutional and Transformer encoders.

Result: The framework improves stability, generalizability, and outperforms baselines and state-of-the-art methods in EEG decoding tasks.

Conclusion: Combining denoising, dynamical features, and self-supervised learning effectively enhances EEG signal analysis and decoding.
...
### [286] [EviNAM: Intelligibility and Uncertainty via Evidential Neural Additive Models](https://arxiv.org/abs/2601.08556)
*Sören Schleibaum,Anton Frederik Thielmann,Julian Teusch,Benjamin Säfken,Jörg P. Müller*

Main category: cs.LG

TL;DR: EviNAM combines Neural Additive Models (NAMs) with evidential learning for interpretable uncertainty estimation in regression tasks.


<details>
  <summary>Details</summary>
Motivation: To enhance intelligibility and reliable uncertainty estimation for decision-making by integrating interpretable models with principled uncertainty quantification.

Method: Extends evidential learning with Neural Additive Models (NAMs) to estimate aleatoric and epistemic uncertainty and explicit feature contributions in one pass.

Result: Demonstrates state-of-the-art predictive performance on synthetic and real data, with potential extension to classification and generalized additive models.

Conclusion: EviNAM provides a promising approach for more interpretable and trustworthy predictions beyond regression.
...
### [287] [M$^2$FMoE: Multi-Resolution Multi-View Frequency Mixture-of-Experts for Extreme-Adaptive Time Series Forecasting](https://arxiv.org/abs/2601.08631)
*Yaohui Huang,Runmin Zou,Yun Wang,Laeeq Aslam,Ruipeng Dong*

Main category: cs.LG

TL;DR: M$^2$FMoE proposes a model for forecasting time series with extreme events using multi-resolution and multi-view frequency modeling to improve accuracy during irregular dynamics.


<details>
  <summary>Details</summary>
Motivation: Existing methods struggle with extreme events due to their high variance and irregular dynamics, leading to significant forecasting errors. M$^2$FMoE aims to address this by capturing both regular and extreme patterns.

Method: The model uses Multi-resolution Adaptive Fusion Module for hierarchical aggregation of frequency features, Temporal Gating Integration Module for dynamic balancing, and Multi-view Frequency Mixture-of-Experts Module for spectral band assignment.

Result: Experiments show M$^2$FMoE outperforms state-of-the-art baselines on hydrological datasets with extreme patterns, even without extreme-event labels.

Conclusion: M$^2$FMoE effectively captures both regular and extreme temporal patterns, providing superior forecasting performance during extreme events.
...
### [288] [Provably Safe Reinforcement Learning using Entropy Regularizer](https://arxiv.org/abs/2601.08646)
*Abhijit Mazumdar,Rafal Wisniewski,Manuela L. Bujorianu*

Main category: cs.LG

TL;DR: The paper focuses on learning optimal policies for Markov decision processes with safety constraints, proposing two online RL algorithms—one based on OFU and another incorporating entropy regularization—to ensure high-probability safety and improved regret bounds.


<details>
  <summary>Details</summary>
Motivation: Addressing the challenge of ensuring safety during the learning phase of reinforcement learning in Markov decision processes, particularly in a reach-avoid setup.

Method: Proposes two algorithms: one leveraging the optimism in the face of uncertainty (OFU) principle, and a main algorithm incorporating entropy regularization for better control and performance.

Result: Finite-sample analysis shows entropy regularization improves regret bounds and reduces episode-to-episode variability compared to OFU-based safe RL algorithms.

Conclusion: Incorporating entropy regularization enhances performance and stability in safe RL algorithms, offering practical benefits for constrained MDPs.
...
### [289] [TRACE: Reconstruction-Based Anomaly Detection in Ensemble and Time-Dependent Simulations](https://arxiv.org/abs/2601.08659)
*Hamid Gadirov,Martijn Westra,Steffen Frey*

Main category: cs.LG

TL;DR: Comparison of 2D and 3D autoencoders for detecting anomalies in high-dimensional, time-dependent simulation data, showing the 3D model's superiority in capturing spatio-temporal patterns.


<details>
  <summary>Details</summary>
Motivation: Addressing the challenge of anomaly detection in complex, time-dependent simulation data with spatial and temporal dynamics.

Method: Using convolutional autoencoders (2D for single frames, 3D for temporal stacks) on ensemble data from Kármán vortex street simulations.

Result: The 3D autoencoder detects anomalous motion patterns better and reduces redundant detections, while reconstruction errors are influenced by mass distribution.

Conclusion: Temporal context is crucial for robust anomaly detection in dynamic simulations.
...
### [290] [Soft Partition-based KAPI-ELM for Multi-Scale PDEs](https://arxiv.org/abs/2601.08719)
*Vikas Dwivedi,Monica Sigovan,Bruno Sixou*

Main category: cs.LG

TL;DR: The paper introduces KAPI-ELM, a deterministic method for solving multiscale PDEs without Fourier features or random sampling, outperforming existing methods like PINN and TFC.


<details>
  <summary>Details</summary>
Motivation: Existing physics-informed machine learning methods struggle with oscillatory, multiscale, or singularly perturbed PDEs due to spectral bias and costly computations.

Method: Proposes KAPI-ELM, using soft partition-based kernel adaptation to control collocation centers and Gaussian kernel widths for coarse-to-fine resolution.

Result: Demonstrates superior accuracy across eight benchmarks compared to PINN and TFC, requiring only a single linear solve.

Conclusion: Soft-partition kernel adaptation offers a fast, architecture-free approach for multiscale PDEs with potential for broader applications.
...
### [291] [Model-Agnostic Solutions for Deep Reinforcement Learning in Non-Ergodic Contexts](https://arxiv.org/abs/2601.08726)
*Bert Verbruggen,Arne Vanhoyweghen,Vincent Ginis*

Main category: cs.LG

TL;DR: Traditional and deep RL methods fail in non-ergodic environments due to reliance on ensemble averages. Incorporating temporal information improves policy optimality without altering environmental feedback.


<details>
  <summary>Details</summary>
Motivation: To address the suboptimality of RL policies in non-ergodic environments where expected-value formulations diverge from time-average growth.

Method: Extends analysis to deep RL and introduces explicit time dependence in learning, allowing value functions to align with intrinsic growth rates.

Result: Shows deep RL also fails in non-ergodic settings but improves when temporal information is incorporated.

Conclusion: Incorporating temporal dependence in RL naturally corrects suboptimal policies in non-ergodic systems, expanding RL applicability.
...
### [292] [A Novel Approach to Explainable AI with Quantized Active Ingredients in Decision Making](https://arxiv.org/abs/2601.08733)
*A. M. A. S. D. Alagiyawanna,Asoka Karunananda,Thushari Silva,A. Mahasinghe*

Main category: cs.LG

TL;DR: A study comparing Quantum Boltzmann Machines (QBMs) and Classical Boltzmann Machines (CBMs) demonstrates QBMs' superior accuracy (83.5% vs. 54%) and clearer feature attribution for explainable AI.


<details>
  <summary>Details</summary>
Motivation: Address the lack of explainability in AI systems, particularly in high-stakes domains like health and finance, by leveraging quantum computing principles within classical machine learning.

Method: Train QBMs and CBMs on a binarised MNIST dataset preprocessed with PCA. Use gradient-based saliency maps (QBMs) and SHAP (CBMs) for interpretability. QBMs employ hybrid quantum-classical circuits; CBMs use contrastive divergence.

Result: QBMs outperformed CBMs in classification accuracy (83.5% vs. 54%) and showed more concentrated feature attributions (lower entropy: 1.27 vs. 1.39).

Conclusion: Quantum-classical hybrid models like QBMs improve both accuracy and interpretability, advancing trustworthy and explainable AI.
...
### [293] [Rewarding the Rare: Uniqueness-Aware RL for Creative Problem Solving in LLMs](https://arxiv.org/abs/2601.08763)
...
TL;DR: The paper introduces Uniqueness-Aware Reinforcement Learning to enhance diversity in solutions for LLMs during reinforcement learning, improving pass@k without harming pass@1.


<details>
  <summary>Details</summary>
Motivation: RL for LLMs often suffers from exploration collapse, focusing on dominant patterns and limiting solution diversity. Addressing this can improve performance across multiple benchmarks.

Method: Proposes a rollout-level objective rewarding unique solutions. Uses an LLM judge to cluster solutions by strategy and reweights advantages inversely with cluster size.

Result: Method improves pass@k and AUC@K across math, physics, and medical benchmarks while maintaining pass@1 and increasing solution diversity.

Conclusion: Encouraging diversity in solution strategies enhances RL performance in LLMs, benefiting complex reasoning tasks without trade-offs.
...
### [294] [Asymptotic Universal Alignment: A New Alignment Framework via Test-Time Scaling](https://arxiv.org/abs/2601.08777)
*Yang Cai,Weiqiang Zheng*

Main category: cs.LG

TL;DR: The paper formalizes universal alignment for LLMs via test-time scaling, introducing (k,f(k))-robust alignment and U-alignment. It characterizes optimal convergence rates, critiques existing methods like NLHF for underutilizing scaling, and proposes a symmetric multi-player game approach to achieve optimal alignment.


<details>
  <summary>Details</summary>
Motivation: Aligning LLMs with diverse and conflicting user preferences is critical for personalized and trustworthy AI, but current methods often fail to leverage test-time scaling effectively, limiting their alignment performance.

Method: The paper introduces (k,f(k))-robust alignment and U-alignment, analyzes the optimal convergence rate, critiques NLHF, and proposes a symmetric multi-player alignment game framework to achieve optimal test-time scaling.

Result: Optimal convergence rate for U-alignment is f(k) = k/(k+1). NLHF is suboptimal for k > 1 due to lack of diversity, while the proposed symmetric game approach achieves optimal alignment.

Conclusion: The proposed symmetric multi-player alignment games achieve optimal test-time scaling and alignment, addressing limitations of existing methods like NLHF and enabling better alignment with diverse user preferences.
...
### [295] [Fast and explainable clustering in the Manhattan and Tanimoto distance](https://arxiv.org/abs/2601.08781)
*Stefan Güttel,Kaustubh Roy*

Main category: cs.LG

TL;DR: CLASSIX algorithm is extended to support multiple distance metrics (Manhattan, Tanimoto) for faster and higher-quality clustering, outperforming other algorithms significantly.


<details>
  <summary>Details</summary>
Motivation: The original CLASSIX algorithm was limited to Euclidean distance, prompting an extension to other metrics like Manhattan and Tanimoto distances to enhance versatility and performance.

Method: The extension replaces principal component sorting with norms of data vectors and uses triangle inequality (or sharper intersection inequality for Tanimoto) to optimize search termination.

Result: CLASSIX Tanimoto outperforms Taylor-Butina (30x faster) and DBSCAN (80x faster) while producing higher-quality clusters on a chemical fingerprint benchmark.

Conclusion: The extended CLASSIX algorithm broadens its applicability and significantly improves clustering speed and quality for diverse distance metrics.
