...
TL;DR: EvidFuse is a multi-agent framework that enables text-chart interleaved generation for data-driven reports, addressing inconsistency and shallow analysis in existing LLM-based systems.


<details>
  <summary>Details</summary>
Motivation: Existing LLM-based systems for data-driven reports suffer from chart-text inconsistency and insight freezing due to staged pipelines, limiting the flexibility and depth of analysis.

Method: EvidFuse uses two collaborating agents: a Data-Augmented Analysis Agent for visualization analysis and a Real-Time Evidence Construction Writer for drafting, allowing dynamic evidence incorporation.

Result: EvidFuse outperforms existing methods in chart quality, chart-text alignment, and report usefulness, as validated by LLM and human evaluations.

Conclusion: EvidFuse effectively addresses the limitations of current systems by enabling on-demand visual evidence construction and seamless integration with narrative text.
